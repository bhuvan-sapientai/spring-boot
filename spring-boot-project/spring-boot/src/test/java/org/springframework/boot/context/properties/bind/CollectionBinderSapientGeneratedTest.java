...
class CollectionBinderSapientGeneratedTest {
    ...
    //Sapient generated method id: ${bindAggregateWhenResultWasSupplied}, hash: D61BFBC07310DEB9A42CF804EAB0A139
    @Disabled()
    @Test()
    void bindAggregateWhenResultWasSupplied() {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: result - Method: wasSupplied
         *  Suggestions:
    ...
    //Sapient generated method id: ${bindAggregateWhenResultNotWasSupplied}, hash: 2D959C441DAA7100CE546D76B5848DCA
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${merge1WhenExistingCollectionIsNull}, hash: 9E445418FDBE5FA7C4AA964ECC60A1E3
    @Test()
    ...
    //Sapient generated method id: ${merge1WhenExistingCollectionIsNotNull}, hash: 1A6DEB45DB92AEE3ECBC31D02255F1E2
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${merge1WhenCaughtUnsupportedOperationException}, hash: 2C2DD2C9FD1D84F559BD10062D3DDF85
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${merge1WhenCaughtException}, hash: C2E6B92075FBBE99D2191B0F7A6CCA57
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${merge1WhenCaughtExceptionAndExistingCollectionIsNull}, hash: E58C46AAAFF2DB24C3BCBAFAF89353A5
    @Test()
