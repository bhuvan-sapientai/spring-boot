...
class ConfigurationPropertyNameAliasesSapientGeneratedTest {
	...
	//Sapient generated method id: ${33fd4f79-ef2b-3f30-ac75-a869eebecb94}
	@Disabled()
	@Test()
	void addAliasesTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${b5f7e64d-074b-3fc8-8adc-0fbfe842d7c3}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${0908a3eb-ee31-39d4-afd0-d5ce03bae9cd}
	@Disabled()
	@Test()
	void getAliasesTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${2ba754dc-302b-3b6f-9784-0e2c63277668}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${7d45f9ca-df10-3434-98de-4f72063d0581}
	@Disabled()
	@Test()
