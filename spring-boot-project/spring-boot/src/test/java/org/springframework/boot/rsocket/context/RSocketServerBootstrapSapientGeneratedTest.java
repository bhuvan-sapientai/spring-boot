...
class RSocketServerBootstrapSapientGeneratedTest {
	...
	//Sapient generated method id: ${a9331398-240e-36aa-9522-b3dc4bcf14ad}, hash: 2D7F85CDFB43159EA3FB8708FB9CBDB3
	@Test()
	void startTest() throws RSocketServerException {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
			...
			doNothing().when(eventPublisherMock).publishEvent((ApplicationEvent) any());
			//Act Statement(s)
			target.start();
			//Assert statement(s)
			assertAll("result", () -> {
				...
				verify(eventPublisherMock).publishEvent((ApplicationEvent) any());
			});
		}
	}

	//Sapient generated method id: ${097b903c-1cba-3dd3-835e-b09bc597ebca}, hash: C74A72500E82D40A4B1E329CC8572A19
	@Test()
	...
	//Sapient generated method id: ${7f0cfd88-2fd9-3152-a1f2-93676acef8c3}, hash: D6921024E3C8DD69714B93A64A789938
	@Test()
	...
	//Sapient generated method id: ${5cee3b5d-d202-3e63-86d6-a3f55550b74f}, hash: 32EDC283C07258C8223DFCA74B716A52
	@Test()
	...
	//Sapient generated method id: ${e6c80439-1481-359a-bd64-24cd14d47076}, hash: FD1000AC505FBDF6460E05B6C0719673
	@Test()
