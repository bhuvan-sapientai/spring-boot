...
class MessageSourceMessageInterpolatorSapientGeneratedTest {
	...
	//Sapient generated method id: ${f40604cd-a968-3a70-bb3d-965fe146fc3d}, hash: DE322EB30E7164474D92B28B7CC815BD
	@Test()
	...
	//Sapient generated method id: ${1a7f664c-effc-3b6f-8c26-92ad70cbd7ff}, hash: 9EEC0430A21F7A337991A619DA31ADB4
	@Test()
	void interpolate1WhenIsUsingCodeAsDefaultMessageNotValueParameterAndValueIsNull() {
		...
		MessageSourceMessageInterpolator target = new MessageSourceMessageInterpolator(messageSourceMock, messageInterpolatorMock);
		Locale locale = new Locale("language1");
		doReturn("{name}, your age is {age}.").when(messageSourceMock).getMessage("C", null, null, locale);
