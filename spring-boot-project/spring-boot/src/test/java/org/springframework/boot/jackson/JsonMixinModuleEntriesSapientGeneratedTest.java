...
class JsonMixinModuleEntriesSapientGeneratedTest {
	...
	//Sapient generated method id: ${d514eab9-9404-35cc-8860-6759e9707398}, hash: 46755C1223E2BDEDC0E7E5C857A31DDD
	@Test()
    ...
    jsonMixinModuleEntries.when(() -> JsonMixinModuleEntries.create((Consumer) any())).thenReturn(jsonMixinModuleEntriesMock);
    classUtils.when(() -> ClassUtils.resolveClassName(eq("err1"), (String) any())).thenReturn(Object.class);
    Collection<String> collection = new ArrayList<>();
    JsonMixinModuleEntries target = JsonMixinModuleEntries.scan(applicationContextMock, collection);
    ClassLoader classLoader = ClassLoader.getPlatformClassLoader();
    //Act Statement(s)
    ...
    assertAll("result", () -> {
        ...
        classUtils.verify(() -> ClassUtils.resolveClassName(eq("err1"), (String) any()), atLeast(2));
    });
}*/
	}
}
