...
class FilteredConfigurationPropertiesSourceSapientGeneratedTest {
	...
	private final ConfigurationPropertySource sourceMock = mock(ConfigurationPropertySource.class, "test");

	private final ConfigurationPropertyName configurationPropertyNameMock = mock(ConfigurationPropertyName.class);

	private final Predicate predicateMock = mock(Predicate.class);

	//Sapient generated method id: ${83cc193e-c3fe-3d15-89d9-324b130ff7fa}, hash: 5B776E7DA670AB1BDD55F5AB9E7863B2
	@Test()
	void getConfigurationPropertyWhenFiltered() {
		...
		Predicate predicateMock = mock(Predicate.class, "true");
