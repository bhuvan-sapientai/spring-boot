...
class CharSequenceToObjectConverterSapientGeneratedTest {
    ...
    //Sapient generated method id: ${matchesWhenSourceTypeGetTypeEqualsString}, hash: 36D1B610EA929D909A0C815E76764559
    @Test()
    ...
    //Sapient generated method id: ${matchesWhenTargetTypeEqualsBYTE_ARRAYAndIsStringConversionBetterNotSourceTypeTargetType}, hash: 4846DE5F766D46E3D2F669A1A99B291C
    @Test()
    ...
    //Sapient generated method id: ${matchesWhenIsStringConversionBetterSourceTypeTargetTypeAndThisConversionServiceCanConvertSTRINGTargetType}, hash: E6488B1AB9B021F0EF6131A504524A79
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${matchesWhenTargetTypeNotEqualsBYTE_ARRAYAndIsStringConversionBetterSourceTypeTargetTypeAndThisConversionServiceNotCanCo}, hash: 0AC90F379CDB0FD7867AD9EC3D2D0516
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${convertTest}, hash: B70E5DB4FD1A732AB9D3A54E8F5A5852
    @Test()
    void convertTest() {
        //Arrange Statement(s)
        CharSequenceToObjectConverter target = new CharSequenceToObjectConverter(conversionServiceMock);
