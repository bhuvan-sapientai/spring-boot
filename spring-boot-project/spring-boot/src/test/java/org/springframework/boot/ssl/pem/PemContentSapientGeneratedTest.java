...
class PemContentSapientGeneratedTest {
	...
	//Sapient generated method id: ${2b216bd1-213c-3ae7-8203-1ee6c92eb640}, hash: 331BC4E79CA05A7251F406F9EF471B79
	@Disabled()
	@Test()
	void loadWhenDefaultBranchThrowsThrowable() throws IOException, FileNotFoundException {
		...
		try (MockedStatic<PemContent> pemContent = mockStatic(PemContent.class, CALLS_REAL_METHODS);
			...
			streamUtils.when(() -> StreamUtils.copyToString((InputStream) any(), eq(charset))).thenReturn("return_of_copyToString1");
			...
			assertAll("result", () -> {
				...
				streamUtils.verify(() -> StreamUtils.copyToString((InputStream) any(), eq(charset)), atLeast(1));
				pemContent.verify(() -> PemContent.of("return_of_copyToString1"), atLeast(1));
			});
		}
	}

	//Sapient generated method id: ${905884fe-b108-3f80-b108-d8f417ad4b2e}, hash: 6A90386772E84E038979C73744A81088
	@Disabled()
	@Test()
	void loadWhenDefaultBranch() throws Throwable, IOException {
		...
		try (MockedStatic<PemContent> pemContent = mockStatic(PemContent.class, CALLS_REAL_METHODS)) {
			pemContent.when(() -> PemContent.isPresentInText("A")).thenReturn(false);
			pemContent.when(() -> PemContent.of("")).thenReturn(pemContentMock);
			//Act Statement(s)
			PemContent result = PemContent.load("A");
			//Assert statement(s)
			assertAll("result", () -> {
				assertThat(result, equalTo(pemContentMock));
				pemContent.verify(() -> PemContent.isPresentInText("A"), atLeast(1));
				pemContent.verify(() -> PemContent.of(""), atLeast(1));
			});
		}
	}

	//Sapient generated method id: ${072deebc-18b6-33aa-a10c-cfb9962572f8}, hash: F038479E32EA6DA94FAE802215FBAE35
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${20714769-25ee-37a8-a731-fabf2cb713e4}, hash: F54BC3EADE9D8D2B7BFFE26A7E7E6F47
	@Disabled()
	@Test()
