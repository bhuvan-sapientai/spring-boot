...
class SpringBootBannerSapientGeneratedTest {
	...
	//Sapient generated method id: ${97dc33a4-c770-39f5-8531-1dd36ef746cc}, hash: 9D63A6B33004E64BF2EB15DB4CA203F6
	@Disabled()
	@Test()
	void printBannerWhenPaddingLengthLessThanSTRAP_LINE_SIZEMinusVersionLengthPlusSPRING_BOOTLength() {
		...
		try (MockedStatic<AnsiOutput> ansiOutput = mockStatic(AnsiOutput.class);
			...
			springBootVersion.when(() -> SpringBootVersion.getVersion()).thenReturn(" (v2.5.0)");
			Object[] objectArray = new Object[] { AnsiColor.GREEN, " :: Spring Boot :: ", AnsiColor.DEFAULT, " ", AnsiStyle.FAINT, " (v (v2.5.0))" };
			ansiOutput.when(() -> AnsiOutput.toString(objectArray)).thenReturn(" :: Spring Boot :: ");
