...
class ErrorPageFilterSapientGeneratedTest {
    ...
    //Sapient generated method id: ${initTest}, hash: 26DD8C5B19443D3F81EE435DE3615F1D
    @Disabled()
    @Test()
    void initTest() throws ServletException {
        /*
         * TODO: Help needed! This method is not unit testable!
         *  A variable could not be isolated/mocked when calling a method - Variable name: delegate - Method: init
         *  Suggestions:
    ...
    //Sapient generated method id: ${doFilterTest}, hash: 46F84F0F79DA6DE5CB10F8198579A3F8
    @Disabled()
    @Test()
    void doFilterTest() throws IOException, ServletException {
        /*
         * TODO: Help needed! This method is not unit testable!
         *  A variable could not be isolated/mocked when calling a method - Variable name: delegate - Method: doFilter
         *  Suggestions:
         *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
         *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
         *  The test code, including the assertion statements, has been successfully generated.
    ...
    //Sapient generated method id: ${getDescriptionWhenRequestGetPathInfoIsNotNull}, hash: 1D521EA621495C8AB0D26F3AF10E8B07
    @Test()
    ...
    //Sapient generated method id: ${getDescriptionWhenRequestGetPathInfoIsNull}, hash: 77131F194777A280986A53E863876A06
    @Test()
    ...
    //Sapient generated method id: ${addErrorPagesWhenErrorPageIsGlobal}, hash: 33D93CA52142059C8EE7D89BB609042A
    @Test()
    ...
    //Sapient generated method id: ${addErrorPagesWhenErrorPageGetStatusIsNotNull}, hash: 22484298E623B9670D667DFBFC5CE4B7
    @Test()
    ...
    //Sapient generated method id: ${addErrorPagesWhenErrorPageGetStatusIsNull}, hash: D7D9ECC8F705D364409A7341F327373F
    @Test()
    ...
    //Sapient generated method id: ${getOrderTest}, hash: 4538D21452517454CAABD8D56C47FE7C
    @Test()
    void getOrderTest() {
        //Arrange Statement(s)
        ErrorPageFilter target = new ErrorPageFilter();
