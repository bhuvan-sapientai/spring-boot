...
class ConfigurationPropertiesBeanSapientGeneratedTest {
	...
	//Sapient generated method id: ${13368fac-223f-37ba-a843-3c9b25e276be}
	@Disabled()
	@Test()
	void getTypeTest() throws NoSuchElementException {
		...
		try (MockedStatic<MergedAnnotations> mergedAnnotations = mockStatic(MergedAnnotations.class);
			...
			resolvableType.when(() -> ResolvableType.forMethodReturnType((Method) null)).thenReturn(resolvableTypeMock);
			mergedAnnotations.when(() -> MergedAnnotations.from((Method) null, MergedAnnotations.SearchStrategy.TYPE_HIERARCHY)).thenReturn(mergedAnnotationsMock);
			...
			assertAll("result", () -> {
				...
				resolvableType.verify(() -> ResolvableType.forMethodReturnType((Method) null), atLeast(1));
				mergedAnnotations.verify(() -> MergedAnnotations.from((Method) null, MergedAnnotations.SearchStrategy.TYPE_HIERARCHY), atLeast(1));
	...
	//Sapient generated method id: ${43f6554e-3df6-3d8d-8e42-81c52fff7a95}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${79719c1b-729d-33eb-96d6-4f4edceef32f}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${70911d7e-d002-324c-a42c-245e3bbae264}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${5c52fa14-ad74-3141-a69e-7272698e46a4}
	@Test()
	...
	//Sapient generated method id: ${93524355-0c8e-3457-8cc1-489e34667617}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${d1344998-3062-3db5-8c71-2026c2a025f8}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${637d1cad-af51-34ef-a495-f09082b3a8cb}
	@Disabled()
	@Test()
	void getWhenBindTargetIsNotNull() throws NoSuchElementException {
		...
		try (MockedStatic<BindMethodAttribute> bindMethodAttribute = mockStatic(BindMethodAttribute.class);
			...
			mergedAnnotations.when(() -> MergedAnnotations.from((Method) null, MergedAnnotations.SearchStrategy.TYPE_HIERARCHY)).thenReturn(mergedAnnotationsMock).thenReturn(mergedAnnotationsMock4);
			...
			assertAll("result", () -> {
				...
				resolvableType.verify(() -> ResolvableType.forMethodReturnType((Method) null), atLeast(1));
				mergedAnnotations.verify(() -> MergedAnnotations.from((Method) null, MergedAnnotations.SearchStrategy.TYPE_HIERARCHY), atLeast(2));
				verify(mergedAnnotationsMock).get(Annotation.class);
				verify(mergedAnnotationMock).isPresent();
	...
	//Sapient generated method id: ${887517c9-64c2-3659-842a-c08c0e93f3fc}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${03d84ad8-cec6-3ccf-9a0b-2be56edffe26}
	@Test()
	...
	//Sapient generated method id: ${b1313bb1-8a73-36f1-8092-83dbfb089f43}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${df3a9861-4cbd-304c-accd-ffd439c79297}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${a237d700-8cc3-3ae6-a384-c70691414ff2}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${91beec94-4b36-3fb4-b0bb-7dad6b775c0d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${f10ba781-66e7-3c18-8fab-d6c748dddcd6}
	@Test()
	...
	//Sapient generated method id: ${09ff049a-d721-397c-b356-d42e6fb8f3ab}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${a1b381ac-175b-3317-8c0d-5a6003d5f0eb}
	@Disabled()
	@Test()
