...
class EventPublishingRunListenerSapientGeneratedTest {
    ...
    //Sapient generated method id: ${getOrderTest}, hash: AF35A1938D04F3708E24D04F821D3AA2
    @Test()
    void getOrderTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${startingTest}, hash: F9EBFAC92F00A8FFF035C837C5CBC7F5
    @Test()
    void startingTest() {
        /*
         * TODO: Help needed! This method is not unit testable!
         *  A variable could not be isolated/mocked when calling a method - Variable name: initialMulticaster - Method: addApplicationListener
         *  Suggestions:
    ...
    //Sapient generated method id: ${environmentPreparedTest}, hash: 82175188BC3CA98BCAA05A41D6D80FE2
    @Test()
    ...
    //Sapient generated method id: ${contextPreparedTest}, hash: 3579B2C7EE312ABDC41CFF14DC0E5C34
    @Test()
    ...
    //Sapient generated method id: ${contextLoadedWhenListenerNotInstanceOfApplicationContextAware}, hash: 619539A1397E0E09FDB3883830D57C3C
    @Test()
    ...
    //Sapient generated method id: ${startedTest}, hash: F2989AA35EB2FC0C608D350C826BAC35
    @Test()
    void startedTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${readyTest}, hash: 2573A7AE147A43278E2A1E7B938C1332
    @Test()
    void readyTest() {
        //Arrange Statement(s)
        try (MockedStatic<AvailabilityChangeEvent> availabilityChangeEvent = mockStatic(AvailabilityChangeEvent.class)) {
    ...
    //Sapient generated method id: ${failedWhenContextIsActive}, hash: 77056C87FCF30A2EBE01644A2499AC77
    @Test()
    ...
    //Sapient generated method id: ${failedWhenContextNotIsActiveAndContextNotInstanceOfAbstractApplicationContext}, hash: 54F123F90B4A410ABDB6867278B358EB
    @Test()
    void failedWhenContextNotIsActiveAndContextNotInstanceOfAbstractApplicationContext() {
         ...
         *
         * TODO: Help needed! This method is not unit testable!
         *  A variable could not be isolated/mocked when calling a method - Variable name: initialMulticaster - Method: multicastEvent
         *  Suggestions:
         *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
         *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
         *  The test code, including the assertion statements, has been successfully generated.
