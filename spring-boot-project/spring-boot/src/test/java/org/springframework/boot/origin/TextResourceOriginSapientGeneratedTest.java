...
class TextResourceOriginSapientGeneratedTest {
	...
	//Sapient generated method id: ${5455f6a6-c86e-3f05-be56-c037c0b1cda5}
	@Test()
	void getParentTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${3abf516b-1871-3fa1-9cbb-dc938b7959a8}
	@Disabled()
	@Test()
	void toStringWhenThisLocationIsNotNull() {
		...
		//Assert statement(s)
		assertAll("result", () -> assertThat(result, equalTo("A - <init>_textResourceOrigin.Location1")));
	}

	//Sapient generated method id: ${26ec678d-cb57-3082-89b9-53bf4a643f18}
	@Test()
	...
	//Sapient generated method id: ${1bfa8e28-7d41-3580-bef1-1034c1b433e9}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${6cb8512c-1161-3233-b9ac-7c529416afed}
	@Test()
