...
class DatabaseInitializationDependencyConfigurerSapientGeneratedTest {
	...
	//Sapient generated method id: ${ce40fea0-b825-3359-9140-d98e9640683a}
	@Test()
	void registerBeanDefinitionsWhenRegistryNotContainsBeanDefinitionName() throws BeanDefinitionStoreException {
		...
		doNothing().when(registryMock).registerBeanDefinition(eq("org.springframework.boot.sql.init.dependency.DatabaseInitializationDependencyConfigurer$DependsOnDatabaseInitializationPostProcessor"), (AbstractBeanDefinition) any());
		...
		assertAll("result", () -> {
			...
			verify(registryMock).registerBeanDefinition(eq("org.springframework.boot.sql.init.dependency.DatabaseInitializationDependencyConfigurer$DependsOnDatabaseInitializationPostProcessor"), (AbstractBeanDefinition) any());
		});
	}
}
