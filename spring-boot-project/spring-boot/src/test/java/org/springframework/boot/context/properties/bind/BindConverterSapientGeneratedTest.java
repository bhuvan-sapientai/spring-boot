...
class BindConverterSapientGeneratedTest {
	...
	//Sapient generated method id: ${69ef5508-56e7-3270-97e6-6a741d4d046b}, hash: A2412BF3A08E111D8F5EC80E6A37AE68
	@Test()
	void canConvertWhenServiceCanConvertSourceTypeTargetType() {
		...
		try (MockedStatic<TypeDescriptor> typeDescriptor = mockStatic(TypeDescriptor.class);
			...
			applicationConversionService.when(() -> ApplicationConversionService.getSharedInstance()).thenReturn(conversionService);
	...
	//Sapient generated method id: ${00d968af-8a7d-37e3-9dab-1c9ee4d8e197}, hash: 7FBBC7FD97A9FA911A7243B7DB255334
	@Test()
	...
	//Sapient generated method id: ${28330c3e-868a-37df-b436-0d4d42720d6d}, hash: 6C5C2670DB7CD69B133E70FB92283ACA
	@Test()
	...
	//Sapient generated method id: ${a2e4648d-e299-340f-9e00-eb9238f344ed}, hash: FC93194A4035EB99DE251A791E906BFB
	@Test()
	...
	//Sapient generated method id: ${082f5b7e-1fb1-3833-bcdf-bd53002ca1fa}, hash: 171E2C7088047DB0B2B815FAB112F2EF
	@Test()
