...
class MapConfigurationPropertySourceSapientGeneratedTest {
    ...
    //Sapient generated method id: ${putAllTest}, hash: 6B2258DD7828AA8DFD55424D9AAE1367
    @Test()
    void putAllTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${putAllWhenCaughtUnsupportedOperationExceptionThrowsIllegalArgumentException}, hash: 2439211AEEE238B0809E282A017A53F3
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${putWhenNameIsNotNull}, hash: A21753DB391A15B35F186C4E81324598
    @Test()
    ...
    //Sapient generated method id: ${putWhenNameIsNull}, hash: E05B1F2B0580CD5E8BBA09E24F2AB811
    @Test()
    ...
    //Sapient generated method id: ${getUnderlyingSourceTest}, hash: ECED74E6B7B39AAD5D431CDF47F08C09
    @Test()
    ...
    //Sapient generated method id: ${getConfigurationPropertyTest}, hash: 1A374A3FA5E74327131F7CF329D7663A
    @Test()
    void getConfigurationPropertyTest() {
        /*
         * TODO: Help needed! This method is not unit testable!
         *  A variable could not be isolated/mocked when calling a method - Variable name: delegate - Method: getConfigurationProperty
         *  Suggestions:
        ...
        try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
            ...
            stringObjectMap.put("object", object);
    ...
    //Sapient generated method id: ${iteratorTest}, hash: 0B0D41058A3F97BC971C60B7D3426AEF
    @Test()
    void iteratorTest() {
        //Arrange Statement(s)
        try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
    ...
    //Sapient generated method id: ${streamTest}, hash: 909D6EAAE440107605BEA88A034B4305
    @Test()
    void streamTest() {
        //Arrange Statement(s)
        try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
