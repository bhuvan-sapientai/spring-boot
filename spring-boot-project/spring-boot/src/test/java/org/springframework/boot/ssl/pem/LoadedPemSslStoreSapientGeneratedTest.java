...
class LoadedPemSslStoreSapientGeneratedTest {
    ...
    //Sapient generated method id: ${typeTest}, hash: D3AF885C544383098981ABC5F6E4045B
    @Disabled()
    @Test()
    void typeTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${aliasTest}, hash: 5D15F29873DC4CC724B245142027EF10
    @Disabled()
    @Test()
    void aliasTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${passwordTest}, hash: BEDED4EACED24ADB01EFB7513422EC52
    @Disabled()
    @Test()
    void passwordTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${certificatesTest}, hash: CFEBBE016F1AF3887DB7761842C03890
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${privateKeyTest}, hash: 46A516906B9B60AD0865E4EA3378DF35
    @Disabled()
    @Test()
    void privateKeyTest() {
        //Arrange Statement(s)
