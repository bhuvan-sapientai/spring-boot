...
class DefaultLogbackConfigurationSapientGeneratedTest {
	...
	private final FileSize fileSize3Mock = mock(FileSize.class);

	private final FileSize fileSize3Mock2 = mock(FileSize.class);

	private final LogFile logFileMock = mock(LogFile.class, "<init>_logFile1");
	...
	//Sapient generated method id: ${73bf880d-b16e-3b10-8f00-50934d137d81}, hash: AD56DE38478B60708B30C854A8DFD78A
	@Disabled()
	@Test()
	void applyWhenThisLogFileIsNull() throws ScanException {
		 ...
		 *  A variable could not be isolated or mocked when calling a method - Variable name: appender - Method: addFilter
		 *  Suggestions:
	...
	//Sapient generated method id: ${f14fc3e4-6ad1-3e38-a03c-6da1885c4205}, hash: EA48D44E8F076A1C6D14DDC6C3AB5FA4
	@Test()
	...
	//Sapient generated method id: ${10f024c7-1fcd-39e1-a198-fce3220f4171}, hash: E2292300F8411495428C2061CC6C7191
	@Test()
	...
	//Sapient generated method id: ${83171729-b395-34f2-83d0-db6dda33a03d}, hash: 3390C59CBE753414694D8BF082059A7F
	@Disabled()
	@Test()
	void applyWhenBooleanParseBooleanResolveConfigVal() throws ScanException {
		...
		try (MockedStatic<OptionHelper> optionHelper = mockStatic(OptionHelper.class);
			...
			sizeAndTimeBasedRollingPolicy.setTotalSizeCap(fileSize3Mock);
			sizeAndTimeBasedRollingPolicy.setMaxFileSize(fileSize3Mock2);
			...
			fileSize.when(() -> FileSize.valueOf("return_of_substVars1")).thenReturn(fileSize3Mock2).thenReturn(fileSize3Mock);
	...
	//Sapient generated method id: ${e903a608-9bc6-30cd-b3d2-e44982f9917d}, hash: D94D3B40E2B39D7651970436C392A375
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${bdb5fd0b-6ac5-396a-9a66-213f51411d82}, hash: 6B16D0400B0C7300D52020852081153B
	@Disabled()
	@Test()
