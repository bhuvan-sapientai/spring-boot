...
class DefaultSslManagerBundleSapientGeneratedTest {
	...
	private final SslStoreBundle storeBundleMock = mock(SslStoreBundle.class, "exampleStoreBundle");
	...
	//Sapient generated method id: ${7f36c4a2-eb8e-3ea9-a2db-fa5534af3737}, hash: 27516BA8F6F67E49EC34672EE9EB22EC
	@Disabled()
	@Test()
	void getKeyManagerFactoryInstanceTest() throws NoSuchAlgorithmException {
		...
		//Act Statement(s)
		KeyManagerFactory result = target.getKeyManagerFactoryInstance("RSA");
		//Assert statement(s)
		assertAll("result", () -> assertThat(result, is(notNullValue())));
	}

	//Sapient generated method id: ${688d4816-af85-3886-b3be-3776adec2c3c}, hash: B98142E465E363FBFC440F73FD619019
	@Disabled()
	@Test()
	void getTrustManagerFactoryInstanceTest() throws NoSuchAlgorithmException {
		...
		DefaultSslManagerBundle target = new DefaultSslManagerBundle(storeBundleMock, sslBundleKey);
		//Act Statement(s)
		TrustManagerFactory result = target.getTrustManagerFactoryInstance("<valid_algorithm_value>");
		//Assert statement(s)
		assertAll("result", () -> assertThat(result, is(notNullValue())));
	}
}
