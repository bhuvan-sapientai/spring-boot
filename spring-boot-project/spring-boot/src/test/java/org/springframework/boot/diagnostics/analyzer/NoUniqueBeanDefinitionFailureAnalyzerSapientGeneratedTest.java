...
class NoUniqueBeanDefinitionFailureAnalyzerSapientGeneratedTest {
	...
	//Sapient generated method id: ${e4d18dad-5216-3a78-b497-0dd59f754c79}
	@Test()
	...
	//Sapient generated method id: ${420e83fd-633d-3eef-bee9-0144f0fd7cec}
	@Test()
	...
	//Sapient generated method id: ${833eacca-32be-371a-bfb1-d8472f8673b8}
	@Disabled()
	@Test()
	void analyze3WhenResourceDescriptionIsNotNull() throws NoSuchBeanDefinitionException {
		...
		try (MockedStatic<MissingParameterNamesFailureAnalyzer> missingParameterNamesFailureAnalyzer = mockStatic(MissingParameterNamesFailureAnalyzer.class);
			...
			NoUniqueBeanDefinitionFailureAnalyzer target = new NoUniqueBeanDefinitionFailureAnalyzer(beanFactoryMock);
			doReturn(beanDefinitionMock).when(beanFactoryMock).getMergedBeanDefinition("arg0");
			...
			//Act Statement(s)
			FailureAnalysis result = target.analyze(throwable, noUniqueBeanDefinitionException, "description1");
			FailureAnalysis failureAnalysis = new FailureAnalysis("description1", "action1", noUniqueBeanDefinitionException);
			//Assert statement(s)
			...
			assertAll("result", () -> {
				...
				verify(beanFactoryMock).getMergedBeanDefinition("arg0");
	...
	//Sapient generated method id: ${2827698e-da01-37d9-9109-e2bfb5758c79}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${5be01d84-cfc5-31ce-8522-57c395482f85}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${6db1bb6c-21d5-3993-8869-72d0e508ed36}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${75e156d5-d2d0-3353-857c-0947bdd8c647}
	@Disabled()
	@Test()
