...
class ConfigDataLoadersSapientGeneratedTest {
	...
	//Sapient generated method id: ${e3cf0279-6830-3a5e-95c0-323aba8ef93f}
	@Disabled()
	@Test()
	void loadWhenResultIsNotNull() throws IOException, ConfigDataResourceNotFoundException {
		...
		try (MockedStatic<LogMessage> logMessage = mockStatic(LogMessage.class);
			...
			doReturn(null).when(logFactoryMock).getLog(ConfigDataLoaders.class);
	...
	//Sapient generated method id: ${8af7da23-036e-3ce2-a062-9f91b92a61a3}
	@Test()
