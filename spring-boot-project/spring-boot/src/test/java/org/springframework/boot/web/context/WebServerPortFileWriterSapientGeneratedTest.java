...
class WebServerPortFileWriterSapientGeneratedTest {
	...
	//Sapient generated method id: ${cb6408df-be20-3316-a61a-2aea15ca81ac}, hash: 957933E3645FAA6EC5E4E3C7711D8944
	@Test()
	...
	//Sapient generated method id: ${3f8e2b63-ec55-30bd-9a25-8574216baedd}, hash: 99BD8C57D145ABDA4AC0654198D08DE7
	@Test()
	void onApplicationEventWhenCaughtException() throws Exception {
		 ...
		 */
		//Arrange Statement(s)
		WebServerInitializedEvent eventMock = mock(WebServerInitializedEvent.class, "WebServerInitializedEvent");
		...
		try (MockedStatic<SystemProperties> systemProperties = mockStatic(SystemProperties.class)) {
			...
			doThrow(runtimeExceptionMock).when(eventMock).getWebServer();
			String[] stringArray = new String[] { "PORTFILE", "portfile" };
			systemProperties.when(() -> SystemProperties.get(stringArray)).thenReturn("return_of_get1");
			File file = new File("pathname1");
			WebServerPortFileWriter target = spy(new WebServerPortFileWriter(file));
			File file2 = new File("pathname1");
			doReturn(file2).when(target).getPortFile((WebServerApplicationContext) null);
			//Act Statement(s)
			target.onApplicationEvent(eventMock);
			//Assert statement(s)
			assertAll("result", () -> {
	...
	//Sapient generated method id: ${af218ee2-6ef1-3aa5-90a4-9801a7c14557}, hash: D1DBE0DE524ED3C1122479489D543B60
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${a680ee12-ecec-3145-b423-ea716a78a433}, hash: 6F4D8BCCD78EFED951BA3587B90EB8C8
	@Disabled()
	@Test()
