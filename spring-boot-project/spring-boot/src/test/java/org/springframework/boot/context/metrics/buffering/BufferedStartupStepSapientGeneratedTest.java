...
class BufferedStartupStepSapientGeneratedTest {
    ...
    //Sapient generated method id: ${getParentIdWhenThisParentIsNotNull}, hash: 2C7B80A2BF3478F40E546E1528337F7D
    @Test()
    ...
    //Sapient generated method id: ${getParentIdWhenThisParentIsNull}, hash: 6302C8CDF7A397997F273B94595520A2
    @Test()
    ...
    //Sapient generated method id: ${getTagsTest}, hash: 22560AF74AA2A4989A19E2933C570452
    @Test()
    void getTagsTest() {
        //Arrange Statement(s)
        Instant instant = Instant.ofEpochSecond(1700000000);
    ...
    //Sapient generated method id: ${tagTest}, hash: 6F0FDC6A238E5926E095C390BD7CB7F2
    @Disabled()
    @Test()
    void tagTest() {
        /*
    ...
    //Sapient generated method id: ${tag1WhenThisEndedNotGet}, hash: 2B051E5E51B143C38F38B93E2B3AF341
    @Test()
    ...
    //Sapient generated method id: ${endTest}, hash: E5DB0D469F7CF8D713CFA45E6FD31305
    @Test()
    void endTest() {
        /*
         * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
    ...
    //Sapient generated method id: ${isEndedTest}, hash: 3E3736E1AB5CDEDE274E07C15CA6D456
    @Test()
    void isEndedTest() {
        //Arrange Statement(s)
        Instant instant = Instant.ofEpochSecond(1700000000);
