...
class DelegatingFilterProxyRegistrationBeanSapientGeneratedTest {
	...
	//Sapient generated method id: ${73bb53de-f0cd-3876-958e-ebcb182f641a}, hash: E025BF52724CC84DB90CD647DC21AC86
	@Test()
	void getFilter1Test() {
		/*
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class, CALLS_REAL_METHODS)) {
			...
			DelegatingFilterProxyRegistrationBean target = new DelegatingFilterProxyRegistrationBean("<value>", servletRegistrationBeanArray);
			//Act Statement(s)
