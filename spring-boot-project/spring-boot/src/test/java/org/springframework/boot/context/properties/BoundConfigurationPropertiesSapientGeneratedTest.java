...
class BoundConfigurationPropertiesSapientGeneratedTest {
	...
	//Sapient generated method id: ${a1cf46f6-be94-3796-a037-ae640381b20e}
	@Test()
	...
	//Sapient generated method id: ${60b0428b-f3c6-30f7-a2c5-a75ca6b7f410}
	@Test()
	...
	void registerWhenRegistryNotContainsBeanDefinitionBEAN_NAME() throws BeanDefinitionStoreException {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
			...
			doNothing().when(registryMock).registerBeanDefinition(eq("org.springframework.boot.context.properties.BoundConfigurationProperties"), (AbstractBeanDefinition) any());
			...
			assertAll("result", () -> {
				...
				verify(registryMock).registerBeanDefinition(eq("org.springframework.boot.context.properties.BoundConfigurationProperties"), (AbstractBeanDefinition) any());
