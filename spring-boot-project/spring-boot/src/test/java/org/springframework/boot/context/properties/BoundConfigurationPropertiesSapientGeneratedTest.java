...
class BoundConfigurationPropertiesSapientGeneratedTest {
    ...
    //Sapient generated method id: ${addTest}, hash: 1110F0BF716B4E8D8E3F8A732A2F1E52
    @Test()
    void addTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${getTest}, hash: 8417CE05B3B86E02CD23B650B8EA6B9A
    @Test()
    void getTest() {
        //Arrange Statement(s)
        BoundConfigurationProperties target = new BoundConfigurationProperties();
    ...
    //Sapient generated method id: ${getAllTest}, hash: 20AE210C20DF2E779A517CD5F542776D
    @Test()
    void getAllTest() {
        //Arrange Statement(s)
        BoundConfigurationProperties target = new BoundConfigurationProperties();
    ...
    //Sapient generated method id: ${get1WhenContextNotContainsBeanDefinitionBEAN_NAME}, hash: E53F59794320329F99A8063BC10FB790
    @Test()
    ...
    //Sapient generated method id: ${get1WhenContextContainsBeanDefinitionBEAN_NAME}, hash: 74DDF01A9B1D3C9A69C615EDEB867ADB
    @Test()
    ...
    //Sapient generated method id: ${registerWhenRegistryNotContainsBeanDefinitionBEAN_NAME}, hash: B22EF1A3D2D153A8E90B53690420AA38
    @Test()
