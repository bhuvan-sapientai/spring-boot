...
class DefaultApplicationContextFactorySapientGeneratedTest {
    ...
    //Sapient generated method id: ${getEnvironmentTypeWhenDefaultResultIsNull}, hash: 8C8320AB33F8A4B7A2B65CF9A10EB074
    @Test()
    ...
    //Sapient generated method id: ${createEnvironmentWhenDefaultResultIsNull}, hash: 8E126FD0E3ADCD09A9A76099007D6C52
    @Test()
    ...
    //Sapient generated method id: ${createWhenDefaultResultIsNotNull}, hash: 7DA8ADA7A0FD4A8D3417F42DC3DEEED7
    @Test()
    void createWhenDefaultResultIsNotNull() throws Exception {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: defaultResult - Method: get
         *  Suggestions:
    ...
    //Sapient generated method id: ${createWhenCaughtExceptionThrowsIllegalStateException}, hash: 3DD587FE2E6DF29F275FE1A7674D98DA
    @Disabled()
    @Test()
