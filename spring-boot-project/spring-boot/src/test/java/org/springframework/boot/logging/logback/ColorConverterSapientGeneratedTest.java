...
class ColorConverterSapientGeneratedTest {
	...
	//Sapient generated method id: ${1c133f83-950a-39aa-a42e-462d588bfb25}, hash: FC519CD41EA053AE85890CDBD2BAD490
	@Test()
	void transform1WhenElementIsNullAndElementIsNotNull() {
		...
		try (MockedStatic<AnsiOutput> ansiOutput = mockStatic(AnsiOutput.class)) {
			...
			Object[] objectArray = new Object[] { ansiElementMock, "<value>" };
			...
			//Act Statement(s)
			String result = target.transform(eventMock, "<value>");
			//Assert statement(s)
			assertAll("result", () -> {
