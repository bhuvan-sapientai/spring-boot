...
class WebServletHandlerSapientGeneratedTest {
	...
	//Sapient generated method id: ${d5d9f3cb-67a4-3272-a28e-82b6863c712c}, hash: 80DAED57499B4BBE6417DFD5968C1728
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${a186b2e1-6c03-34ec-88de-e3cb1eac806f}, hash: 04E293857DC4E75B2C1149FCAA9BD764
	@Disabled()
	@Test()
	void doHandleWhenAttributesIsNotNull() throws BeanDefinitionStoreException {
		...
		try (MockedStatic<BeanDefinitionBuilder> beanDefinitionBuilder = mockStatic(BeanDefinitionBuilder.class)) {
			...
			stringObjectMap.put("location", object2);
			stringObjectMap.put("maxRequestSize", object3);
			stringObjectMap.put("maxFileSize", object4);
			...
			doReturn(beanDefinitionBuilderMock7).when(beanDefinitionBuilder3Mock).addConstructorArgValue(object2);
			doReturn(beanDefinitionBuilderMock8).when(beanDefinitionBuilder3Mock).addConstructorArgValue(object4);
			doReturn(beanDefinitionBuilderMock9).when(beanDefinitionBuilder3Mock).addConstructorArgValue(object3);
	...
	//Sapient generated method id: ${761a2088-4165-32b3-bddf-a261e5ec03bd}, hash: F0087E2C15EBD5F2C37BECC25FC26EBB
	@Disabled()
	@Test()
	void doHandleWhenStringUtilsNotHasTextAttributesGetNameAndAttributesIsNotNull() throws BeanDefinitionStoreException {
		...
		try (MockedStatic<BeanDefinitionBuilder> beanDefinitionBuilder = mockStatic(BeanDefinitionBuilder.class);
			...
			stringObjectMap.put("maxRequestSize", object4);
			doReturn(stringObjectMap).when(annotationMetadataMock).getAnnotationAttributes("jakarta.servlet.annotation.MultipartConfig");
			...
			doReturn(beanDefinitionBuilderMock9).when(beanDefinitionBuilder3Mock).addConstructorArgValue(object4);
			doReturn(beanDefinitionBuilderMock10).when(beanDefinitionBuilder3Mock).addConstructorArgValue(object);
			doReturn(abstractBeanDefinition).when(beanDefinitionBuilder3Mock).getBeanDefinition();
			beanDefinitionBuilder.when(() -> BeanDefinitionBuilder.rootBeanDefinition(ServletRegistrationBean.class)).thenReturn(builderMock);
