...
class TomcatReactiveWebServerFactorySapientGeneratedTest {
	...
	//Sapient generated method id: ${751f6ca7-6bb6-3d3e-9bff-1339f86a7da0}
	@Disabled()
	@Test()
	...
	void getWebServerWhenThisAdditionalTomcatConnectorsIsEmpty() throws IOException {
		...
		HttpHandler httpHandlerMock = mock(HttpHandler.class, "<value>");
	...
	//Sapient generated method id: ${9ed55df3-b75e-35e3-bf46-c2a0ef495d91}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${2ff5a4bd-56e1-30bb-9880-e829a6780922}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${9cd6b75a-51fe-39d9-aa7b-0a7d74fc0128}
	@Test()
	...
	void customizeConnectorWhenStringUtilsHasTextSslBundleNameAndThisTomcatConnectorCustomizersIsEmpty() throws NoSuchSslBundleException {
		...
		try (MockedStatic<WebServerSslBundle> webServerSslBundle = mockStatic(WebServerSslBundle.class);
			...
			doNothing().when(connectorMock).setPort(28957);
			...
			target = new TomcatReactiveWebServerFactory(28957);
			autoCloseableMocks = MockitoAnnotations.openMocks(this);
			...
			//Assert statement(s)
			assertAll("result", () -> {
				verify(connectorMock).setPort(28957);
	...
	void getTomcatWebServerWhenGetPortGreaterThanOrEqualsTo0() {
		...
		assertAll("result", () -> assertThat(result, equalTo(tomcatWebServer)));
	}
