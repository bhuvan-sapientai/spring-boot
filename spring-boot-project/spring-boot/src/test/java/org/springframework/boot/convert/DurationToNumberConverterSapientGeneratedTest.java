...
class DurationToNumberConverterSapientGeneratedTest {
	...
	//Sapient generated method id: ${56568c04-8c71-30f4-be77-6cf7f80ca7c3}, hash: 9AB60552D65E30EF522D5B8C0FD2172E
	@Disabled()
	@Test()
	void convertWhenAnnotationIsNotNull() throws Exception {
		...
		try (MockedStatic<DurationStyle.Unit> durationStyleUnit = mockStatic(DurationStyle.Unit.class, CALLS_REAL_METHODS)) {
			durationStyleUnit.when(() -> DurationStyle.Unit.fromChronoUnit(ChronoUnit.NANOS)).thenReturn(DurationStyle.Unit.SECONDS);
			DurationToNumberConverter target = new DurationToNumberConverter();
	...
	//Sapient generated method id: ${802ce6f6-3b94-363b-9ea3-1b9489384e53}, hash: CE52A8169729A68A3CFCDB5331285C38
	@Disabled()
	@Test()
	void convertWhenAnnotationIsNull() throws Exception {
		...
		DurationToNumberConverter target = new DurationToNumberConverter();
		Duration durationMock = mock(Duration.class, "PT20S");
		//Act Statement(s)
		Object result = target.convert((Object) durationMock, sourceTypeMock, targetTypeMock);
		//Assert statement(s)
		//TODO: Please implement equals method in Object for verification of the entire object or you need to adjust respective assertion statements
		assertAll("result", () -> {
			assertThat(result, is(notNullValue()));
	...
	//Sapient generated method id: ${bf4655be-9b11-3161-9595-f7df1c00f2e7}, hash: A95CCD631BA0E4F55A8A3D493956CD7B
	@Disabled()
	@Test()
