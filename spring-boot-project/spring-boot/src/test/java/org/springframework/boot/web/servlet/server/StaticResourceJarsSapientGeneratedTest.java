...
class StaticResourceJarsSapientGeneratedTest {
	...
	//Sapient generated method id: ${118e01f4-1faf-3b15-93b3-0cf387ec1ffd}
	@Test()
	...
	//Sapient generated method id: ${1e56f988-b0ef-3c38-80f7-3bd2d83140c0}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${3fdb69f1-d197-3fb8-b0c1-f50414769dbf}
	@Test()
	void getUrlsFromWhenIsResourcesJarNotJarURLConnection() throws URISyntaxException, IOException {
		/* Branches:
		 * (for-each(urls)) : true
	...
	//Sapient generated method id: ${768bbee9-504e-3a24-b649-9e5dc2a04229}
	@Test()
	void getUrlsFromWhenIsResourcesJarJarURLConnection() throws URISyntaxException, IOException {
		/* Branches:
		 * (for-each(urls)) : true
		 * (!"file".equals(url.getProtocol())) : true  #  inside addUrl method
		 * (connection instanceof JarURLConnection jarURLConnection) : true  #  inside addUrlConnection method
		...
		//Act Statement(s)
		//List<URL> result = target.getUrlsFrom(uRLArray);
		//List<URL> uRLResultList = new ArrayList<>();
		//uRLResultList.add((URL) null);
		//Assert statement(s)
        /*assertAll("result", () -> {
    assertThat(result.size(), equalTo(uRLResultList.size()));
    assertThat(result, containsInRelativeOrder(uRLResultList.toArray()));
});*/
	}

	//Sapient generated method id: ${2d58f4fd-41df-3a8d-a49b-3516ff8df318}
	@Test()
	...
	//Sapient generated method id: ${29e51881-8a7e-35d7-8827-e81171dfc019}
	@Test()
	...
	//Sapient generated method id: ${1b5cc1ba-a9a2-37d6-92ba-ee3d9668c900}
	@Test()
	void getUrlsFromWhenJarFileGetNameNotEndsWith_jarAndNotCloseJarFileAndIsResourcesJarNotJarURLConnection() throws URISyntaxException, IOException {
		...
		//Arrange Statement(s)
		//StaticResourceJars target = new StaticResourceJars();
		//URL[][] uRLArray3 = new URL[][] { (URL) null };
		//URL[] uRLArray2 = new URL[] { uRLArray3 };
		//URL[][] uRLArray5 = new URL[][] { (URL) null };
		//URL[] uRLArray4 = new URL[] { uRLArray5 };
		//URL[] uRLArray = new URL[] { uRLArray2, uRLArray4 };
		//Act Statement(s)
		//List<URL> result = target.getUrlsFrom(uRLArray);
		//Assert statement(s)
		//assertAll("result", () -> assertThat(result.size(), equalTo(0)));
	...
	//Sapient generated method id: ${0bf0b868-e626-3c78-9477-da4fe5be3d15}
	@Test()
	...
	//Sapient generated method id: ${6e918a8d-396c-3e99-a462-17377cb7dfbc}
	@Test()
	...
	//Sapient generated method id: ${8d9ccbe3-94ef-35a9-a39d-53413083602a}
	@Test()
	...
	//Sapient generated method id: ${4e07e697-2c30-363e-a847-64e52ead09fb}
	@Test()
