...
class ClientHttpRequestFactoriesSapientGeneratedTest {
	...
	//Sapient generated method id: ${a68b91b7-5fc8-3b1c-b4c4-351bd8093b79}
	@Test()
	...
	//Sapient generated method id: ${3f573db9-3ba0-3efe-a87a-10095c3b08e5}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${050cddae-1063-3626-8133-5e136f6c3ce0}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${bdc67078-792b-3083-9388-f8cabbc87b35}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${808814c3-22ac-30e7-b42f-05e0304b52d9}
	@Test()
	...
	//Sapient generated method id: ${1e81cac3-f2f6-3b18-89e6-358cc6cf21a9}
	@Test()
	...
	//Sapient generated method id: ${ef87021b-ac45-3ac1-9c8b-b5473dc4cfc6}
	@Test()
	...
	//Sapient generated method id: ${7c426a17-9fe8-3a6f-92c3-d25d87da4cb7}
	@Test()
	...
	//Sapient generated method id: ${e42c3b2d-efee-3364-96fb-ab96dc225600}
	@Test()
	...
	//Sapient generated method id: ${be782244-bd76-349f-8176-7b33f635f68f}
	@Test()
	...
	//Sapient generated method id: ${42102760-fc2b-3f43-8fbd-621c4fa4959b}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${f91f2aed-7f5a-319b-98be-57aee8abb063}
	@Test()
	void get2Test() {
		//Arrange Statement(s)
		try (MockedStatic<ClientHttpRequestFactories.Reflective> clientHttpRequestFactoriesReflective = mockStatic(ClientHttpRequestFactories.Reflective.class)) {
			clientHttpRequestFactoriesReflective.when(() -> ClientHttpRequestFactories.Reflective.get((Supplier) null, clientHttpRequestFactorySettingsMock)).thenReturn(clientHttpRequestFactoryMock);
			//TODO: Needs initialization with real value
			Supplier supplier = null;
			//Act Statement(s)
			ClientHttpRequestFactory result = ClientHttpRequestFactories.get(supplier, clientHttpRequestFactorySettingsMock);
			//Assert statement(s)
			assertAll("result", () -> {
				assertThat(result, equalTo(clientHttpRequestFactoryMock));
				clientHttpRequestFactoriesReflective.verify(() -> ClientHttpRequestFactories.Reflective.get((Supplier) null, clientHttpRequestFactorySettingsMock), atLeast(1));
			});
		}
	}
}
