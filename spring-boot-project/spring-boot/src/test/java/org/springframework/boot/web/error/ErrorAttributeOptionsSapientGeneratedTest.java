...
class ErrorAttributeOptionsSapientGeneratedTest {
	...
	//Sapient generated method id: ${35f0f4ab-412e-3056-8667-753e42c94144}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${822a83a2-284a-33a9-8ffe-554ea9eff52d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${65571caf-0ccc-3618-9b02-a1b6b1b5188b}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${c5a06bfd-66be-38ef-b28d-0e92dfe844d6}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${c9420936-bdbc-3910-b319-e4e79bb2e3fa}
	@Disabled()
	@Test()
	void excludingWhenThisIncludesNotIsEmpty() {
		...
		try (MockedStatic<ErrorAttributeOptions> errorAttributeOptions = mockStatic(ErrorAttributeOptions.class)) {
			errorAttributeOptions.when(() -> ErrorAttributeOptions.of(anyList())).thenReturn(errorAttributeOptionsMock);
			ErrorAttributeOptions.Include[] includeArray = new ErrorAttributeOptions.Include[] { ErrorAttributeOptions.Include.EXCEPTION };
			ErrorAttributeOptions target = ErrorAttributeOptions.of(includeArray);
			ErrorAttributeOptions.Include[] includeArray2 = new ErrorAttributeOptions.Include[] { ErrorAttributeOptions.Include.EXCEPTION };
			//Act Statement(s)
			ErrorAttributeOptions result = target.excluding(includeArray2);
			//Assert statement(s)
			assertAll("result", () -> {
	...
	//Sapient generated method id: ${4b4fc6cd-cf6b-3df3-a6d2-5600586aed20}
	@Test()
	void defaultsTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${fc846735-0584-305f-b1a5-cb9daaf4b871}
	@Test()
	...
	//Sapient generated method id: ${fb56b6d0-0c10-3485-b06b-08765b22cd89}
	@Test()
	void of1WhenIncludesNotIsEmpty() {
		...
		//Act Statement(s)
		ErrorAttributeOptions result = ErrorAttributeOptions.of(collection);
		Collection<ErrorAttributeOptions.Include> collectionCollection = new ArrayList<>();
		collectionCollection.add(ErrorAttributeOptions.Include.EXCEPTION);
		//Assert statement(s)
		assertAll("result", () -> {
			assertThat(result, is(notNullValue()));
			assertThat(collection.size(), equalTo(collectionCollection.size()));
			assertThat(collection, containsInRelativeOrder(collectionCollection.toArray()));
		});
	}
}
