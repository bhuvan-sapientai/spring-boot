...
class ValueObjectBinderSapientGeneratedTest {
	...
	private final Object objectMock = mock(Object.class);
	...
	//Sapient generated method id: ${e7777e7a-937a-3703-905e-a47723d7f6f8}, hash: 55C5323B917BEA77A1A12A69BA3427E1
	@Disabled()
	@Test()
	void bindWhenDefaultValueLengthNotEquals0AndNotBound() {
		...
		doReturn(objectMock).when(bindConverterMock).convert(stringArray, resolvableTypeMock2, annotationArray);
	...
	//Sapient generated method id: ${2c19e2c5-9a2b-3fc5-b5a6-106a12f8424d}, hash: 1600448EBDA135B3CC8E04C288D6089E
	@Disabled()
	@Test()
	void bindWhenDefaultValueLengthEquals1AndNotBound() {
		...
		doReturn(object).when(bindConverterMock).convert(stringArray, resolvableTypeMock2, annotationArray);
		doReturn(stringArray).when(defaultValueMock).value();
		doReturn(objectMock).when(bindConverterMock).convert("return_of_valueItem1", resolvableTypeMock2, annotationArray);
		doNothing().when(contextMock).clearConfigurationProperty();
		doNothing().when(contextMock).popConstructorBoundTypes();
		ValueObjectBinder target = new ValueObjectBinder(bindConstructorProviderMock);
		ConfigurationPropertyName configurationPropertyName = ConfigurationPropertyName.of("bind_configurationPropertyName1-name1");
	...
	//Sapient generated method id: ${f7a9c911-158c-3edf-9684-e66e05956f1e}, hash: 1A422BDF8019683CE7900B30877D44B8
	@Disabled()
	@Test()
	void createWhenDefaultValueLengthNotEquals0() {
		...
		String[] stringArray = new String[] { "return_of_valueItem1" };
		Annotation[] annotationArray = new Annotation[] { defaultValueMock };
		doReturn(objectMock).when(bindConverterMock).convert(stringArray, resolvableTypeMock, annotationArray);
		doReturn(stringArray).when(defaultValueMock).value();
		ValueObjectBinder target = new ValueObjectBinder(bindConstructorProviderMock);
		//Act Statement(s)
	...
	//Sapient generated method id: ${c048560a-1fee-3839-bdd8-8b17d65e50dc}, hash: 15A78DD296AD36DF1AB610AE4EB55514
	@Disabled()
	@Test()
	void createWhenDefaultValueLengthEquals1() {
		...
		doReturn(stringArray).when(defaultValueMock).value();
		doReturn(objectMock).when(bindConverterMock).convert("return_of_valueItem1", resolvableTypeMock, annotationArray);
		ValueObjectBinder target = new ValueObjectBinder(bindConstructorProviderMock);
		//Act Statement(s)
		Object result = target.create(bindableMock, contextMock);
		//Assert statement(s)
	...
	//Sapient generated method id: ${0b33c793-dd49-30cd-a55b-68b0ea844f32}, hash: A0A06400AB31643EFA3A77D9F10B1975
	@Disabled()
	@Test()
