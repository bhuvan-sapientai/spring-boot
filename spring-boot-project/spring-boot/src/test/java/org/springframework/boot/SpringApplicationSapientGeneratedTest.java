...
class SpringApplicationSapientGeneratedTest {
	...
	//Sapient generated method id: ${3e7af4bd-9984-3984-a7be-79318e0c493a}, hash: 7044B2C5EA7BCFCD90C5BC227C149BFB
	@Disabled()
	@Test()
	void runWhenExceptionInstanceOfAbandonedRunExceptionThrowsSpringApplicationAbandonedRunException() throws IllegalStateException, BeansException {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class, CALLS_REAL_METHODS);
			...
			springFactoriesLoader.when(() -> SpringFactoriesLoader.forDefaultResourceLocation((ClassLoader) any())).thenReturn(springFactoriesLoaderMock).thenReturn(springFactoriesLoaderMock2).thenReturn(springFactoriesLoaderMock3).thenReturn(springFactoriesLoaderMock4);
			List<SpringApplicationRunListener> springApplicationRunListenerList = new ArrayList<>();
			doReturn(springApplicationRunListenerList).when(springFactoriesLoaderMock4).load(eq(SpringApplicationRunListener.class), (SpringFactoriesLoader.ArgumentResolver) any());
			...
			doReturn(org.springframework.core.env.ConfigurableEnvironment.class).when(applicationContextFactoryMock).getEnvironmentType(WebApplicationType.NONE);
			...
			assertAll("result", () -> {
				...
				verify(springApplicationStartupMock, atLeast(1)).started();
				verify(springApplicationStartupMock, atLeast(1)).timeTakenToStarted();
				verify(springFactoriesLoaderMock4, atLeast(1)).load(eq(SpringApplicationRunListener.class), (SpringFactoriesLoader.ArgumentResolver) any());
	...
	//Sapient generated method id: ${84f7d002-e180-33f9-9ad7-da295fbf2101}, hash: D25AB1451F5BCD059DA567EF47AEF0FD
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${d3164a5d-0756-36d7-bfaa-12e2f652e42d}, hash: 09A34CDC05E999CCACCEAFADA1AF699C
	@Disabled()
	@Test()
	void runWhenExceptionNotInstanceOfRuntimeExceptionThrowsIllegalStateException() throws IllegalStateException, BeansException {
		...
		try (MockedStatic<SpringFactoriesLoader> springFactoriesLoader = mockStatic(SpringFactoriesLoader.class, CALLS_REAL_METHODS);
			...
			aotDetector.when(() -> AotDetector.useGeneratedArtifacts()).thenReturn(false);
			_assert.when(() -> Assert.notEmpty(anySet(), eq("Sources must not be empty"))).thenAnswer((Answer<Void>) invocation -> null);
			springFactoriesLoaderArgumentResolver.when(() -> SpringFactoriesLoader.ArgumentResolver.of(ConfigurableApplicationContext.class, configurableApplicationContextMock)).thenReturn(springFactoriesLoaderArgumentResolverMock);
			ApplicationStartup applicationStartup = ApplicationStartup.DEFAULT;
			doNothing().when(configurableApplicationContextMock).setApplicationStartup(applicationStartup);
			doNothing().when(configurableApplicationContextMock).setEnvironment((ConfigurableEnvironment) any());
			doReturn(null).when(configurableApplicationContextMock).getParent();
			...
			doReturn(collection).when(springFactoriesLoaderMock2).load(SpringBootExceptionReporter.class, springFactoriesLoaderArgumentResolverMock);
			target = spy(new SpringApplication(resourceLoaderMock, classArray));
			autoCloseableMocks = MockitoAnnotations.openMocks(this);
			doReturn(null).when(resourceLoaderMock).getClassLoader();
			ClassLoader classLoader = ClassLoader.getPlatformClassLoader();
			String[] stringArray2 = new String[] {};
			...
			assertAll("result", () -> {
				assertThat(result, is(notNullValue()));
				verify(applicationContextFactoryMock, times(2)).createEnvironment(WebApplicationType.NONE);
				verify(applicationContextFactoryMock, times(2)).getEnvironmentType(WebApplicationType.NONE);
				_assert.verify(() -> Assert.notNull(classArray, "PrimarySources must not be null"), atLeast(1));
				webApplicationType.verify(() -> WebApplicationType.deduceFromClasspath(), atLeast(1));
				...
				verify(springFactoriesLoaderMock, atLeast(1)).load(eq(SpringApplicationRunListener.class), (SpringFactoriesLoader.ArgumentResolver) any());
				configurationPropertySources.verify(() -> ConfigurationPropertySources.attach((ConfigurableEnvironment) null), atLeast(1));
				defaultPropertiesPropertySource.verify(() -> DefaultPropertiesPropertySource.moveToEnd((ConfigurableEnvironment) null), atLeast(1));
				configurationPropertySources.verify(() -> ConfigurationPropertySources.attach((Environment) any()), atLeast(1));
				aotDetector.verify(() -> AotDetector.useGeneratedArtifacts(), atLeast(2));
				...
				verify(springFactoriesLoaderMock2, atLeast(1)).load(SpringBootExceptionReporter.class, springFactoriesLoaderArgumentResolverMock);
				verify(resourceLoaderMock, times(3)).getClassLoader();
	...
	//Sapient generated method id: ${47998f2c-e1fa-3346-b77b-7a9bf045784a}, hash: D856D4139EB2872FB3DC524ECBB0A003
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${018a18ba-3224-3ac9-a6c0-8b5f893cf169}, hash: ABF382354A9028F0AF72BA09CF5537A7
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${1c16bcf4-118d-3712-a3e9-e2b279e1fef1}, hash: 2D60F20ACABAEF73A1A85C00B513152F
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${e0f442ca-4495-38d9-8886-c07c87b2a590}, hash: 058F4F976AAE669C85277AF12534E869
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${0919dc49-1474-3ca3-9a46-c293d6fa39d7}, hash: 1F56EC19B590BACC0C8E20B382FF635C
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${890d1e16-f411-30d8-8955-b00f093a4f32}, hash: 8ED1C4467A6935D088F9804054C91285
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${b23810c3-dac9-3d30-ac48-d7155f542c94}, hash: FA5BC3D71470B660C028EC177A7E6E64
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${212b5c97-e6ec-340e-86c7-b3128cd97492}, hash: 183EDF525FD3BE013AECA5AFE94FE525
	@Test()
	...
	//Sapient generated method id: ${fe1d6de4-9f0b-30ee-bd41-02e2cb0fc896}, hash: AF7E311B57FBEF3AECE5A77ADD021B4D
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${4d3f5881-2df7-36f6-ba0e-d378cc1c9961}, hash: 9E37A26DFE9850C11DFB27B94722BB9F
	@Test()
	...
	//Sapient generated method id: ${12ba3654-5a20-3d01-9ac3-101c24d7b881}, hash: D27EF1BC0BE3A497D982C1643D27D09A
	@Test()
	...
	//Sapient generated method id: ${9c00b33b-c8a9-3d56-a6c8-a065898a22cf}, hash: A1011632810D12EB13A169853413C3CF
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${42bd8e04-a447-3f2d-8974-3d8cc8bc6382}, hash: 5F86F746A92A01D05F397D0E55FA0793
	@Test()
	...
	//Sapient generated method id: ${3225fa7f-29dc-3094-b54a-9418ca3a1291}, hash: 987171E660564EC018DCB037E893B904
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${63370684-1d57-3cda-a9f9-2089947d8a17}, hash: 6509BE333BCD2CE93C6C806F83963BB4
	@Test()
	...
	//Sapient generated method id: ${3ebd3d04-76b3-320f-b304-f0b6a8fe009f}, hash: 922A17AC485A5DC20E40F050F2F756FF
	@Test()
	...
	//Sapient generated method id: ${4a576cbb-85af-3f7f-a0a4-d2bcf1755ecd}, hash: 7E6AA2D1C702F5EE1A956AFE3DA5D102
	@Test()
	...
	//Sapient generated method id: ${2183ec8d-e159-326b-b1a0-fcaea33dd430}, hash: 7280D1AD2C39B52BF76992D839FC82D1
	@Test()
	...
	//Sapient generated method id: ${cfe5d614-23fb-3836-bd5d-b3a4127ae5c2}, hash: 1A1A40124B258B9FCFF12CC7849C008D
	@Test()
	...
	//Sapient generated method id: ${ca0a65e6-fc8d-3f7b-89c4-6575e2140f17}, hash: F687792419091BAB9405D676BBCD4EF8
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${62e170bc-1441-3662-bd95-fcc548180549}, hash: E57597963CB649DDFA8B1F8DAF494BBD
	@Test()
	...
	//Sapient generated method id: ${8bb24f6d-f691-3a0b-9b67-f93813cee29d}, hash: B519561D6438D0B82D9D49143EDE5C14
	@Test()
	...
	//Sapient generated method id: ${b266c308-ccb6-3103-9704-4dad9dcc13c6}, hash: AFB5091CBAA0FB3ECA7C0F32ADBCC4F4
	@Disabled()
	@Test()
	void setSourcesTest() {
		/*
	...
	//Sapient generated method id: ${2a4d4666-3ec6-3350-bbd2-d61740db6402}, hash: 912B69A013D9864B0DCF9B0BFE5B6A9E
	@Test()
	...
	//Sapient generated method id: ${3914a37c-38bf-3ffa-81f3-16abba975add}, hash: B2504BEBA7313B8323395891D7F681D9
	@Test()
	...
	//Sapient generated method id: ${cbecbfed-0103-33c5-ae0e-fbba9246ad93}, hash: 44BA046D7CB6CA1639DA319F7F86E642
	@Test()
	...
	//Sapient generated method id: ${595291b2-32f5-3310-98d3-672101248388}, hash: 83D96E8A3EB1BA18469057FCF3B512E3
	@Test()
	...
	//Sapient generated method id: ${989e71c1-43b5-3b60-bd3d-0b55b3617114}, hash: 3FE5994318DC58CA4210AB2A2B0BDCD1
	@Test()
	...
	//Sapient generated method id: ${757246c3-9d4b-3c3b-9de8-9c3b71e7f6c4}, hash: 832427F6FB4CC8BA136D7A9EA6AF4753
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${4738b7b6-3b1c-3a7b-9897-15d45c98ffbc}, hash: 648465FABA416D603526750D598CCB48
	@Test()
	...
	//Sapient generated method id: ${8c3502b2-ba78-3b5d-ae77-8a49ede199a4}, hash: C799D307EBEBFF9B70A009A0E99332C6
	@Test()
	...
	//Sapient generated method id: ${b1c37231-1147-3ac0-8762-d7c1e4be3220}, hash: 60C0BD99657654B685935AAB8C2A1F16
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${42991c09-c463-3ec4-93af-0a8b46b20a6a}, hash: C8169DFDC4E0D88C00467845F69C78CB
	@Test()
	...
	//Sapient generated method id: ${5af4d4a4-5a21-3907-ba98-a9d64a2bc8cb}, hash: 876168E028758958835CE38B44B8616C
	@Test()
	...
	//Sapient generated method id: ${df8a3a78-9698-3221-ad1a-aa38be07d856}, hash: 46F6961E759E6FB5B4FE8C8253C9B227
	@Disabled()
	@Test()
	void run2Test() {
		/*
