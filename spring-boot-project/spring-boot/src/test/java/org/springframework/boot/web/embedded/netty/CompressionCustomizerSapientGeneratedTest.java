...
class CompressionCustomizerSapientGeneratedTest {
	...
	//Sapient generated method id: ${0263efdf-b2b2-3c4f-9608-2b5474d1095c}
	@Disabled()
	@Test()
	void applyWhenObjectUtilsIsEmptyExcludedUserAgents() {
		 ...
		 */
		//Arrange Statement(s)
		doReturn(httpServerMock).when(serverMock).compress(1);
		doReturn(httpServerMock2).when(httpServerMock).compress((BiPredicate) null);
		...
		assertAll("result", () -> {
			...
			verify(serverMock).compress(1);
			verify(httpServerMock).compress((BiPredicate) null);
			verify(dataSizeMock).isNegative();
			verify(dataSizeMock).toBytes();
		});
	}

	//Sapient generated method id: ${955b9637-0678-382c-b30a-1e872fea7a40}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${e4103881-f17c-3166-9f39-f408c70f933c}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${ae89a5c9-1f5c-3e18-bc6d-ed2890f43d61}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${bb542f5c-741f-3b1e-9c2b-087478f1b2d1}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${91fb3902-65d9-3e08-8055-6f8f286de3f0}
	@Disabled()
	@Test()
