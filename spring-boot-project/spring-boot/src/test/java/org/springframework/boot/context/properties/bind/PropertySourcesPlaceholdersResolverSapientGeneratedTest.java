...
class PropertySourcesPlaceholdersResolverSapientGeneratedTest {
	...
	//Sapient generated method id: ${f55b244d-d45e-37b8-b852-86b4d940632d}, hash: DEE4DADE698956A669BBD0C89069F973
	@Disabled()
	@Test()
	void resolvePlaceholderWhenValueIsNotNull() {
		...
		PropertySourcesPlaceholdersResolver target = new PropertySourcesPlaceholdersResolver(iterableMock, propertyPlaceholderHelper);
		//Act Statement(s)
		String result = target.resolvePlaceholder("example");
		//Assert statement(s)
