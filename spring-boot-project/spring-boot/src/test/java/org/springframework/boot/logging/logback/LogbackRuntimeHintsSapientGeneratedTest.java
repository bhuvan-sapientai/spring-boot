...
class LogbackRuntimeHintsSapientGeneratedTest {
	...
	//Sapient generated method id: ${2b490b9b-fb0c-374c-a8f2-5b7e79d5719c}
	@Test()
	...
	//Sapient generated method id: ${0ff589e8-d5e8-3035-8631-66b859419ffc}
	@Disabled()
	@Test()
	void registerHintsWhenClassUtilsIsPresentCh_qos_logback_classic_LoggerContextClassLoader() {
		...
		try (MockedStatic<TypeReference> typeReference = mockStatic(TypeReference.class);
			...
			Class[] classArray = new Class[] { DateTokenConverter.class, IntegerTokenConverter.class, SyslogStartConverter.class };
			typeReference.when(() -> TypeReference.listOf(classArray)).thenReturn(typeReferenceList);
			Class[] classArray2 = new Class[] { ColorConverter.class, ExtendedWhitespaceThrowableProxyConverter.class, WhitespaceThrowableProxyConverter.class, CorrelationIdConverter.class };
