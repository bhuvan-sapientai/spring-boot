...
class SimpleAsyncTaskExecutorBuilderSapientGeneratedTest {
    ...
    //Sapient generated method id: ${threadNamePrefixTest}, hash: 397E33F46578EB2551285E8B8DDEEF72
    @Test()
    ...
    //Sapient generated method id: ${virtualThreadsTest}, hash: 1D7733C49EA07DDF18DE8FD3F31FEBBF
    @Test()
    ...
    //Sapient generated method id: ${concurrencyLimitTest}, hash: A1595B660976884C25F61D2E5727C66C
    @Test()
    ...
    //Sapient generated method id: ${taskDecoratorTest}, hash: 95EC7D80A2BB783A4068B02658165286
    @Test()
    ...
    //Sapient generated method id: ${taskTerminationTimeoutTest}, hash: A07AF8D2E29CF8CE45ED84A65E0F157B
    @Test()
    ...
    //Sapient generated method id: ${customizersTest}, hash: 9A57DF8F97B1FC3F480D3D5E73CEBB1F
    @Test()
    ...
    //Sapient generated method id: ${customizers1WhenSetIsNull}, hash: CD511683AC0A23BBE2832EE421015849
    @Test()
    ...
    //Sapient generated method id: ${additionalCustomizersTest}, hash: 8266EF7702D03BB9AD5D359ABDC858C5
    @Test()
    ...
    //Sapient generated method id: ${additionalCustomizers1WhenSetIsNull}, hash: 5FD498212D1DE5DDF777BF9602EE67FE
    @Test()
    ...
    //Sapient generated method id: ${buildTest}, hash: 84DA1171D25C8F532C9608A09D12B3D5
    @Test()
    void buildTest() {
        //Arrange Statement(s)
        SimpleAsyncTaskExecutorBuilder target = spy(new SimpleAsyncTaskExecutorBuilder());
    ...
    //Sapient generated method id: ${build1Test}, hash: 13C3BA68C04E32AB1BE6443C498B7E84
    @Test()
    void build1Test() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${configureWhenCollectionUtilsIsEmptyThisCustomizers}, hash: 57DC79AA48323D380212A7291569D3E6
    @Disabled()
    @Test()
