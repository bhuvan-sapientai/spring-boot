...
class DelegatingLoggingSystemFactorySapientGeneratedTest {
	...
	private final Function<ClassLoader, List<LoggingSystemFactory>> delegatesMock = mock(Function.class, "delegates");

	//Sapient generated method id: ${1570d71d-a1ea-36ee-8069-ab2dc5347812}, hash: 7E3B0A73CCA10A7C6944985FB36E9D62
	@Test()
	void getLoggingSystemWhenLoggingSystemIsNotNull() {
		...
		LoggingSystem loggingSystemMock = mock(LoggingSystem.class);
