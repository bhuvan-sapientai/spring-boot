...
class NettyRSocketServerFactorySapientGeneratedTest {
	...
	//Sapient generated method id: ${914392cb-5114-3e2a-9155-1bddb71a5db8}, hash: 99CF5C23BFEE09D79ACF3B95AEB36838
	@Test()
	...
	//Sapient generated method id: ${8c1c2428-d157-32f2-bc6f-8c9530bee6fe}, hash: 20CFFC57E3326F437245382734E9659E
	@Test()
	...
	//Sapient generated method id: ${633803c5-cc12-35af-a90b-9dfa32ea9f35}, hash: DD6F0ECF03425D6EC35167DE582DCFFD
	@Test()
	void createWhenSslNotIsEnabledThisSsl() {
		...
		try (MockedStatic<PropertyMapper> propertyMapper = mockStatic(PropertyMapper.class);
			...
			//Assert statement(s)
			//TODO: Please implement equals method in NettyRSocketServer for verification of the entire object or you need to adjust respective assertion statements
			assertAll("result", () -> {
