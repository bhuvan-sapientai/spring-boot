...
class StandardConfigDataLoaderSapientGeneratedTest {
    ...
    private final ConfigDataLocation configDataLocationMock2 = mock(ConfigDataLocation.class, "configDataLocation2");
    ...
    private final StandardConfigDataResource resourceMock = mock(StandardConfigDataResource.class, "resource");
    ...
    //Sapient generated method id: ${loadWhenResourceIsEmptyDirectory}, hash: 6D5965722E9903B81672900737F0AEC8
    @Test()
    ...
    //Sapient generated method id: ${loadWhenResourceGetProfileIsNotNull}, hash: 7B5359ED23A5941C380E5BD0B6BE6EC4
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${loadWhenResourceGetProfileIsNull}, hash: 93C5A9D79B2FC85B5371A0DE88217BA6
    @Disabled()
    @Test()
