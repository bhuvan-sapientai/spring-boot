...
class ThreadPoolTaskSchedulerBuilderSapientGeneratedTest {
	...
	void poolSizeTest() {
		...
		ThreadPoolTaskSchedulerBuilder threadPoolTaskSchedulerBuilder = new ThreadPoolTaskSchedulerBuilder(1, false, duration, "threadNamePrefix1", threadPoolTaskSchedulerCustomizerSet);
		//Assert statement(s)
		//TODO: Please implement equals method in ThreadPoolTaskSchedulerBuilder for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> assertThat(result, equalTo(threadPoolTaskSchedulerBuilder)));
	}
	...
	void awaitTerminationTest() {
		...
		ThreadPoolTaskSchedulerBuilder threadPoolTaskSchedulerBuilder = new ThreadPoolTaskSchedulerBuilder(0, false, duration, "threadNamePrefix1", threadPoolTaskSchedulerCustomizerSet);
		//Assert statement(s)
		//TODO: Please implement equals method in ThreadPoolTaskSchedulerBuilder for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> assertThat(result, equalTo(threadPoolTaskSchedulerBuilder)));
	}
	...
	void awaitTerminationPeriodTest() {
		...
		ThreadPoolTaskSchedulerBuilder threadPoolTaskSchedulerBuilder = new ThreadPoolTaskSchedulerBuilder(0, false, duration2, "threadNamePrefix1", threadPoolTaskSchedulerCustomizerSet);
		//Assert statement(s)
		//TODO: Please implement equals method in ThreadPoolTaskSchedulerBuilder for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> assertThat(result, equalTo(threadPoolTaskSchedulerBuilder)));
	}
	...
	void customizers1WhenSetIsNull() {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
			...
			Set<ThreadPoolTaskSchedulerCustomizer> threadPoolTaskSchedulerCustomizerSet = new HashSet<>();
			ThreadPoolTaskSchedulerBuilder target = new ThreadPoolTaskSchedulerBuilder(0, false, duration, "threadNamePrefix1", threadPoolTaskSchedulerCustomizerSet);
			Iterable<ThreadPoolTaskSchedulerCustomizer> iterable = null;
			//Act Statement(s)
