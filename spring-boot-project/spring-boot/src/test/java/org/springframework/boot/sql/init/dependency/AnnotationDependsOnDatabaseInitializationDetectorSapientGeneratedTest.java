...
class AnnotationDependsOnDatabaseInitializationDetectorSapientGeneratedTest {
	...
	//Sapient generated method id: ${371149c7-48d2-3388-8b14-0667892d3ed9}
	@Disabled()
	@Test()
	void detectWhenBeanFactoryFindAnnotationOnBeanBeanNameDependsOnDatabaseInitializationFalseIsNotNull() throws NoSuchBeanDefinitionException {
		...
		doReturn(null).when(beanFactoryMock).findAnnotationOnBean("return_of_getBeanDefinitionNamesItem1", DependsOnDatabaseInitialization.class, false);
