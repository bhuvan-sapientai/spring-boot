...
class ServletContextInitializerBeansSapientGeneratedTest {
	...
	//Sapient generated method id: ${d9edcbff-0783-39fd-a93e-eb38531ddf19}, hash: 74C01742C2B75570601D7DB688653026
	@Disabled()
	@Test()
	void addAdaptableBeansWhenSeenNotContainsTypeBeanAndBeansIsEmptyAndServletListenerRegistrationBeanGetSupportedTypesIsNotEmpt() throws BeansException {
		...
		doReturn(object5).when(beanFactoryMock).getBean("E", HttpSessionAttributeListener.class);
		...
		String[] stringArray7 = new String[] { "B" };
		doReturn(stringArray5, stringArray7).when(beanFactoryMock).getBeanNamesForType(HttpSessionAttributeListener.class, true, false);
		Object object7 = new Object();
		doReturn(object7).when(beanFactoryMock).getBean("B", HttpSessionAttributeListener.class);
		...
		assertAll("result", () -> {
			...
			verify(beanFactoryMock, times(2)).getBeanNamesForType(HttpSessionAttributeListener.class, true, false);
			verify(beanFactoryMock).getBean("E", HttpSessionAttributeListener.class);
			verify(beanFactoryMock).getBean("F", MultipartConfigElement.class);
			verify(beanFactoryMock).getBean("B", HttpSessionAttributeListener.class);
