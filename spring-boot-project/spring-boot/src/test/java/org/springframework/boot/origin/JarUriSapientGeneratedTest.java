...
class JarUriSapientGeneratedTest {
	...
	//Sapient generated method id: ${46267df3-cfc0-3d4a-aef4-4b72c4a0138b}, hash: 69D3E1CF0DBEA19E268F80E992226BA6
	@Test()
	void getDescription1Test() {
		//Arrange Statement(s)
		try (MockedStatic<JarUri> jarUri = mockStatic(JarUri.class)) {
			jarUri.when(() -> JarUri.from("x1")).thenReturn(jarUriMock);
			...
			assertAll("result", () -> {
				...
				jarUri.verify(() -> JarUri.from("x1"), atLeast(1));
			});
		}
	}

	//Sapient generated method id: ${363d3698-f34c-39ad-914f-376a19498023}, hash: 0DE20F7C1027CD409A61EC2D680C6938
	@Test()
	void toStringTest() {
		//Arrange Statement(s)
		try (MockedStatic<JarUri> jarUri = mockStatic(JarUri.class)) {
	...
	//Sapient generated method id: ${75b57cb1-444a-3fb9-bd56-a8c3b1a5a77c}, hash: 1EF3BC72C3A98CE7D53F47865111F52C
	@Test()
	void fromTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${72855e9c-5fd0-38f6-bd15-7d6f21bddb99}, hash: 4C753B7C4535F1017534DB7910391C51
	@Test()
	...
	//Sapient generated method id: ${afec6a9a-42e4-3a4d-a4bd-9db1f75d4de7}, hash: A24C111A9861C9D12A0FA608433F5DB7
	@Test()
	...
	//Sapient generated method id: ${d7a8654b-9090-3412-88cc-ed7b6c9c278f}, hash: CD10DBF89D192157E1E65D8130BECD2C
	@Test()
