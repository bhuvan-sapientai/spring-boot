...
class ConfigurationPropertiesBindingPostProcessorSapientGeneratedTest {
	...
	//Sapient generated method id: ${5e4a16e7-3979-39b2-b914-192e6d28c84a}
	@Test()
	...
	//Sapient generated method id: ${e6126cec-8afc-3bb1-ba53-10f7f5367792}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${c9adc945-173e-3492-af14-dbfd76804149}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${a612dd02-cfe1-3d7f-a31d-2371d7a0eb0e}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${4d7d246d-b274-319d-9bb1-bb0939771461}
	@Disabled()
	@Test()
	...
	void registerWhenRegistryNotContainsBeanDefinitionBEAN_NAME() throws BeanDefinitionStoreException {
		...
		try (MockedStatic<ConfigurationPropertiesBinder> configurationPropertiesBinder = mockStatic(ConfigurationPropertiesBinder.class);
			...
			doNothing().when(registryMock).registerBeanDefinition(eq("org.springframework.boot.context.properties.ConfigurationPropertiesBindingPostProcessor"), (AbstractBeanDefinition) any());
			...
			assertAll("result", () -> {
				...
				verify(registryMock).registerBeanDefinition(eq("org.springframework.boot.context.properties.ConfigurationPropertiesBindingPostProcessor"), (AbstractBeanDefinition) any());
