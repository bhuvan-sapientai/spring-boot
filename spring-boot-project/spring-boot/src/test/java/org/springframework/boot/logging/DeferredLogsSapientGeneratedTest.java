...
class DeferredLogsSapientGeneratedTest {
	...
	//Sapient generated method id: ${272bcec7-07e5-34f3-9cc3-86d806553584}, hash: D396CE348656DBCFC9CB108060A9CAFB
	@Disabled()
	@Test()
	void switchOverAllWhenThisLoggersIsEmpty() {
		...
		try (MockedStatic<DeferredLog> deferredLog = mockStatic(DeferredLog.class)) {
			...
			//Assert statement(s)
			assertAll("result", () -> deferredLog.verify(() -> DeferredLog.logTo(noOpLog, LogLevel.TRACE, object, throwable), atLeast(1)));
		}
	}
}
