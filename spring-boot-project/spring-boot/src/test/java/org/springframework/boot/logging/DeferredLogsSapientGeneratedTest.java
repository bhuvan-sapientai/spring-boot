...
class DeferredLogsSapientGeneratedTest {
    ...
    //Sapient generated method id: ${getLogTest}, hash: 3FBE4C16E4EFBE82A28FFBFFA850FCA8
    @Test()
    void getLogTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${getLog1Test}, hash: 15F6E9720C577734A0F41BEAE220B76F
    @Test()
    void getLog1Test() {
        //Arrange Statement(s)
        DeferredLogs target = spy(new DeferredLogs());
    ...
    //Sapient generated method id: ${getLog2Test}, hash: BCB783981B4AD82FB91D4FB5A16DE83E
    @Test()
    void getLog2Test() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${switchOverAllWhenThisLoggersIsEmpty}, hash: 9E4EE7F1E9EF0C3968CE11D9FB3509ED
    @Disabled()
    @Test()
    void switchOverAllWhenThisLoggersIsEmpty() {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: var2 - Method: hasNext
         *  Suggestions:
