...
class SslConnectorCustomizerSapientGeneratedTest {
    ...
    //Sapient generated method id: ${updateTest}, hash: D70F6E798C04869413706FCB61CAD09C
    @Test()
    ...
    //Sapient generated method id: ${customizeWhenOptionsGetEnabledProtocolsIsNotNull}, hash: 62B2A66D8B071649547E49D00B268EAD
    @Disabled()
    @Test()
    void customizeWhenOptionsGetEnabledProtocolsIsNotNull() throws Exception {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: sslHostConfig - Method: addCertificate
         *  Suggestions:
    ...
    //Sapient generated method id: ${customizeWhenCaughtExceptionThrowsIllegalStateException}, hash: E272FACD9D19815EA8F8FACD5EED3015
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${customizeWhenStoresGetKeyStoreIsNullAndStoresGetTrustStoreIsNullAndOptionsGetEnabledProtocolsIsNull7}, hash: E984CEB8DC137D9663F29FBC953EFF81
    @Test()
