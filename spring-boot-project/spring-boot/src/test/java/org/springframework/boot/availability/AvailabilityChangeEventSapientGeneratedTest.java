...
class AvailabilityChangeEventSapientGeneratedTest {
	...
	//Sapient generated method id: ${ccc44468-b0a5-319f-ae80-41e9abbf402a}
	@Test()
	void getStateTest() {
		/**
	...
	//Sapient generated method id: ${0fdcc628-f655-30f9-a6a4-254974870393}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${590cd13f-424c-34cb-95b0-2654fa9768cf}
	@Test()
	void publishTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${125fc076-78de-38a4-953e-6a261fd08c0c}
	@Test()
	void publish1Test() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
