...
class InstantiatorSapientGeneratedTest {
	...
	//Sapient generated method id: ${82924032-459c-3122-937e-f03e9b5ac3f9}
	@Disabled()
	@Test()
	void instantiateTest() {
		 ...
		 */
		//Arrange Statement(s)
		Instantiator<Object> target = spy(new Instantiator(Object.class, (Consumer) null, failureHandlerMock));
	...
	//Sapient generated method id: ${80c68cc7-92aa-31d8-8a86-6d3765d76d4d}
	@Disabled()
	@Test()
	void instantiate1WhenArgsIsNotNull() {
		...
		try (MockedStatic<ReflectionUtils> reflectionUtils = mockStatic(ReflectionUtils.class);
			...
			Instantiator<Object> target = new Instantiator(Object.class, (Consumer) null, failureHandlerMock);
	...
	//Sapient generated method id: ${9590d6b3-45d0-38a9-85da-3103db50c568}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${c1726a3c-ea37-3412-be59-248ad82f7d1f}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${248ac416-ede7-37a0-8746-14c013ad530b}
	@Disabled()
	@Test()
