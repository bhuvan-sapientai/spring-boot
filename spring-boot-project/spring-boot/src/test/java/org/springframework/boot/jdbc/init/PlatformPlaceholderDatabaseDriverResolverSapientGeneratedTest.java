...
class PlatformPlaceholderDatabaseDriverResolverSapientGeneratedTest {
	...
	//Sapient generated method id: ${35df3e6b-7260-32b3-9251-b0aea004ed27}, hash: 3873929BA7BF1131FF6D3C81A63E7CA5
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${3a131fb2-d4a4-32c3-948e-4b7b7c089d4c}, hash: 8B7A714741A04A6F4B7FBCB549CAF85C
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${2e8bef5a-6f89-32ac-857a-5cb73309b76b}, hash: FD7CAC92039D9C079A348F7F8A75C5FD
	@Test()
    ...
    jdbcUtils.when(() -> JdbcUtils.extractDatabaseMetaData(eq(dataSourceMock), (DataSource) any())).thenReturn("A");
    PlatformPlaceholderDatabaseDriverResolver target = new PlatformPlaceholderDatabaseDriverResolver("placeholder1");
    //Act Statement(s)
    ...
    assertAll("result", () -> {
        ...
        jdbcUtils.verify(() -> JdbcUtils.extractDatabaseMetaData(eq(dataSourceMock), (DataSource) any()), atLeast(1));
    });
}*/
	}

	//Sapient generated method id: ${afe0124a-dd92-3f53-9f7a-32fa5ead7403}, hash: D7947D5E8E864DA7EC992BBFACD679BB
	@Test()
