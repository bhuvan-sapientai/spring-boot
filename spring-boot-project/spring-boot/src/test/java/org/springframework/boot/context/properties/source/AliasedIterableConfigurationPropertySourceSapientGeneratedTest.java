...
class AliasedIterableConfigurationPropertySourceSapientGeneratedTest {
    ...
    //Sapient generated method id: ${streamTest}, hash: 8EAFA786647A392E46A775CC4DFDAD5D
    @Test()
    void streamTest() {
        /*
    ...
    //Sapient generated method id: ${getSource1Test}, hash: 31218262D7AFFD85664C2F3B395AE84B
    @Test()
    void getSource1Test() {
        //Arrange Statement(s)
        try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
