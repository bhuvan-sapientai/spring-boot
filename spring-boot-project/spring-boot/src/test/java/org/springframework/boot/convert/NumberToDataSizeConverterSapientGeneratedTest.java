...
class NumberToDataSizeConverterSapientGeneratedTest {
	...
	void convertWhenSourceIsNotNull() {
		...
		StringToDataSizeConverter stringToDataSizeConverter = new StringToDataSizeConverter();
		TypeDescriptor typeDescriptor = TypeDescriptor.valueOf(String.class);
		Object object = stringToDataSizeConverter.convert("convert_object1", typeDescriptor, typeDescriptorMock2);
		//Assert statement(s)
	...
	void convertWhenSourceIsNull() {
		...
		StringToDataSizeConverter stringToDataSizeConverter = new StringToDataSizeConverter();
		TypeDescriptor typeDescriptor = TypeDescriptor.valueOf(String.class);
		Object object2 = stringToDataSizeConverter.convert(null, typeDescriptor, typeDescriptorMock2);
		//Assert statement(s)
		//TODO: Please implement equals method in Object for verification to succeed or you need to adjust respective assertion statements
