...
class CompressionConnectorCustomizerSapientGeneratedTest {
	...
	//Sapient generated method id: ${3f29487e-8d09-3c1a-bd25-2d1aca98659f}
	@Test()
	void customizeWhenThisCompressionGetExcludedUserAgentsIsNotNull() {
		...
		doNothing().when(protocolMock).setCompressionMinSize(1);
		...
		assertAll("result", () -> {
			...
			verify(protocolMock).setCompressionMinSize(1);
