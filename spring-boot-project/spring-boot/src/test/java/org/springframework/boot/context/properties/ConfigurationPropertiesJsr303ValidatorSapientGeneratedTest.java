...
class ConfigurationPropertiesJsr303ValidatorSapientGeneratedTest {
	...
	void supportsWhenThisDelegateSupportsType() {
		 ...
		 */
		//Arrange Statement(s)
		ApplicationContext applicationContextMock = mock(ApplicationContext.class, "ApplicationContext");
	...
	void supportsWhenThisDelegateNotSupportsType() {
		 ...
		 */
		//Arrange Statement(s)
		ApplicationContext applicationContextMock = mock(ApplicationContext.class, "<value>");
		ConfigurationPropertiesJsr303Validator target = new ConfigurationPropertiesJsr303Validator(applicationContextMock);
		//Act Statement(s)
		boolean result = target.supports(Object.class);
		//Assert statement(s)
	...
	void validateTest() {
		 ...
		 */
		//Arrange Statement(s)
		ApplicationContext applicationContextMock = mock(ApplicationContext.class, "valid_applicationContext_value");
		ConfigurationPropertiesJsr303Validator target = new ConfigurationPropertiesJsr303Validator(applicationContextMock);
		Object object = new Object();
		Errors errorsMock = mock(Errors.class, "valid_errors_value");
		//Act Statement(s)
