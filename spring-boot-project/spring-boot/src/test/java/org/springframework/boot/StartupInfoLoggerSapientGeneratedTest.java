...
class StartupInfoLoggerSapientGeneratedTest {
	...
	private final Duration durationMock = mock(Duration.class);
	...
	//Sapient generated method id: ${8504f7d1-6a37-39c6-ab07-523a20473aea}, hash: 758FE62D4D2D0E1A60CDCE20F8187C0F
	...
	void logStartedWhenUptimeMsIsNotNull() throws Exception {
		...
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class)) {
			...
			doReturn(durationMock).when(startupMock).timeTakenToStarted();
			doReturn(1L).when(durationMock).toMillis();
	...
	//Sapient generated method id: ${9dd8ed23-fc40-3d93-a829-591273f62890}, hash: 6656DE05FBD0A4B9B6BE975A4CC9D079
	@Disabled(value = "Potential harmful system call (Callable.call) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	void logStartedWhenStringUtilsNotHasLengthValueAndStringUtilsNotHasLengthValueAndUptimeMsIsNull() throws Exception {
		...
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class)) {
			doReturn("<value>").when(startupMock).action();
			doReturn(durationMock).when(startupMock).timeTakenToStarted();
			doReturn(0L).when(durationMock).toMillis();
	...
	//Sapient generated method id: ${50c1a04c-aa6d-3e04-b0cf-3f81c44fcf3e}, hash: E49090A1D9CB4084C037782DDD224A83
	@Disabled(value = "Potential harmful system call (Callable.call) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	void logStartedWhenMessageNotIsEmptyAndUptimeMsIsNull() throws Exception {
		 ...
		 */
		//Arrange Statement(s)
		NoOpLog applicationLogMock = mock(NoOpLog.class, "NoOpLog");
		SpringApplication.Startup startupMock = mock(SpringApplication.Startup.class, "start");
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class)) {
			doReturn(true).when(applicationLogMock).isInfoEnabled();
			StringBuilder stringBuilder = new StringBuilder();
			doNothing().when(applicationLogMock).info(stringBuilder);
			...
			StartupInfoLogger target = new StartupInfoLogger(Object.class);
			//Act Statement(s)
			target.logStarted(applicationLogMock, startupMock);
			//Assert statement(s)
			assertAll("result", () -> {
				verify(applicationLogMock).isInfoEnabled();
				verify(applicationLogMock).info(stringBuilder);
				verify(startupMock).action();
				verify(startupMock).timeTakenToStarted();
				verify(durationMock).toMillis();
				verify(startupMock).processUptime();
	...
	//Sapient generated method id: ${61edd902-ad58-32aa-ab5d-983574a500dd}, hash: 9407EF73B57752F7A68A9F4664FC3097
	@Disabled()
	@Test()
