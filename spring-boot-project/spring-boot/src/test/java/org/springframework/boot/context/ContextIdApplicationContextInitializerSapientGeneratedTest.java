...
class ContextIdApplicationContextInitializerSapientGeneratedTest {
    ...
    //Sapient generated method id: ${initializeWhenParentContainsBeanContextIdGetName}, hash: B61C3DC11B0BF1F889E2F53CC5502492
    @Test()
    ...
    //Sapient generated method id: ${initializeWhenStringUtilsHasTextName}, hash: 6DC0A7C2849B8505D1B9C34D0795C815
    @Disabled()
    @Test()
    void initializeWhenStringUtilsHasTextName() throws IllegalStateException {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: contextId - Method: getId
         *  Suggestions:
    ...
    //Sapient generated method id: ${initializeWhenParentNotContainsBeanContextIdGetNameAndStringUtilsNotHasTextName}, hash: 9855F54539A89522B75DA8F373F936D7
    @Disabled()
    @Test()
