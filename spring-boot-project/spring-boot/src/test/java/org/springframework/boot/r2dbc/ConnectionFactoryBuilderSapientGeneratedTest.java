...
class ConnectionFactoryBuilderSapientGeneratedTest {
	...
	//Sapient generated method id: ${f56d41b4-cf00-3592-bb68-9a89456c3c5f}, hash: 23C0052551E7944CCE8F706F653C07EF
	@Disabled()
	@Test()
	void configureTest() {
		//Arrange Statement(s)
		Consumer optionsMock = mock(Consumer.class, "ConnectionFactoryOptions");
		ConnectionFactoryBuilder connectionFactoryBuilderMock = mock(ConnectionFactoryBuilder.class, "ConnectionFactoryBuilder");
	...
	//Sapient generated method id: ${394a5b4b-a81c-32e5-a50d-fb551a21e859}, hash: 4F34847CBCD7AE4BC3D2326D5789B68A
	@Disabled()
	@Test()
	void hostnameTest() {
		/*
	...
	//Sapient generated method id: ${4b22df10-a8c1-3a60-a0e1-afa6700edc07}, hash: 2B825B7BB3325926DF5D35EE1FB38E82
	@Disabled()
	@Test()
	void portTest() {
		//Arrange Statement(s)
		ConnectionFactoryBuilder connectionFactoryBuilderMock2 = mock(ConnectionFactoryBuilder.class);
		try (MockedStatic<ConnectionFactoryBuilder> connectionFactoryBuilder = mockStatic(ConnectionFactoryBuilder.class);
			 MockedStatic<ConnectionFactoryOptions> connectionFactoryOptions = mockStatic(ConnectionFactoryOptions.class);
			 MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
			_assert.when(() -> Assert.hasText(eq("url1"), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
	...
	//Sapient generated method id: ${86964bde-330e-3613-92e1-338ea5306909}, hash: 1EF0F837791C3F0C997BC0E208ED14E1
	@Disabled()
	@Test()
	void databaseTest() {
		/*
	...
	//Sapient generated method id: ${9c52951b-3694-339a-bc67-eabb104eb353}, hash: 8DFD29186BF211E2D68192E031B0CF43
	@Disabled()
	@Test()
	void decoratorTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${c8934ae0-763c-3cf8-be7a-39d7180272be}, hash: 0FBF03B411514E750831BD90ABC4E5DE
	@Disabled()
	@Test()
	void decoratorsWhenDecoratorsIsNotEmpty() {
		 ...
		 */
		//Arrange Statement(s)
		Iterable decoratorsMock = mock(Iterable.class);
		ConnectionFactoryBuilder connectionFactoryBuilderMock = mock(ConnectionFactoryBuilder.class, "ConnectionFactoryBuilder");
		try (MockedStatic<ConnectionFactoryBuilder> connectionFactoryBuilder = mockStatic(ConnectionFactoryBuilder.class);
			 MockedStatic<ConnectionFactoryOptions> connectionFactoryOptions = mockStatic(ConnectionFactoryOptions.class);
			 MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
			doReturn(null).when(decoratorsMock).iterator();
			_assert.when(() -> Assert.hasText(eq("String"), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
			connectionFactoryOptions.when(() -> ConnectionFactoryOptions.parse("String")).thenReturn(connectionFactoryOptionsMock);
			doReturn(connectionFactoryOptionsBuilderMock).when(connectionFactoryOptionsMock).mutate();
			connectionFactoryBuilder.when(() -> ConnectionFactoryBuilder.withOptions(connectionFactoryOptionsBuilderMock)).thenReturn(connectionFactoryBuilderMock);
			ConnectionFactoryBuilder target = ConnectionFactoryBuilder.withUrl("String");
			//Act Statement(s)
			ConnectionFactoryBuilder result = target.decorators(decoratorsMock);
			//Assert statement(s)
			assertAll("result", () -> {
				assertThat(result, equalTo(target));
				verify(decoratorsMock).iterator();
				_assert.verify(() -> Assert.hasText(eq("String"), (Supplier) any()));
				connectionFactoryOptions.verify(() -> ConnectionFactoryOptions.parse("String"), atLeast(1));
				verify(connectionFactoryOptionsMock).mutate();
				connectionFactoryBuilder.verify(() -> ConnectionFactoryBuilder.withOptions(connectionFactoryOptionsBuilderMock), atLeast(1));
