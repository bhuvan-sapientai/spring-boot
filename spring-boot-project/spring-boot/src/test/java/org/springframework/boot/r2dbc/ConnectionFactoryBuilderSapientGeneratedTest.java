...
class ConnectionFactoryBuilderSapientGeneratedTest {
	...
	//Sapient generated method id: ${f56d41b4-cf00-3592-bb68-9a89456c3c5f}, hash: 6F726CEDAF4F927E07A57CB0655AA5C1
	@Test()
	void configureTest() {
		//Arrange Statement(s)
		Consumer optionsMock = mock(Consumer.class, "ConnectionFactoryOptions");
		ConnectionFactoryOptions connectionFactoryOptionsMock = mock(ConnectionFactoryOptions.class, "ConnectionFactoryOptions");
