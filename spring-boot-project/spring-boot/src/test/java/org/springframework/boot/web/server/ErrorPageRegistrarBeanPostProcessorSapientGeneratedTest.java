...
class ErrorPageRegistrarBeanPostProcessorSapientGeneratedTest {
	...
	//Sapient generated method id: ${6a498d31-c29e-3164-874e-02924a8e16ac}, hash: 4D0A636037EB26643298BF5A56108FA5
	@Test()
	...
	//Sapient generated method id: ${046a55f8-72ca-3fc9-b1e9-f87be879d206}, hash: 4BC19EA1490140003BE2290446B53063
	@Test()
	void postProcessBeforeInitializationWhenGetRegistrarsIsEmpty() throws BeansException {
		...
		//Act Statement(s)
		Object result = target.postProcessBeforeInitialization((Object) errorPageRegistryMock, "<value>");
	...
	//Sapient generated method id: ${4cfb5025-dae0-38fb-9400-154ec4849360}, hash: 5FA455014C34335C2CCC9CD6E1CF1427
	@Test()
