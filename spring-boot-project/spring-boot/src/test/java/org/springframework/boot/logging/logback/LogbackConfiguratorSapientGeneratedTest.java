...
class LogbackConfiguratorSapientGeneratedTest {
	...
	//Sapient generated method id: ${31c564db-0ad3-3c6d-b37c-50f945e58f85}
	@Test()
	...
	//Sapient generated method id: ${dbfdc72e-ac3e-3b2d-922a-c3615e7ca2e7}
	@Test()
	...
	//Sapient generated method id: ${32b8870a-a87b-3b45-9ae9-f44732d8a2c7}
	@Test()
	void appenderTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${0cf8ebb2-2c2c-309e-a87a-378be02e6efd}
	@Test()
	void loggerTest() {
		//Arrange Statement(s)
        /*try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
	...
	//Sapient generated method id: ${6b1210eb-7306-3c43-9351-7bb5e1a868e9}
	@Test()
	void logger1Test() {
		//Arrange Statement(s)
        /*try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
	...
	//Sapient generated method id: ${e147d52b-7eb6-3842-9144-2f38b18f9e21}
	@Test()
	...
	//Sapient generated method id: ${93e29cb6-0e7e-3db5-973c-c0807d2db0ba}
	@Test()
	...
	//Sapient generated method id: ${3fe34f2f-108d-309d-9530-d663e42f27d9}
	@Test()
