...
class SpringProfileModelHandlerSapientGeneratedTest {
    ...
    //Sapient generated method id: ${handleWhenAcceptsProfilesNotInterconProfileModel}, hash: E16196A9AC022453E2C0C82D163B415A
    @Test()
    ...
    //Sapient generated method id: ${handleWhenProfileNamesLengthEquals0AndAcceptsProfilesNotInterconProfileModel}, hash: 0FD58973FCC080C88B902A6438FE2D1A
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${handleWhenCaughtScanExceptionThrowsRuntimeException}, hash: DD2ED9EF932DF4222A9CC29E8DDACD82
    @Disabled()
    @Test()
    void handleWhenCaughtScanExceptionThrowsRuntimeException() throws ModelHandlerException, ScanException {
        ...
        try (MockedStatic<OptionHelper> optionHelper = mockStatic(OptionHelper.class)) {
            doReturn("A").when(modelMock).getName();
            optionHelper.when(() -> OptionHelper.substVars("return_of_trimArrayElementsItem1", modelInterpretationContextMock, contextMock)).thenThrow(scanExceptionMock);
            SpringProfileModelHandler target = new SpringProfileModelHandler(contextMock, environmentMock);
            //Act Statement(s)
            ...
            assertAll("result", () -> {
                ...
                optionHelper.verify(() -> OptionHelper.substVars("return_of_trimArrayElementsItem1", modelInterpretationContextMock, contextMock), atLeast(1));
            });
        }
    }

    //Sapient generated method id: ${handleWhenAcceptsProfilesInterconProfileModel}, hash: 34A530DB81FF3CA8BC52E28FFA7258AB
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${handleWhenThisEnvironmentNotAcceptsProfilesProfilesOfProfileNamesAndAcceptsProfilesNotInterconProfileModel}, hash: 90F8D64DA9BB7717A33F135923709A98
    @Disabled()
    @Test()
