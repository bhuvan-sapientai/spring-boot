...
class CorrelationIdFormatterSapientGeneratedTest {
	...
	//Sapient generated method id: ${1fcb0a7a-83fc-3167-9ab2-07cd36eb76a1}, hash: B2C7E7495123064BBE236C9A437FF929
	@Test()
	void formatToWhenIteratorHasNext() throws IOException {
		 ...
		 */
		//Arrange Statement(s)
		UnaryOperator<String> resolverMock = mock(UnaryOperator.class);
	...
	//Sapient generated method id: ${6d9cf4a0-6aaa-30f1-b831-613f596f3994}, hash: ADD71937ECFBACD450C6A3EEC386C28E
	@Test()
