...
class WhitespaceThrowableProxyConverterSapientGeneratedTest {
	...
	//Sapient generated method id: ${aecae6ab-c760-31b9-8104-96683d63cca4}, hash: A481F90447EAF6BF7910A38E6EC3FAEE
	@Disabled()
	@Test()
	void throwableProxyToStringTest() {
		...
		try (MockedStatic<ThrowableProxyUtil> throwableProxyUtil = mockStatic(ThrowableProxyUtil.class)) {
			...
			doReturn("jItem1").when(tpMock).getClassName();
			doReturn("jItem1").when(tpMock).getMessage();
	...
	//Sapient generated method id: ${6cda4a3d-30ac-36d6-bd3e-9b157fcaf24e}, hash: 1456532EBE5E1DD8FCB74934F16EE46D
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${8d7f4411-fc8b-3270-8c81-5642f5c0cb8f}, hash: 401A8545D5EAB0D657369B677B21A099
	@Test()
