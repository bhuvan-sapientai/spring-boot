...
class LoggingApplicationListenerSapientGeneratedTest {
	...
	//Sapient generated method id: ${cd22d811-8ef9-377b-9a2d-5d154bbbaca1}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${fdc090e8-4f7c-3656-8fb2-8d898b42f85d}
	@Test()
	...
	//Sapient generated method id: ${3cda323b-4b79-38e4-acde-73aae126c217}
	@Test()
	...
	//Sapient generated method id: ${fcf2e665-d547-39c0-b041-182e6bd19db1}
	@Test()
	...
	//Sapient generated method id: ${202c3ac3-60ab-3f94-abec-02a9db1ab1da}
	@Test()
	...
	//Sapient generated method id: ${456afd42-df2d-3323-bbcd-0682321e780e}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${727d1b11-625e-3e25-a64c-fa793f19efdb}
	@Test()
	...
	//Sapient generated method id: ${1fe6a34d-1953-3eba-8e93-5ca7b284df37}
	@Test()
	...
	//Sapient generated method id: ${7fe7cd1d-b7fb-3e4f-8584-cbb2c06b6899}
	@Test()
	...
	//Sapient generated method id: ${9efb9ef3-47c8-3c6d-a3f9-26c88a9a30fd}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${72793170-e16d-392a-88d0-53b0efc41381}
	@Test()
	...
	//Sapient generated method id: ${dfe143bb-2b9b-31f5-873f-992cb7f9dbae}
	@Disabled()
	@Test()
	void initializeWhenIgnoreLogConfigLogConfigAndExceptionToReportIsNullAndExceptionToReportIsNull4ThrowsNullPointerException() {
		 ...
		 *  Following variables could not be isolated/mocked: org.springframework.boot.logging.LoggingSystemProperties
		 *  Suggestions:
	...
	//Sapient generated method id: ${a69ebfd3-0b52-3b9c-8b41-e8a0691879fe}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${c1c445d0-2498-3598-8ca9-6de7664fa292}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${f789ff19-6dee-3a40-aa4a-1daad4fcc38c}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${025179cc-e036-3858-bd74-77fce2b78377}
	@Test()
	...
	//Sapient generated method id: ${2b082947-1b2b-3b02-9f92-bd7b931e194f}
	@Test()
	...
	void registerShutdownHookTest() {
		...
		try (MockedStatic<SpringApplication> springApplication = mockStatic(SpringApplication.class)) {
			...
			doNothing().when(springApplicationShutdownHandlersMock).add((Runnable) null);
			target = new LoggingApplicationListener();
			autoCloseableMocks = MockitoAnnotations.openMocks(this);
			//TODO: Needs initialization with real value
			Runnable runnable = null;
			//Act Statement(s)
			target.registerShutdownHook(runnable);
			//Assert statement(s)
			assertAll("result", () -> {
				springApplication.verify(() -> SpringApplication.getShutdownHandlers(), atLeast(1));
				verify(springApplicationShutdownHandlersMock).add((Runnable) null);
			});
		}
	}
}
