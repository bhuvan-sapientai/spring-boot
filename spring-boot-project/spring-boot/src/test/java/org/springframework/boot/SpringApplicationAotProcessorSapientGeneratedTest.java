...
class SpringApplicationAotProcessorSapientGeneratedTest {
	...
	//Sapient generated method id: ${2e5860ff-9b97-3d7a-a37a-361ee5355e86}, hash: 2BE5BF94D3FBA087DBEF180B58929518
	@Disabled()
	@Test()
	void prepareApplicationContextTest() {
		...
		AbstractAotProcessor.Settings abstractAotProcessorSettingsMock = mock(AbstractAotProcessor.Settings.class, "true");
