...
class PropertiesPropertySourceLoaderSapientGeneratedTest {
    ...
    //Sapient generated method id: ${getFileExtensionsTest}, hash: D0C94D7D6C8DDE90DD30FD1679FAE670
    @Test()
    ...
    //Sapient generated method id: ${loadWhenILessThanPropertiesSizeAndPropertiesSizeEquals1}, hash: 58E35E7BBF999F12385DA0995CFD1F03
    @Test()
    ...
    //Sapient generated method id: ${loadWhenPropertiesNotIsEmptyAndILessThanPropertiesSizeAndPropertiesSizeEquals1}, hash: 23B61954C6DA06BC424179DDA9700DDA
    @Disabled()
    @Test()
    void loadWhenPropertiesNotIsEmptyAndILessThanPropertiesSizeAndPropertiesSizeEquals1() throws IOException {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: object of type OriginTrackedPropertiesLoader - Method: load
         *  Suggestions:
