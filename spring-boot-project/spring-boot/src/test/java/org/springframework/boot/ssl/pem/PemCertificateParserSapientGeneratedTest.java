...
class PemCertificateParserSapientGeneratedTest {
	...
	//Sapient generated method id: ${338a9b6c-713e-3004-8310-8ed2c59d6a79}
	@Test()
	...
	//Sapient generated method id: ${dda8f05a-7c6e-385d-a7df-65b719c84f92}
	@Test()
	...
	//Sapient generated method id: ${7dbfec7e-54da-3601-866e-eee4a83b8a65}
	@Test()
	...
	//Sapient generated method id: ${d0daca89-7f9e-3849-b113-3952438a9b4e}
	@Disabled()
	@Test()
	void parseWhenInputStreamAvailableGreaterThan0AndCaughtCertificateExceptionThrowsIllegalStateException() {
		...
		//Act Statement(s)
		final IllegalStateException result = assertThrows(IllegalStateException.class, () -> {
			PemCertificateParser.parse("<value>");
		});
		//Assert statement(s)
		assertAll("result", () -> {
			assertThat(result, is(notNullValue()));
