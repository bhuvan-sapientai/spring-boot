...
class WebServerStartStopLifecycleSapientGeneratedTest {
	...
	//Sapient generated method id: ${a9331398-240e-36aa-9522-b3dc4bcf14ad}, hash: 9719F9481A608D125C863D4F27007E44
	@Test()
	void startTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${097b903c-1cba-3dd3-835e-b09bc597ebca}, hash: 94929988F45F02FB73F22B7E60CC8B01
	@Test()
	void stopTest() {
		//Arrange Statement(s)
		WebServerStartStopLifecycle target = new WebServerStartStopLifecycle(weServerManagerMock);
	...
	//Sapient generated method id: ${a13e4cc2-0333-30ea-a37d-5a0469c59d55}, hash: 64B95C0118790E027BC1CE05A7E3D820
	@Test()
	void getPhaseTest() {
		//Arrange Statement(s)
		WebServerStartStopLifecycle target = new WebServerStartStopLifecycle(weServerManagerMock);
