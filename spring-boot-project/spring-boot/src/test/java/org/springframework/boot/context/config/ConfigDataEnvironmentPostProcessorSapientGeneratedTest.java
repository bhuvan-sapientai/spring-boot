...
class ConfigDataEnvironmentPostProcessorSapientGeneratedTest {
    ...
    //Sapient generated method id: ${postProcessEnvironmentTest}, hash: 88814EA35200E617795DA35CA86CCDD3
    @Test()
    ...
    //Sapient generated method id: ${postProcessEnvironment1WhenResourceLoaderIsNotNull}, hash: BC46FE73D14995E640070B1FC8517B51
    @Test()
    ...
    //Sapient generated method id: ${postProcessEnvironment1WhenResourceLoaderIsNull}, hash: 7DE16F65C795DA8888453A4281F783BA
    @Test()
    void postProcessEnvironment1WhenResourceLoaderIsNull() {
        ...
        assertAll("result", () -> {
            ...
            verify(configDataEnvironmentMock, atLeast(1)).processAndApply();
        });
    }

    //Sapient generated method id: ${getConfigDataEnvironmentTest}, hash: 5B95B2BE7D472F51162E8545C547909C
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${applyToTest}, hash: 0BE955D494D136DC500575AC7C8EE08C
    @Test()
    void applyToTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${applyTo1Test}, hash: 79977D6827DDB4F6C20179600E65B521
    @Test()
    void applyTo1Test() {
        //Arrange Statement(s)
        try (MockedStatic<ConfigDataEnvironmentPostProcessor> configDataEnvironmentPostProcessor = mockStatic(ConfigDataEnvironmentPostProcessor.class, CALLS_REAL_METHODS)) {
    ...
    //Sapient generated method id: ${applyTo2WhenBootstrapContextIsNotNull}, hash: 7FE8FA42234E0CE16D55E704BE497DDB
    @Disabled()
    @Test()
    void applyTo2WhenBootstrapContextIsNotNull() {
         ...
         *
         * TODO: Help needed! This method is not unit testable!
         *  A variable could not be isolated/mocked when calling a method - Variable name: postProcessor - Method: postProcessEnvironment
         *  Suggestions:
         *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
         *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
         *  The test code, including the assertion statements, has been successfully generated.
    ...
    //Sapient generated method id: ${applyTo2WhenBootstrapContextIsNull}, hash: 497CBA6A2203CEEB7C277F728280ED98
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${applyTo3WhenBootstrapContextIsNotNull}, hash: 31CE69D23D6896FB923A83544F759292
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${applyTo3WhenBootstrapContextIsNull}, hash: 0428B2D8390F0C213F3BC436FEE0FD9F
    @Disabled()
    @Test()
