...
class SpringApplicationJsonEnvironmentPostProcessorSapientGeneratedTest {
	...
	//Sapient generated method id: ${99159ba2-634f-301b-acba-aef10d42d902}, hash: 474819216EFD7186ECF4D71BCF1CA065
	@Disabled()
	@Test()
	void postProcessEnvironmentWhenClassUtilsNotIsPresentSERVLET_ENVIRONMENT_CLASSNullAndSourcesNotContainsName() throws JsonParseException {
		...
		try (MockedStatic<ClassUtils> classUtils = mockStatic(ClassUtils.class);
			...
			doReturn(stringObjectMap).when(jsonParserMock).parseMap("arg0");
			...
			assertAll("result", () -> {
				...
				verify(jsonParserMock).parseMap("arg0");
	...
	//Sapient generated method id: ${c00d8ba9-fd0a-3b27-81cb-df61ce3e110f}, hash: B93AFB050382E017C9A1611090960EFF
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${baca2b8d-afd4-3335-b274-3a40ae4301d0}, hash: 3BF0C02FBE3DD447AE1A6A867F008B79
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${717f0a9c-b6f1-34af-9525-28afd11c5dd8}, hash: 1C84BA41223AEF0A49CF8AF64A307524
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${4667b870-62fc-3c9e-8b4a-826d451eadb6}, hash: D4C13A9D928A7C0E8B6583809BF3C9AD
	@Disabled()
	@Test()
