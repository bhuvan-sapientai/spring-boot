...
class JacksonRuntimeHintsSapientGeneratedTest {
	...
	//Sapient generated method id: ${b35d5d0c-4e5d-305a-95c1-c809fad49f91}
	@Test()
	...
	//Sapient generated method id: ${22266cd7-504f-3507-8e97-f6964639aed2}
	@Test()
	void registerHintsWhenClassUtilsIsPresentCom_fasterxml_jackson_databind_ser_BasicSerializerFactoryClassLoader() {
		...
		try (MockedStatic<TypeReference> typeReference = mockStatic(TypeReference.class);
			...
			Class[] classArray = new Class[] { StdJdkSerializers.AtomicBooleanSerializer.class, StdJdkSerializers.AtomicIntegerSerializer.class, StdJdkSerializers.AtomicLongSerializer.class, FileSerializer.class, ClassSerializer.class, TokenBufferSerializer.class };
