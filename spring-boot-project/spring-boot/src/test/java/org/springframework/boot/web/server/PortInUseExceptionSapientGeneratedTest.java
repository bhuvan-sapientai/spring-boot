...
class PortInUseExceptionSapientGeneratedTest {
	...
	//Sapient generated method id: ${eeec45fb-e3c7-3494-8faf-9684c0629800}, hash: 37F48686C2F64A3704567E32C10F82FB
	@Test()
	...
	//Sapient generated method id: ${c774ab4b-e75f-350c-9e71-1a620689db7a}, hash: D7F56EE58A9276AB8DED5BD4D4BD8F6C
	@Test()
	...
	//Sapient generated method id: ${55c69765-224e-3d51-88a9-f208e3e5ec97}, hash: 80A428AE1F662D65781ED4D03DFFBF83
	@Test()
	...
	//Sapient generated method id: ${21d79cb3-1408-38c9-b0b6-0597cd977518}, hash: 74D63FA43E7D84B248789A47C37E80B8
	@Test()
	void ifCausedByWhenCausedByIsInstanceCandidate() {
		...
		Exception exception = new Exception();
		doNothing().when(actionMock).accept(exception);

		//Act Statement(s)
		PortInUseException.ifCausedBy(exception, Exception.class, actionMock);

		//Assert statement(s)
		assertAll("result", () -> verify(actionMock).accept(exception));
	}
}
