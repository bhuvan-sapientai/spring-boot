...
class ConfigDataResourceNotFoundExceptionSapientGeneratedTest {
	...
	//Sapient generated method id: ${b4470aa6-1ce4-3fc4-a2b4-8f47ac67a20a}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${63e75f5a-2b88-3c37-bdb2-16bd9f87d912}
	@Test()
	...
	//Sapient generated method id: ${8e39f001-ff63-3d33-94d7-fa209eb1ad0f}
	@Disabled()
	@Test()
	void throwIfDoesNotExistWhenExists() {
		 ...
		 */
		//Arrange Statement(s)
		ConfigDataResource configDataResourceMock = mock(ConfigDataResource.class, "validResource");
	...
	//Sapient generated method id: ${dc4bd248-8b37-3f2a-a9b0-4a944b46e201}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${8930b87e-cea2-3b95-93f3-2bdf661979ac}
	@Test()
	...
	//Sapient generated method id: ${86be841f-c1bf-3884-8357-8e496ee16d22}
	@Test()
	...
	//Sapient generated method id: ${867986a8-087a-3ba7-953f-c0d52ff36ff4}
	@Test()
