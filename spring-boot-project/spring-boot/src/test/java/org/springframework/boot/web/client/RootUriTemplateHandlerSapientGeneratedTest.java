...
class RootUriTemplateHandlerSapientGeneratedTest {
	...
	//Sapient generated method id: ${993f20eb-4a10-398e-a4d3-caa3adfa22f0}, hash: 4D0E4CACB58CA1942DEE225B94D224DF
	@Test()
	void withHandlerWrapperTest() {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class, CALLS_REAL_METHODS)) {
			...
			RootUriTemplateHandler target = new RootUriTemplateHandler("<String value>", handlerMock);
			//Act Statement(s)
