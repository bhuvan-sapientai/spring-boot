...
class NestedJarResourceSetSapientGeneratedTest {
    ...
    //Sapient generated method id: ${createArchiveResourceTest}, hash: 47AA1950C62A3CA9B18D51636A2EECFA
    @Test()
    ...
    //Sapient generated method id: ${initInternalWhenConnectionNotGetUseCaches}, hash: D636F32893B29CAE1D8C9EC52E58F516
    @Disabled()
    @Test()
    void initInternalWhenConnectionNotGetUseCaches() throws LifecycleException, IllegalArgumentException, IOException {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: sm - Method: getString
         *  Suggestions:
    ...
    //Sapient generated method id: ${initInternalWhenConnectionGetUseCaches}, hash: 5576DFF5567EAE53BAF5FE0FD95F8337
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${initInternalWhenCaughtIOExceptionThrowsIllegalStateException}, hash: 2A75B82EF4E29F58BDBBF775C1859DA8
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${openJarFileWhenThisArchiveIsNull}, hash: FFC23EF0A3EF86E8EB860C4F6B632A9A
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${closeJarFileTest}, hash: 2646CE3B276A1F6526BFB74A71B1B16D
    @Test()
    ...
    //Sapient generated method id: ${isMultiReleaseWhenAttributesIsNull}, hash: 21BBD33BBFC2051693C9F4DB393B22EB
    @Test()
    ...
    //Sapient generated method id: ${gcWhenThisArchiveIsNull}, hash: 2C9E81A45F67BADDA97EA4E1E4CF7854
    @Test()
