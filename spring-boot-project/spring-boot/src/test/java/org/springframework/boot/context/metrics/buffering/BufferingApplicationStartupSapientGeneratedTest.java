...
class BufferingApplicationStartupSapientGeneratedTest {
	...
	void startWhenThisCurrentCompareAndSetCurrentNext() {
		/* Branches:
		 * (step != null) : true  #  inside getLatestActive method
		 * (step.isEnded()) : true  #  inside getLatestActive method
	...
	//Sapient generated method id: ${2e556e6e-6511-3d1b-be8f-a3022b88db19}, hash: 591D6DD77BAC0CAF04C89D10345A3F49
	@Test()
	void startWhenStepIsEndedAndThisCurrentNotCompareAndSetCurrentNext() {
		/* Branches:
		 * (step != null) : true  #  inside getLatestActive method
		 * (step.isEnded()) : true  #  inside getLatestActive method
