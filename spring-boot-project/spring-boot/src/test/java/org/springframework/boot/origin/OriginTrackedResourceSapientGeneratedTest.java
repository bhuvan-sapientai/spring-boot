...
class OriginTrackedResourceSapientGeneratedTest {
    ...
    //Sapient generated method id: ${getInputStreamTest}, hash: 5F0B96573BEB0CBE7032FACB525203F8
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${existsWhenGetResourceExists}, hash: 95F0D1EBC805F94FFCACB12FA637FACE
    @Test()
    ...
    //Sapient generated method id: ${existsWhenGetResourceNotExists}, hash: 0D00288F6F06D78A7B8870285F2F5456
    @Test()
    ...
    //Sapient generated method id: ${isReadableWhenGetResourceIsReadable}, hash: 0839B95F3BFAAC0013A156A9C0567190
    @Test()
    ...
    //Sapient generated method id: ${isReadableWhenGetResourceNotIsReadable}, hash: F88FBD16BB497B7743ADFFE50513A828
    @Test()
    ...
    //Sapient generated method id: ${isOpenWhenGetResourceIsOpen}, hash: 0BEB81336CC5C350F7D3B8509DDD7132
    @Test()
    ...
    //Sapient generated method id: ${isOpenWhenGetResourceNotIsOpen}, hash: 057D2F626D0DE34F0E7D4610ACAC65EA
    @Test()
    ...
    //Sapient generated method id: ${isFileWhenGetResourceIsFile}, hash: AE2AA9430A59F3FA46C6ECC0058D1499
    @Test()
    ...
    //Sapient generated method id: ${isFileWhenGetResourceNotIsFile}, hash: D5D280E6537BBD199B8C0A62182FA6C0
    @Test()
    ...
    //Sapient generated method id: ${getURLTest}, hash: 59597D849F4C479B0C5CFA5738CDB82C
    @Test()
    ...
    //Sapient generated method id: ${getURITest}, hash: 3EC0A8F7375844C1733330A0567BF6E7
    @Test()
    ...
    //Sapient generated method id: ${getFileTest}, hash: F7A02372448E88175C8DC35D9E7BE279
    @Test()
    ...
    //Sapient generated method id: ${readableChannelTest}, hash: 287B8EE5220C77600250F65036146C15
    @Test()
    ...
    //Sapient generated method id: ${contentLengthTest}, hash: 1D1B4DBA27645D067782775FD6438F62
    @Test()
    ...
    //Sapient generated method id: ${lastModifiedTest}, hash: 1A0E46EA6CA3782014447EA2F334D8B0
    @Test()
    ...
    //Sapient generated method id: ${createRelativeTest}, hash: D6BD105E86EEA29D87F04518A02C8653
    @Test()
    ...
    //Sapient generated method id: ${getFilenameTest}, hash: 0524478CCF28486D022D7F85E55BDC64
    @Test()
    ...
    //Sapient generated method id: ${getDescriptionTest}, hash: 9CD542331A40B2C3C7CBA0531921CEA6
    @Test()
    ...
    //Sapient generated method id: ${toStringTest}, hash: B21D19DACC80EF15A247099C7B21535C
    @Test()
    void toStringTest() {
        //Arrange Statement(s)
        Resource resourceMock = mock(Resource.class, "resource");
        try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
            _assert.when(() -> Assert.notNull(resourceMock, "Resource must not be null")).thenAnswer((Answer<Void>) invocation -> null);
            OriginTrackedResource target = new OriginTrackedResource(resourceMock, originMock);
            //Act Statement(s)
    ...
    //Sapient generated method id: ${ofTest}, hash: 54D00CE3F7860C45FF8C8F0F6C6C0A83
    @Test()
    void ofTest() {
        /*
    ...
    //Sapient generated method id: ${of1WhenResourceInstanceOfWritableResource}, hash: F32AFB49771250C38F027E6C0F641019
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${of1WhenResourceNotInstanceOfWritableResource}, hash: 2CDBEA150969038980160F99459EDCA9
    @Disabled()
    @Test()
