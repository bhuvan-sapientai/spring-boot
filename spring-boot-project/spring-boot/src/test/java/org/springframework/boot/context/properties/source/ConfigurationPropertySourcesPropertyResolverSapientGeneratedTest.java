...
class ConfigurationPropertySourcesPropertyResolverSapientGeneratedTest {
	...
	//Sapient generated method id: ${3330932b-5c8c-39b9-a6c0-b88cb5f4ebae}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${c0e9bb19-8da4-3906-bbef-9c8c866ea231}
	@Test()
	...
	//Sapient generated method id: ${5d86fb9f-75bd-3848-9b65-f3a24d29b0d0}
	@Test()
	...
	//Sapient generated method id: ${c519a802-bafd-336d-abd2-40264828dd8d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${abf2f751-2d8d-328b-b876-1d028f927b94}
	@Test()
	...
	//Sapient generated method id: ${73c17d9a-4743-3423-a4c5-31860de55d0d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${dc9fbe4a-8d57-3691-ae58-7bae70fbc30d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${97ce597c-91ee-34da-bc91-30b57e73d393}
	@Test()
	...
	//Sapient generated method id: ${fef8509b-1159-33de-baa3-53aa2b22b647}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${7ac2ea26-3a82-3f8b-9802-1c527554ec2d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${06cfd8ef-1ec6-33fa-954d-f1efeb038665}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${e158282f-b41d-3367-94af-49d38b7ba1ea}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${6cf580f6-244b-31c9-a85d-34146976b29d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${d071d10f-388d-3270-b158-d9f291bc308a}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${0e3d4019-4e90-37a0-b32d-8bb73f4ba120}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${b983baf7-66fa-34cb-8458-6a130f93c4ea}
	@Test()
	...
	//Sapient generated method id: ${ddfae7d5-b8dd-383e-80db-fe19b964c210}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${0106ccab-fbad-3458-85c9-aba9a897ea6d}
	@Test()
	...
	//Sapient generated method id: ${4be18f0e-fc19-36f7-bd30-a24284232024}
	@Test()
	...
	//Sapient generated method id: ${04a859b7-4ac2-370b-adbd-713d08e1fe8b}
	@Test()
	...
	//Sapient generated method id: ${4eb45dcf-3e0f-3715-976d-c80efad0c4ce}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${3381bc01-cc6f-3fb1-acc6-49d9032189b6}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${137c4932-6bf0-3306-98f3-1a13f6dae120}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${96526e58-f2a4-39cb-ae25-d7d769ae4d92}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${8178a25c-3642-3433-86f1-fb6c4cc7e472}
	@Test()
	...
	//Sapient generated method id: ${58557aca-035b-3c54-bf85-8473a7b90a3e}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${9089bea0-bf63-3a30-b81e-574541a28fec}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${5c4e4df6-d7b5-3443-ba18-431e3022d0dc}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${4ab0aaa3-6bea-38fa-9c21-f244d7e9c6a0}
	@Disabled()
	@Test()
	void getPropertyAsRawStringWhenCaughtExceptionAndValueIsNotNullAndNotResolveNestedPlaceholders() throws Exception {
		...
		try (MockedStatic<DefaultConversionService> defaultConversionService = mockStatic(DefaultConversionService.class);
			...
			configurationPropertyName.when(() -> ConfigurationPropertyName.of("key1", true)).thenReturn(configurationPropertyNameMock);
			Object object2 = new Object();
			classUtils.when(() -> ClassUtils.isAssignableValue(Object.class, object2)).thenReturn(false);
			defaultConversionService.when(() -> DefaultConversionService.getSharedInstance()).thenReturn(conversionServiceMock);
			doReturn("return_of_convert1").when(conversionServiceMock).convert(object2, Object.class);
			ConfigurationPropertySourcesPropertyResolver target = new ConfigurationPropertySourcesPropertyResolver(mutablePropertySourcesMock);
			//Act Statement(s)
			String result = target.getPropertyAsRawString("key1");
			//Assert statement(s)
			assertAll("result", () -> {
				...
				verify(configurationPropertySourcesPropertySourceMock).findConfigurationProperty(configurationPropertyNameMock);
				configurationPropertyName.verify(() -> ConfigurationPropertyName.of("key1", true), atLeast(1));
				classUtils.verify(() -> ClassUtils.isAssignableValue(Object.class, object2), atLeast(1));
				defaultConversionService.verify(() -> DefaultConversionService.getSharedInstance(), atLeast(1));
				verify(conversionServiceMock).convert(object2, Object.class);
			});
		}
	}

	//Sapient generated method id: ${d8e95d18-a74a-3b58-b7a9-c72791ba3814}
	@Disabled()
	@Test()
	void getPropertyAsRawStringWhenConfigurationPropertyIsNotNullAndCaughtExceptionAndValueIsNotNullAndNotResolveNestedPlacehold() throws Exception {
		...
		try (MockedStatic<ClassUtils> classUtils = mockStatic(ClassUtils.class);
			...
			doReturn(configurationProperty).when(configurationPropertySourcesPropertySourceMock).findConfigurationProperty(configurationPropertyNameMock);
			configurationPropertyName.when(() -> ConfigurationPropertyName.of("key1", true)).thenReturn(configurationPropertyNameMock);
			classUtils.when(() -> ClassUtils.isAssignableValue(Object.class, "return_of_getProperty1")).thenReturn(true);
			ConfigurationPropertySourcesPropertyResolver target = new ConfigurationPropertySourcesPropertyResolver(mutablePropertySourcesMock);
			//Act Statement(s)
			String result = target.getPropertyAsRawString("key1");
			//Assert statement(s)
			assertAll("result", () -> {
				...
				verify(configurationPropertySourcesPropertySourceMock).findConfigurationProperty(configurationPropertyNameMock);
				configurationPropertyName.verify(() -> ConfigurationPropertyName.of("key1", true), atLeast(1));
				classUtils.verify(() -> ClassUtils.isAssignableValue(Object.class, "return_of_getProperty1"), atLeast(1));
			});
		}
	}

	//Sapient generated method id: ${acf7beb5-251a-3524-99f1-c4f065269f55}
	@Disabled()
	@Test()
