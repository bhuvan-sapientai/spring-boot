...
class UnboundElementsSourceFilterSapientGeneratedTest {
	...
	//Sapient generated method id: ${0000fa7d-6b33-3661-a73a-b594448e0a97}, hash: 9285B44154082D489755CDFB4F452154
	@Test()
	void applyWhenBENIGN_PROPERTY_SOURCE_NAMESNotContainsName() {
		 ...
		 */
		//Arrange Statement(s)
		ConfigurationPropertySource configurationPropertySourceMock = mock(ConfigurationPropertySource.class, "name");
	...
	//Sapient generated method id: ${3fe2d48d-60a8-3b7b-ac26-5152b14a648a}, hash: 60A59C9F3B17C7E4B8F9D51B622B1EFC
	@Test()
