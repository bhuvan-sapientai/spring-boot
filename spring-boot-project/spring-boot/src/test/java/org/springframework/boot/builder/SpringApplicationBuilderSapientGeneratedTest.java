...
class SpringApplicationBuilderSapientGeneratedTest {
	...
	//Sapient generated method id: ${d328fd58-07d5-3414-ad48-bd3b21260b98}
	@Disabled()
	@Test()
	void createSpringApplicationTest() {
		...
		SpringApplication springApplication = new SpringApplication(resourceLoaderMock, classArray);
		//Assert statement(s)
		//TODO: Please implement equals method in SpringApplication for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> assertThat(result, equalTo(springApplication)));
	}

	//Sapient generated method id: ${3e66ad8b-20f0-30cd-a806-cc9ed7e5b825}
	@Test()
	void contextTest() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
	...
	//Sapient generated method id: ${27046cc6-da25-369e-83c3-98e8427b8452}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${fe355eac-144b-3144-ba25-7b4e45d30ff3}
	@Test()
	...
	//Sapient generated method id: ${fcf842d9-5633-3fb9-b39d-f2a546d672d2}
	@Disabled()
	@Test()
	void build1WhenThisNotRegisterShutdownHookApplied() {
		...
		//TODO: Please implement equals method in SpringApplication for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> {
			assertThat(result, equalTo(springApplication));
			verify(parentMock).run(stringArray);
		});
	}

	//Sapient generated method id: ${9edf64c4-8f43-3202-945d-12a6bc8ff24d}
	@Disabled()
	@Test()
	void childTest() {
		/**
		...
		SpringApplicationBuilder springApplicationBuilder = new SpringApplicationBuilder(classArray3);
		//Assert statement(s)
		//TODO: Please implement equals method in SpringApplicationBuilder for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> assertThat(result, equalTo(springApplicationBuilder)));
	}

	//Sapient generated method id: ${4b094faa-bfa9-3ee0-bcad-aee062ac3db1}
	@Disabled()
	@Test()
	void parentWhenThisParentIsNull() {
		 ...
		 *
		 * TODO: Help needed! This method is not unit testable!
		 *  Following variables could not be isolated/mocked: org.springframework.boot.builder.SpringApplicationBuilder
		 *  Suggestions:
		 *  You can change the initialization of above variables and make it injectable or
		 *  adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
		 *  The test code, including the assertion statements, has been successfully generated.
		...
		SpringApplicationBuilder springApplicationBuilder = springApplicationBuilderMock.environment((ConfigurableEnvironment) null);
		//Assert statement(s)
		//TODO: Please implement equals method in SpringApplicationBuilder for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> assertThat(result, equalTo(springApplicationBuilder)));
	}

	//Sapient generated method id: ${bcbcac76-965c-3188-9424-a575f2351de1}
	@Disabled()
	@Test()
	void parentWhenThisParentIsNotNull() {
		...
		assertAll("result", () -> {
			...
			verify(parentMock2).sources(classArray2);
		});
	}

	//Sapient generated method id: ${142403f8-dccc-39d7-969e-9bc8e0a3ba8d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${59703626-cb8e-3907-9d28-4df897f01c4a}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${873d5435-00e7-3660-b58e-70c17674124b}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${cc2dbd10-53d5-34ca-9dd8-bd0762487b5d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${7001c55f-a8f4-3828-b436-8753b2adeddc}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${309fa848-98d1-37a7-b066-e0fa5fc96ed6}
	@Test()
	...
	//Sapient generated method id: ${128875af-f21b-3458-9e98-d6a82c2646a8}
	@Test()
	void sourcesTest() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
	...
	//Sapient generated method id: ${ca3e9a33-3093-3a81-ae63-5f3fa481ee84}
	@Test()
	void webTest() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
	...
	//Sapient generated method id: ${30468886-252c-3988-947a-f444694b9920}
	@Test()
	...
	//Sapient generated method id: ${ddf1a563-e46d-3a7b-a2a2-0d51e083b3c7}
	@Test()
	void bannerTest() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
	...
	//Sapient generated method id: ${e7883b3b-ee72-3e33-b2f4-08b42712a4eb}
	@Test()
	void bannerModeTest() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
	...
	//Sapient generated method id: ${12fcd0c9-9d90-3767-a1c9-84d859b90dc6}
	@Test()
	void headlessTest() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
	...
	//Sapient generated method id: ${d5677af8-91e7-39d2-b67e-2d5761466fb2}
	@Test()
	...
	//Sapient generated method id: ${b9f578a4-802c-3759-8f23-6bfd68fd311b}
	@Test()
	void mainTest() {
		/**
		 * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
	...
	//Sapient generated method id: ${b32a1ad1-954e-35fb-9184-c0595a27f53a}
	@Test()
	...
	//Sapient generated method id: ${7dde1cb1-cb7b-3137-8d4b-acfe0f01b80a}
	@Test()
	...
	//Sapient generated method id: ${8969bb91-8b8b-31fc-b7ab-e3a35dcdd372}
	@Test()
	...
	//Sapient generated method id: ${5d0cb8c8-9a2c-3cfd-87f9-06967a06b4b3}
	@Test()
	...
	//Sapient generated method id: ${739e3f81-8055-3124-8d63-e40a2871141c}
	@Test()
	...
	//Sapient generated method id: ${d6387c93-c7b5-3e51-95e6-13dd6e77a8a1}
	@Test()
	...
	//Sapient generated method id: ${259ed713-4f9b-3a80-a509-1b5f1054f79c}
	@Disabled()
	@Test()
	void properties2WhenThisParentIsNotNull() {
		...
		assertAll("result", () -> {
			...
			verify(parentMock2).properties(eq(stringObjectMap));
			verify(parentMock2).environment((ConfigurableEnvironment) null);
		});
	}

	//Sapient generated method id: ${32890405-c521-3186-a0b4-54047b452aa6}
	@Disabled()
	@Test()
	void profilesTest() {
		/**
	...
	//Sapient generated method id: ${c606a8ab-7b23-3d95-8d15-a30be474618e}
	@Test()
	...
	//Sapient generated method id: ${c7d3a088-abbb-37bc-9c42-d108bb0f1df3}
	@Test()
	...
	//Sapient generated method id: ${df4d06ce-099e-3549-8f12-f91fefdfddf4}
	@Test()
	...
	//Sapient generated method id: ${9eeeb03c-8805-33f9-81ea-72a50b42c4a0}
	@Test()
	...
	//Sapient generated method id: ${281e1cb8-202f-3703-b3b3-04b784b363dc}
	@Test()
	...
	//Sapient generated method id: ${26f260f6-b8ec-3918-b30e-0556355e0b8a}
	@Test()
	void listenersTest() {
		/**
		 * TODO: Help needed! This method is not unit testable!
	...
	//Sapient generated method id: ${1c9d1c4a-61ec-3609-b201-aac1ed30c798}
	@Test()
	...
	//Sapient generated method id: ${a20cad7c-f3f6-3a0f-ba7d-5fd32d36ef8f}
	@Test()
