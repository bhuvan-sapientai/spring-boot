...
class SpringApplicationBuilderSapientGeneratedTest {
	...
	//Sapient generated method id: ${fe355eac-144b-3144-ba25-7b4e45d30ff3}, hash: EAD548BBD85349C50AE7269CC3146E0B
	@Test()
	void runWhenThisNotRegisterShutdownHookAppliedAndThisRunningCompareAndSetFalseTrue() {
		 ...
		 *  A variable could not be isolated or mocked when calling a method - Variable name: application - Method: addInitializers
		 *  Suggestions:
	...
	void childTest() {
		/*
		 * TODO: Help needed! This method is not unit testable!
		 *  Following variables could not be isolated/mocked: application, object of type SpringApplicationBuilder, child
		 *  Suggestions:
		 *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
		 *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
		 *  The test code, including the assertion statements, has been successfully generated.
	...
	//Sapient generated method id: ${739e3f81-8055-3124-8d63-e40a2871141c}, hash: C329B8AB43C29C387EEBC14A521246D6
	@Test()
	...
	//Sapient generated method id: ${d6387c93-c7b5-3e51-95e6-13dd6e77a8a1}, hash: 85AF6C9D13A60A852AE3D1F63AFA3207
	@Disabled()
	@Test()
	void properties1WhenCollectionsListPropertiesPropertyNamesIsNotEmpty() {
		 ...
		 */
		//Arrange Statement(s)
		ResourceLoader resourceLoaderMock = mock(ResourceLoader.class, "null");
		Class<?>[] classArray = new Class[] {};
		target = spy(new SpringApplicationBuilder(resourceLoaderMock, classArray));
		autoCloseableMocks = MockitoAnnotations.openMocks(this);
		SpringApplicationBuilder springApplicationBuilderMock = mock(SpringApplicationBuilder.class);
		Map<String, Object> stringObjectMap = new HashMap<>();
		stringObjectMap.put("defaultsItem1Key1", (Object) null);
		doReturn(springApplicationBuilderMock).when(target).properties(eq(stringObjectMap));
	...
	//Sapient generated method id: ${259ed713-4f9b-3a80-a509-1b5f1054f79c}, hash: 92D9B82CDA5FF54829D0F88A41ED7132
	@Disabled()
	@Test()
