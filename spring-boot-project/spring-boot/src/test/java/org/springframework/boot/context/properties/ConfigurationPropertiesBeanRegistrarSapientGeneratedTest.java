...
class ConfigurationPropertiesBeanRegistrarSapientGeneratedTest {
	...
	//Sapient generated method id: ${1f68e201-ef10-35df-9a07-1476241b36f5}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${1e8acbc1-030a-3bca-aab8-13cf04495245}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${457da517-a828-386b-9bee-c57d15eca370}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${0d78ece8-4b86-3d5e-b785-087ad7a58e66}
	@Disabled()
	@Test()
	void register1WhenBindMethodEqualsBindMethodVALUE_OBJECT() throws NoSuchElementException, BeanDefinitionStoreException {
		...
		try (MockedStatic<BindMethodAttribute> bindMethodAttribute = mockStatic(BindMethodAttribute.class);
			...
			ConfigurationPropertiesBeanRegistrar target = new ConfigurationPropertiesBeanRegistrar(registryMock);
			doNothing().when(registryMock).registerBeanDefinition(eq("A-java.lang.Object"), (RootBeanDefinition) any());
			//Act Statement(s)
			target.register(Object.class, annotationMock);
			//Assert statement(s)
			assertAll("result", () -> {
				...
				verify(registryMock).registerBeanDefinition(eq("A-java.lang.Object"), (RootBeanDefinition) any());
			});
		}
	}
}
