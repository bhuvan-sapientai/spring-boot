...
class ConfigDataImporterSapientGeneratedTest {
    ...
    //Sapient generated method id: ${resolveAndLoadWhenActivationContextIsNullAndLocationsIsEmptyAndILessThan0}, hash: A450B841FC65B7B65F45589BA9334C69
    @Test()
    ...
    //Sapient generated method id: ${resolveAndLoadWhenLocationsIsEmptyAndILessThan0AndCaughtIOExceptionThrowsIllegalStateException}, hash: F07948B0571604C9702BA0B766A87376
    @Disabled()
    @Test()
    void resolveAndLoadWhenLocationsIsEmptyAndILessThan0AndCaughtIOExceptionThrowsIllegalStateException() {
        /* Branches:
         * (activationContext != null) : false
         * (for-each(locations)) : false  #  inside resolve method
         * (i >= 0) : false  #  inside load method
    ...
    //Sapient generated method id: ${resolveAndLoadWhenLoadedIsNotNull}, hash: D06B4DBB6B5EA37BF5B3B73455DC905D
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${resolveAndLoadWhenResourceIsNullAndILessThan0}, hash: 0B2B2CA9F1355F73313DA755203C55E4
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${resolveAndLoadWhenLoadedIsNotNullAndCaughtIOExceptionThrowsIllegalStateException}, hash: B7282647027F4F832C77A7E6E8BDE5AD
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${resolveAndLoadWhenResourceIsOptional}, hash: 53E1FD735B4EC542E4F2214DC04A4F49
    @Disabled()
    @Test()
