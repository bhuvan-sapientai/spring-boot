...
class PrefixedIterableConfigurationPropertySourceSapientGeneratedTest {
	...
	//Sapient generated method id: ${b4af2388-e781-3800-820a-b8ede09bd914}, hash: 68CDED38DD26F969735523615515183B
	@Test()
	void streamTest() {
		/*
		...
		try (MockedStatic<ConfigurationPropertyName> configurationPropertyName = mockStatic(ConfigurationPropertyName.class);
			...
			configurationPropertyName.when(() -> ConfigurationPropertyName.of("prefix1")).thenReturn(configurationPropertyNameMock);
			PrefixedIterableConfigurationPropertySource target = spy(new PrefixedIterableConfigurationPropertySource(iterableConfigurationPropertySourceMock, "prefix1"));
	...
	//Sapient generated method id: ${bfcb6725-5fb8-3080-8655-dc87e9921af1}, hash: 09D9B9B3CEE26BF61C8659D9AF6C1829
	@Test()
	void getSource1Test() {
		//Arrange Statement(s)
		try (MockedStatic<ConfigurationPropertyName> configurationPropertyName = mockStatic(ConfigurationPropertyName.class);
			...
			_assert.when(() -> Assert.hasText("prefix1", "Prefix must not be empty")).thenAnswer((Answer<Void>) invocation -> null);
			configurationPropertyName.when(() -> ConfigurationPropertyName.of("prefix1")).thenReturn(configurationPropertyNameMock);
			PrefixedIterableConfigurationPropertySource target = new PrefixedIterableConfigurationPropertySource(iterableConfigurationPropertySourceMock, "prefix1");
			//Act Statement(s)
