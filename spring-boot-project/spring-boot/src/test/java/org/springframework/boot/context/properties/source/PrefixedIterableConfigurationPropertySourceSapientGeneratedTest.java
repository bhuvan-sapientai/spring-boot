...
class PrefixedIterableConfigurationPropertySourceSapientGeneratedTest {
    ...
    //Sapient generated method id: ${streamTest}, hash: 3854EF1666714CEE2DBCA3A46B722333
    @Test()
    void streamTest() {
        /*
    ...
    //Sapient generated method id: ${getSource1Test}, hash: 75BCC953BE06E3C7A8E3CFEFF9722FF7
    @Test()
    void getSource1Test() {
        //Arrange Statement(s)
        try (MockedStatic<ConfigurationPropertyName> configurationPropertyName = mockStatic(ConfigurationPropertyName.class);
