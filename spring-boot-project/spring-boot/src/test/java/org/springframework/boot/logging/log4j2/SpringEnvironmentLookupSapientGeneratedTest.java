...
class SpringEnvironmentLookupSapientGeneratedTest {
	...
	//Sapient generated method id: ${c6edc453-674a-3832-b628-99046fb4a099}
	@Test()
	void lookupTest() {
		//Arrange Statement(s)
		target = spy(new SpringEnvironmentLookup());
		autoCloseableMocks = MockitoAnnotations.openMocks(this);
		doReturn("return_of_lookup1").when(target).lookup("key1");
		//TODO: Needs initialization with real value
		LogEvent logEvent = null;
		//Act Statement(s)
		String result = target.lookup(logEvent, "key1");
		//Assert statement(s)
		assertAll("result", () -> {
			assertThat(result, equalTo("return_of_lookup1"));
			verify(target).lookup("key1");
		});
	}

	//Sapient generated method id: ${a16791f1-0bc3-3c28-a5f5-c1c0840540e6}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${7a5846a5-15d9-38ce-8d4b-9b708230d1b3}
	@Test()
