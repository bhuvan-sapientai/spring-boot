...
class BindableSapientGeneratedTest {
	...
	//Sapient generated method id: ${0c0b54df-f145-3614-8d79-f6601fa56d79}
	@Test()
	...
	//Sapient generated method id: ${4eb7db39-0a57-38ad-a72d-511d50e04994}
	@Test()
	...
	//Sapient generated method id: ${2a98fe32-b8a9-36b6-836e-6db8e42d23b4}
	@Test()
	...
	//Sapient generated method id: ${5e37aa51-fcf5-3095-9f2c-5a579041ad64}
	@Test()
	...
	//Sapient generated method id: ${98869e93-f5c9-3b6c-ba2d-3272eeab77b3}
	@Test()
	...
	//Sapient generated method id: ${0a923754-1598-368b-923e-63ff46b9f177}
	@Test()
	...
	//Sapient generated method id: ${b6c83d41-f625-3420-9839-04f9ae84dc5a}
	@Test()
	...
	//Sapient generated method id: ${b7446969-16fe-3200-a92a-363fafc23073}
	@Test()
    ...
    assertAll("result", () -> {
        ...
        verify(boxedTypeMock).resolve();
    });
}*/
	}

	//Sapient generated method id: ${887d4022-14db-348b-8a3d-fa4aa86d8237}
	@Test()
    ...
    //Act Statement(s)
    Bindable result = target.withSuppliedValue(supplier);
    //Assert statement(s)
    assertAll("result", () -> {
        assertThat(result, is(notNullValue()));
        resolvableType.verify(() -> ResolvableType.forClassWithGenerics(Map.class, classArray), atLeast(1));
	...
	//Sapient generated method id: ${4623f66f-2eaf-3b78-b9eb-6d6cecb5f962}
	@Test()
	...
	//Sapient generated method id: ${9c096587-2488-3865-9fb2-ad8cf97bbd6b}
	@Test()
	...
	//Sapient generated method id: ${99269197-38e4-3e61-b80e-c546d61e22ee}
	@Test()
	void ofInstanceTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${b1301ccd-db54-3f04-ba3b-023b16f93ee8}
	@Test()
	void listOfTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${1a55bfd1-a800-3a32-bada-69469b6ce117}
	@Test()
	void setOfTest() {
		//Arrange Statement(s)
	...
	//Sapient generated method id: ${fdc5ff0e-48f6-3ffc-bd15-6aa54a16a841}
	@Test()
	void mapOfTest() {
		//Arrange Statement(s)
        /*try (MockedStatic<Bindable> bindable = mockStatic(Bindable.class, CALLS_REAL_METHODS);
	...
	//Sapient generated method id: ${47c9fee2-c871-304a-9717-afca5a5be807}
	@Disabled()
	@Test()
    ...
    assertAll("result", () -> {
        assertThat(result, is(notNullValue()));
        verify(typeMock2).resolve();
        verify(typeMock2).getComponentType();
        _assert.verify(() -> Assert.notNull(typeMock2, "Type must not be null"), atLeast(1));
	...
	//Sapient generated method id: ${408629a3-3af9-3096-8cdb-52cfaf0d3167}
	@Test()
