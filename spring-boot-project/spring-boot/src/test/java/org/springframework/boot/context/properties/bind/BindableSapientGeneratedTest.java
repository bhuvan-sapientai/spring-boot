...
class BindableSapientGeneratedTest {
	...
	//Sapient generated method id: ${0c0b54df-f145-3614-8d79-f6601fa56d79}, hash: 047B4258E151EA911B75D04562D2D53D
	@Test()
	void getAnnotationWhenTypeIsInstanceAnnotation() {
		 ...
		 */
		//Arrange Statement(s)
		//ResolvableType resolvableTypeMock = mock(ResolvableType.class, "ResolvableType");
		//Bindable<Map<Object, Object>> bindableMock = mock(Bindable.class, "Bindable");
	...
	//Sapient generated method id: ${4eb7db39-0a57-38ad-a72d-511d50e04994}, hash: F2DB5BE376A8610DE09981CFA0186012
	@Test()
	...
	//Sapient generated method id: ${b7446969-16fe-3200-a92a-363fafc23073}, hash: B81ED5FA51A78B1403B769314FC2F20E
	@Test()
	void withExistingValueWhenThisBindMethodNotEqualsBindMethodVALUE_OBJECTAndExistingValueIsNotNull() {
		 ...
		 */
		//Arrange Statement(s)
		//Object objectMock = mock(Object.class, "null");
        /*try (MockedStatic<Assert> _assert = mockStatic(Assert.class);
    MockedStatic<Bindable> bindable = mockStatic(Bindable.class);
    MockedStatic<ResolvableType> resolvableType = mockStatic(ResolvableType.class)) {
    Class<Object>[] classArray = new Class[] { Object.class, Object.class };
    ...
    //Act Statement(s)
    Bindable result = target.withExistingValue(objectMock);
    //Assert statement(s)
    assertAll("result", () -> {
        assertThat(result, is(notNullValue()));
        resolvableType.verify(() -> ResolvableType.forClassWithGenerics(Map.class, classArray), atLeast(1));
	...
	//Sapient generated method id: ${c9bb1644-d672-3aaa-9855-15df24c7157e}, hash: 4696DEE02621AE934410925DFD723D40
	@Test()
    ...
    Bindable<Object> target = Bindable.mapOf(Object.class, Object.class);
    doReturn(false).when(typeMock).isArray();
    doReturn(ResolvableType.class).when(boxedTypeMock).resolve();
	...
	//Sapient generated method id: ${4623f66f-2eaf-3b78-b9eb-6d6cecb5f962}, hash: 2C60E7C5878778F90B061F2591BF7F6B
	@Test()
