...
class Log4J2LoggingSystemSapientGeneratedTest {
	...
	//Sapient generated method id: ${d8aa49fb-f8d7-35a5-8379-a9af06a492bc}, hash: EAC560DFB088E64DD7CCF6E87FFC248F
	@Disabled()
	@Test()
	void loadConfiguration1WhenCaughtExceptionThrowsIllegalStateException() throws FileNotFoundException {
		...
		try (MockedStatic<ResourceUtils> resourceUtils = mockStatic(ResourceUtils.class);
			...
			resourceUtils.when(() -> ResourceUtils.getURL("description1")).thenReturn(uRLMock);
			ClassLoader classLoader = ClassLoader.getPlatformClassLoader();
			Log4J2LoggingSystem target = new Log4J2LoggingSystem(classLoader);
			List<String> stringList = new ArrayList<>();
			//Act Statement(s)
			...
			assertAll("result", () -> {
				...
				resourceUtils.verify(() -> ResourceUtils.getURL("description1"), atLeast(1));
			});
		}
	}

	//Sapient generated method id: ${540dc9f4-a650-3155-94d8-58e5c5618ec8}, hash: B620C5A8325CC2335E02CFC4E02972A1
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${61e61526-e4ed-3c74-bfd7-3062419e3331}, hash: 85F3B32D4838EB2C153098B69272242B
	@Disabled()
	@Test()
