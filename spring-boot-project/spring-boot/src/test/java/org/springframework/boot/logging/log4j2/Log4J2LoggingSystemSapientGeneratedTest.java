...
class Log4J2LoggingSystemSapientGeneratedTest {
	...
	//Sapient generated method id: ${6175c26e-d6bc-3151-8f34-74f59721a7a1}, hash: 5B3F67FA52F26FB2BC33D94F72E5ED95
	@Test()
	void getStandardConfigLocationsWhenPropertyDefinedLocationIsNull() {
		...
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class)) {
			String[] stringArray = new String[] { "log4j2-test.properties", "log4j2-test.xml", "log4j2.properties", "log4j2.xml" };
	...
	//Sapient generated method id: ${d8aa49fb-f8d7-35a5-8379-a9af06a492bc}, hash: CB676CF141967C334D6846C5305B6A4D
	@Test()
	...
	//Sapient generated method id: ${540dc9f4-a650-3155-94d8-58e5c5618ec8}, hash: 94E4DA990E63E91C9959986EE239C9B6
	@Test()
	void loadConfiguration1WhenConfigurationsSizeNotGreaterThan1AndCaughtExceptionThrowsIllegalStateException() throws FileNotFoundException {
		...
		try (MockedStatic<ResourceUtils> resourceUtils = mockStatic(ResourceUtils.class)) {
			...
			resourceUtils.when(() -> ResourceUtils.getFile((URL) any())).thenReturn(file);
			resourceUtils.when(() -> ResourceUtils.getURL("<value>")).thenReturn(uRL).thenReturn(uRLMock);
			File file2 = new File("pathname1");
			resourceUtils.when(() -> ResourceUtils.getFile(uRLMock)).thenReturn(file2);
			ClassLoader classLoader = ClassLoader.getPlatformClassLoader();
			Log4J2LoggingSystem target = new Log4J2LoggingSystem(classLoader);
			LogFile logFile = LogFile.get(propertyResolverMock);
			List<String> stringList = new ArrayList<>();
			...
			assertAll("result", () -> {
				...
				assertThat(result.getCause(), is(instanceOf(exception.getClass())));
				resourceUtils.verify(() -> ResourceUtils.getURL("<value>"), atLeast(2));
				resourceUtils.verify(() -> ResourceUtils.getFile((URL) any()));
				resourceUtils.verify(() -> ResourceUtils.getFile(uRLMock), atLeast(1));
			});
		}
	}
	...
	//Sapient generated method id: ${61e61526-e4ed-3c74-bfd7-3062419e3331}, hash: 1A4003F493642680C647A63635C25B07
	@Test()
	void reinitializeWhenCaughtIOExceptionThrowsRuntimeException() throws IOException {
		 ...
		 */
		//Arrange Statement(s)
		Binder binderMock = mock(Binder.class, "BindResult");
		Environment environmentMock = mock(Environment.class, "Environment");
		BindResult<List<String>> bindResultMock = mock(BindResult.class, "Binder");
