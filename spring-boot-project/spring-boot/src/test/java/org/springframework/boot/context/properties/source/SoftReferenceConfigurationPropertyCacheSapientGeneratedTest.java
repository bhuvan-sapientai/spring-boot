...
class SoftReferenceConfigurationPropertyCacheSapientGeneratedTest {
	...
	//Sapient generated method id: ${44d7d8d6-bf4a-3f14-9c90-fcb97adadc11}, hash: E29837BC95C034DB4D2DBDC36D42EB60
	@Test()
	void setTimeToLiveWhenTimeToLiveNotIsZero() {
		 ...
		 */
		//Arrange Statement(s)
		Duration timeToLiveMock = mock(Duration.class, "PT10M");
		doReturn(false).when(timeToLiveMock).isZero();
		SoftReferenceConfigurationPropertyCache<Object> target = new SoftReferenceConfigurationPropertyCache(true);
		//Act Statement(s)
		target.setTimeToLive(timeToLiveMock);
		//Assert statement(s)
		assertAll("result", () -> verify(timeToLiveMock).isZero());
	}
