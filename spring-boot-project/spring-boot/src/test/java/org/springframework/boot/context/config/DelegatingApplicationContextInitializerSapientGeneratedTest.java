...
class DelegatingApplicationContextInitializerSapientGeneratedTest {
	...
	//Sapient generated method id: ${35f75ba5-16f0-3861-bf9e-72876a53136d}, hash: 5768BB55FC18CD55B5859D963EF0C7AF
//	@Test()
...
//			doReturn("return_of_getProperty1").when(configurableEnvironmentMock).getProperty("context.initializer.classes");
//			stringUtils.when(() -> StringUtils.hasLength("return_of_getProperty1")).thenReturn(true);
//			String[] stringArray = new String[] { "A" };
//			stringUtils.when(() -> StringUtils.tokenizeToStringArray("return_of_getProperty1", ",")).thenReturn(stringArray);
...
//				stringUtils.verify(() -> StringUtils.tokenizeToStringArray("return_of_getProperty1", ","), atLeast(1));
...
//	}
//
//	//Sapient generated method id: ${ffe9eea1-be58-357d-980e-e5ce8b3bb69f}, hash: C942C9C459D0470207673B32D56F0B86
//	@Disabled()
//	@Test()
...
//			doReturn("return_of_getProperty1").when(configurableEnvironmentMock).getProperty("context.initializer.classes");
//			stringUtils.when(() -> StringUtils.hasLength("return_of_getProperty1")).thenReturn(true);
//			String[] stringArray = new String[] { "return_of_tokenizeToStringArrayItem1" };
//			stringUtils.when(() -> StringUtils.tokenizeToStringArray("return_of_getProperty1", ",")).thenReturn(stringArray);
//			ClassLoader classLoader = ClassLoader.getPlatformClassLoader();
//			classUtils.when(() -> ClassUtils.getDefaultClassLoader()).thenReturn(classLoader);
