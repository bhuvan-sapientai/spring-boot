...
class JavaLoggingSystemSapientGeneratedTest {
	...
	//Sapient generated method id: ${855a9e38-7486-375a-821a-b4bc7d5739af}, hash: 4D686150A8E02AC79D442DBA8A660B60
	@Disabled()
	@Test()
	void getLoggerConfigurationsWhenNamesHasMoreElements() {
		...
		doReturn(loggerConfigurationMock10).when(target).getLoggerConfiguration("#com.intellij.openapi.vcs.actions.AnnotateToggleAction");
		LoggerConfiguration loggerConfigurationMock11 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock11).when(target).getLoggerConfiguration("org.languagetool.rules.spelling.morfologik.MorfologikSpellerRule");
		LoggerConfiguration loggerConfigurationMock12 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock12).when(target).getLoggerConfiguration("#git4idea.log.GitLogProvider");
		LoggerConfiguration loggerConfigurationMock13 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock13).when(target).getLoggerConfiguration("#com.intellij.openapi.vfs.impl.local.WatchRootsManager");
		LoggerConfiguration loggerConfigurationMock14 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock14).when(target).getLoggerConfiguration("#org.jetbrains.kotlin.psi.stubs.impl.KotlinStubBaseImpl");
		LoggerConfiguration loggerConfigurationMock15 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock15).when(target).getLoggerConfiguration("#com.intellij.lang.ant.config.impl.AntReference");
		LoggerConfiguration loggerConfigurationMock16 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock16).when(target).getLoggerConfiguration("#com.intellij.refactoring.extractInterface.ExtractInterfaceHandler");
		LoggerConfiguration loggerConfigurationMock17 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock17).when(target).getLoggerConfiguration("#com.intellij.openapi.wm.impl.PainterHelper");
		LoggerConfiguration loggerConfigurationMock18 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock18).when(target).getLoggerConfiguration("#com.intellij.codeInsight.editorActions.TypedHandler");
		LoggerConfiguration loggerConfigurationMock19 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock19).when(target).getLoggerConfiguration("#com.intellij.execution.process.KillableProcessHandler");
		LoggerConfiguration loggerConfigurationMock20 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock20).when(target).getLoggerConfiguration("#com.intellij.execution.testDiscovery.TestDiscoveryIndex");
		LoggerConfiguration loggerConfigurationMock21 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock21).when(target).getLoggerConfiguration("#org.jetbrains.plugins.terminal.ShellTerminalWidget");
		LoggerConfiguration loggerConfigurationMock22 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock22).when(target).getLoggerConfiguration("A");
		LoggerConfiguration loggerConfigurationMock23 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock23).when(target).getLoggerConfiguration("#com.intellij.lang.properties.PropertiesUastReferenceContributor");
		LoggerConfiguration loggerConfigurationMock24 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock24).when(target).getLoggerConfiguration("#com.intellij.debugger.ui.breakpoints.ExceptionBreakpoint");
		LoggerConfiguration loggerConfigurationMock25 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock25).when(target).getLoggerConfiguration("#zielu.gittoolbox.blame");
		...
		doReturn(loggerConfigurationMock28).when(target).getLoggerConfiguration("#org.jetbrains.idea.perforce.application.PerforceClientRootsChecker");
		LoggerConfiguration loggerConfigurationMock29 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock29).when(target).getLoggerConfiguration("jetbrains.exodus.gc.GarbageCollector");
		LoggerConfiguration loggerConfigurationMock30 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock30).when(target).getLoggerConfiguration("#com.intellij.codeInsight.daemon.impl.quickfix.DefineParamsDefaultValueAction");
		...
		doReturn(loggerConfigurationMock33).when(target).getLoggerConfiguration("sun.lwawt.macosx.CPlatformView");
		LoggerConfiguration loggerConfigurationMock34 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock34).when(target).getLoggerConfiguration("#org.zmlx.hg4idea.util.HgVersion");
		LoggerConfiguration loggerConfigurationMock35 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock35).when(target).getLoggerConfiguration("#com.intellij.codeInsight.actions.VcsFacade");
		LoggerConfiguration loggerConfigurationMock36 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock36).when(target).getLoggerConfiguration("#com.intellij.openapi.paths.PathReferenceProviderBase");
		LoggerConfiguration loggerConfigurationMock37 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock37).when(target).getLoggerConfiguration("#com.intellij.toolWindow.ToolWindowPane");
		LoggerConfiguration loggerConfigurationMock38 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock38).when(target).getLoggerConfiguration("#com.intellij.concurrency.JobLauncher");
		LoggerConfiguration loggerConfigurationMock39 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock39).when(target).getLoggerConfiguration("#com.intellij.codeInspection.CommonProblemDescriptorImpl");
		LoggerConfiguration loggerConfigurationMock40 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock40).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.impl.SelectionModelImpl");
		LoggerConfiguration loggerConfigurationMock41 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock41).when(target).getLoggerConfiguration("#com.intellij.execution.actions.BaseRunConfigurationAction");
		LoggerConfiguration loggerConfigurationMock42 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock42).when(target).getLoggerConfiguration("okhttp3.OkHttpClient");
		LoggerConfiguration loggerConfigurationMock43 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock43).when(target).getLoggerConfiguration("jdk.internal.httpclient.debug");
		LoggerConfiguration loggerConfigurationMock44 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock44).when(target).getLoggerConfiguration("#com.intellij.codeInsight.daemon.impl.DaemonListeners");
		LoggerConfiguration loggerConfigurationMock45 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock45).when(target).getLoggerConfiguration("#com.intellij.indexing.shared.util.zipFs.UncompressedZipFileSystem");
		LoggerConfiguration loggerConfigurationMock46 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock46).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.impl.IntervalTreeImpl");
		LoggerConfiguration loggerConfigurationMock47 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock47).when(target).getLoggerConfiguration("#org.intellij.plugins.xpathView.XPathEvalAction");
		...
		doReturn(loggerConfigurationMock49).when(target).getLoggerConfiguration("#com.intellij.psi.search.scope.packageSet.FilePatternPackageSet");
		LoggerConfiguration loggerConfigurationMock50 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock50).when(target).getLoggerConfiguration("#com.intellij.codeInsight.folding.impl.UpdateFoldRegionsOperation");
		LoggerConfiguration loggerConfigurationMock51 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock51).when(target).getLoggerConfiguration("#com.intellij.openapi.roots.impl.libraries.RenameLibraryHandler");
		LoggerConfiguration loggerConfigurationMock52 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock52).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.impl.softwrap.mapping.CachingSoftWrapDataMapper");
		LoggerConfiguration loggerConfigurationMock53 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock53).when(target).getLoggerConfiguration("#com.intellij.psi.controlFlow.ControlFlowAnalyzer");
		LoggerConfiguration loggerConfigurationMock54 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock54).when(target).getLoggerConfiguration("com.sun.xml.bind.v2.runtime.reflect.Accessor$FieldReflection");
		LoggerConfiguration loggerConfigurationMock55 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock55).when(target).getLoggerConfiguration("#com.intellij.externalProcessAuthHelper.ExternalProcessHandlerService");
		LoggerConfiguration loggerConfigurationMock56 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock56).when(target).getLoggerConfiguration("#com.intellij.execution.RunManager");
		LoggerConfiguration loggerConfigurationMock57 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock57).when(target).getLoggerConfiguration("org.apache.commons.beanutils.converters.BooleanConverter");
		LoggerConfiguration loggerConfigurationMock58 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock58).when(target).getLoggerConfiguration("#com.intellij.codeInspection.dataFlow.interpreter.StandardDataFlowInterpreter");
		LoggerConfiguration loggerConfigurationMock59 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock59).when(target).getLoggerConfiguration("#com.intellij.compiler.server.impl.BuildProcessClasspathManager");
		LoggerConfiguration loggerConfigurationMock60 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock60).when(target).getLoggerConfiguration("#com.intellij.openapi.wm.impl.ToolWindowManagerImpl");
		LoggerConfiguration loggerConfigurationMock61 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock61).when(target).getLoggerConfiguration("#com.intellij.psi.GenericsUtil");
		LoggerConfiguration loggerConfigurationMock62 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock62).when(target).getLoggerConfiguration("#com.intellij.openapi.vcs.changes.VcsIgnoreManagerImpl");
		LoggerConfiguration loggerConfigurationMock63 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock63).when(target).getLoggerConfiguration("#com.intellij.psi.impl.migration.PsiMigrationManager");
		LoggerConfiguration loggerConfigurationMock64 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock64).when(target).getLoggerConfiguration("#com.intellij.util.indexing.UnindexedFilesScannerExecutor");
		LoggerConfiguration loggerConfigurationMock65 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock65).when(target).getLoggerConfiguration("org.gradle.tooling.GradleConnector");
		LoggerConfiguration loggerConfigurationMock66 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock66).when(target).getLoggerConfiguration("#com.intellij.framework.detection.impl.DetectedFrameworksData");
		LoggerConfiguration loggerConfigurationMock67 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock67).when(target).getLoggerConfiguration("#com.intellij.ui.InsertPathAction");
		LoggerConfiguration loggerConfigurationMock68 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock68).when(target).getLoggerConfiguration("#com.theoryinpractice.testng.inspection.DuplicatedDataProviderNamesInspection");
		...
		doReturn(loggerConfigurationMock72).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.tree.SharedImplUtil");
		LoggerConfiguration loggerConfigurationMock73 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock73).when(target).getLoggerConfiguration("#com.intellij.util.indexing.diagnostic.IndexOperationFUS");
		LoggerConfiguration loggerConfigurationMock74 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock74).when(target).getLoggerConfiguration("#org.jetbrains.plugins.groovy.codeInspection.confusing.GrUnusedIncDecInspection");
		LoggerConfiguration loggerConfigurationMock75 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock75).when(target).getLoggerConfiguration("#com.intellij.util.indexing.ProjectChangedFilesScanner");
		LoggerConfiguration loggerConfigurationMock76 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock76).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.resolve.ClassResolverProcessor");
		LoggerConfiguration loggerConfigurationMock77 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock77).when(target).getLoggerConfiguration("#git4idea.rebase.GitSimpleEditorHandler");
		LoggerConfiguration loggerConfigurationMock78 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock78).when(target).getLoggerConfiguration("#zielu.gittoolbox.ui");
		LoggerConfiguration loggerConfigurationMock79 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock79).when(target).getLoggerConfiguration("java.awt.event.InputEvent");
		LoggerConfiguration loggerConfigurationMock80 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock80).when(target).getLoggerConfiguration("#com.intellij.lang.documentation.psi");
		LoggerConfiguration loggerConfigurationMock81 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock81).when(target).getLoggerConfiguration("#com.intellij.util.containers.Enumerator");
		LoggerConfiguration loggerConfigurationMock82 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock82).when(target).getLoggerConfiguration("#com.intellij.vcs.log.impl.VcsLogCachesInvalidator");
		LoggerConfiguration loggerConfigurationMock83 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock83).when(target).getLoggerConfiguration("#com.intellij.util.MethodInvocator");
		LoggerConfiguration loggerConfigurationMock84 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock84).when(target).getLoggerConfiguration("#org.jetbrains.kotlin.idea.script.ScriptTemplatesFromDependenciesProvider");
		LoggerConfiguration loggerConfigurationMock85 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock85).when(target).getLoggerConfiguration("#com.intellij.uiDesigner.binding.FormClassAnnotator");
		LoggerConfiguration loggerConfigurationMock86 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock86).when(target).getLoggerConfiguration("#com.android.tools.idea.run.ui.BaseAction");
		LoggerConfiguration loggerConfigurationMock87 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock87).when(target).getLoggerConfiguration("#com.intellij.ide.impl.DataValidators");
		LoggerConfiguration loggerConfigurationMock88 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock88).when(target).getLoggerConfiguration("#com.intellij.vcs.log.data.index.VcsLogUserIndex");
		LoggerConfiguration loggerConfigurationMock89 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock89).when(target).getLoggerConfiguration("#com.intellij.openapi.projectRoots.impl.UnknownSdkCollector");
		LoggerConfiguration loggerConfigurationMock90 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock90).when(target).getLoggerConfiguration("#org.jetbrains.android.AndroidDocumentationProvider");
		LoggerConfiguration loggerConfigurationMock91 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock91).when(target).getLoggerConfiguration("#com.intellij.openapi.vcs.changes.committed.CommittedChangesCache");
		LoggerConfiguration loggerConfigurationMock92 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock92).when(target).getLoggerConfiguration("#com.intellij.util.indexing.PerProjectIndexingQueue");
		LoggerConfiguration loggerConfigurationMock93 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock93).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.codeStyle.JavaCodeStyleManagerImpl");
		LoggerConfiguration loggerConfigurationMock94 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock94).when(target).getLoggerConfiguration("com.intellij.coverage.JavaCoverageEngine");
		LoggerConfiguration loggerConfigurationMock95 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock95).when(target).getLoggerConfiguration("#com.intellij.workspaceModel.ide.impl.WorkspaceModelCacheSerializer");
		LoggerConfiguration loggerConfigurationMock96 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock96).when(target).getLoggerConfiguration("#com.intellij.internal.statistic.eventLog.uploader.EventLogExternalUploader");
		LoggerConfiguration loggerConfigurationMock97 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock97).when(target).getLoggerConfiguration("#org.jetbrains.io.ChannelRegistrar");
		LoggerConfiguration loggerConfigurationMock98 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock98).when(target).getLoggerConfiguration("IdeResourcesUtil.kt");
		LoggerConfiguration loggerConfigurationMock99 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock99).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.colors.impl.AppFontOptions");
		LoggerConfiguration loggerConfigurationMock100 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock100).when(target).getLoggerConfiguration("#com.intellij.internal.ml.ngram.VocabularyWithLimit");
		LoggerConfiguration loggerConfigurationMock101 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock101).when(target).getLoggerConfiguration("#com.intellij.codeInsight.intention.impl.ShowIntentionActionsHandler");
		//Act Statement(s)
		...
		assertAll("result", () -> {
			...
			verify(target).getLoggerConfiguration("#com.intellij.ui.InsertPathAction");
			...
			verify(target).getLoggerConfiguration("IdeResourcesUtil.kt");
			verify(target).getLoggerConfiguration("#com.intellij.openapi.editor.colors.impl.AppFontOptions");
			verify(target).getLoggerConfiguration("#com.intellij.internal.ml.ngram.VocabularyWithLimit");
			verify(target).getLoggerConfiguration("#com.intellij.codeInsight.intention.impl.ShowIntentionActionsHandler");
		});
	}
