...
class JavaLoggingSystemSapientGeneratedTest {
	...
	//Sapient generated method id: ${855a9e38-7486-375a-821a-b4bc7d5739af}, hash: 2276A0AB07D600C628CF1C455EDE46F0
	@Test()
	void getLoggerConfigurationsWhenNamesHasMoreElements() {
		...
		doReturn(loggerConfigurationMock8).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.tree.java.AnnotationParamListElement");
		LoggerConfiguration loggerConfigurationMock9 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock9).when(target).getLoggerConfiguration("#git4idea.actions.GitPull");
		LoggerConfiguration loggerConfigurationMock10 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock10).when(target).getLoggerConfiguration("#com.intellij.openapi.progress.impl.BackgroundableProcessIndicator");
		LoggerConfiguration loggerConfigurationMock11 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock11).when(target).getLoggerConfiguration("#com.intellij.util.progress");
		LoggerConfiguration loggerConfigurationMock12 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock12).when(target).getLoggerConfiguration("#com.intellij.openapi.vcs.actions.AnnotateToggleAction");
		...
		doReturn(loggerConfigurationMock14).when(target).getLoggerConfiguration("#com.android.tools.idea.gradle.dsl.model.ext.GradlePropertyModelImpl");
		LoggerConfiguration loggerConfigurationMock15 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock15).when(target).getLoggerConfiguration("#com.intellij.openapi.vfs.impl.local.WatchRootsManager");
		...
		doReturn(loggerConfigurationMock20).when(target).getLoggerConfiguration("#com.intellij.execution.process.KillableProcessHandler");
		LoggerConfiguration loggerConfigurationMock21 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock21).when(target).getLoggerConfiguration("#com.intellij.execution.testDiscovery.TestDiscoveryIndex");
		LoggerConfiguration loggerConfigurationMock22 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock22).when(target).getLoggerConfiguration("org.apache.hc.client5.http.headers");
		LoggerConfiguration loggerConfigurationMock23 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock23).when(target).getLoggerConfiguration("#org.jetbrains.plugins.terminal.ShellTerminalWidget");
		LoggerConfiguration loggerConfigurationMock24 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock24).when(target).getLoggerConfiguration("#com.intellij.lang.properties.PropertiesUastReferenceContributor");
		LoggerConfiguration loggerConfigurationMock25 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock25).when(target).getLoggerConfiguration("#com.intellij.notification.impl.NotificationsAnnouncer");
		LoggerConfiguration loggerConfigurationMock26 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock26).when(target).getLoggerConfiguration("H");
		LoggerConfiguration loggerConfigurationMock27 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock27).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.tree.java.MethodReferenceResolver");
		LoggerConfiguration loggerConfigurationMock28 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock28).when(target).getLoggerConfiguration("#com.intellij.codeInsight.daemon.impl.quickfix.DefineParamsDefaultValueAction");
		LoggerConfiguration loggerConfigurationMock29 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock29).when(target).getLoggerConfiguration("#com.intellij.util.xml.impl.DomRootInvocationHandler");
		LoggerConfiguration loggerConfigurationMock30 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock30).when(target).getLoggerConfiguration("#com.intellij.externalProcessAuthHelper.ExternalProcessRest");
		LoggerConfiguration loggerConfigurationMock31 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock31).when(target).getLoggerConfiguration("#com.intellij.openapi.util.LowMemoryWatcher");
		LoggerConfiguration loggerConfigurationMock32 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock32).when(target).getLoggerConfiguration("#com.intellij.codeInspection.dataFlow.ConstantValueInspection");
		LoggerConfiguration loggerConfigurationMock33 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock33).when(target).getLoggerConfiguration("#org.jetbrains.kotlin.idea.stubindex.KotlinTypeAliasByExpansionShortNameIndex$Helper");
		LoggerConfiguration loggerConfigurationMock34 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock34).when(target).getLoggerConfiguration("sun.lwawt.macosx.CPlatformView");
		LoggerConfiguration loggerConfigurationMock35 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock35).when(target).getLoggerConfiguration("#org.zmlx.hg4idea.util.HgVersion");
		LoggerConfiguration loggerConfigurationMock36 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock36).when(target).getLoggerConfiguration("#com.intellij.codeInsight.actions.VcsFacade");
		LoggerConfiguration loggerConfigurationMock37 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock37).when(target).getLoggerConfiguration("#com.intellij.openapi.paths.PathReferenceProviderBase");
		LoggerConfiguration loggerConfigurationMock38 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock38).when(target).getLoggerConfiguration("#com.intellij.toolWindow.ToolWindowPane");
		LoggerConfiguration loggerConfigurationMock39 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock39).when(target).getLoggerConfiguration("#com.intellij.concurrency.JobLauncher");
		LoggerConfiguration loggerConfigurationMock40 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock40).when(target).getLoggerConfiguration("#com.intellij.codeInspection.CommonProblemDescriptorImpl");
		LoggerConfiguration loggerConfigurationMock41 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock41).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.impl.SelectionModelImpl");
		LoggerConfiguration loggerConfigurationMock42 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock42).when(target).getLoggerConfiguration("#com.intellij.execution.actions.BaseRunConfigurationAction");
		LoggerConfiguration loggerConfigurationMock43 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock43).when(target).getLoggerConfiguration("okhttp3.OkHttpClient");
		LoggerConfiguration loggerConfigurationMock44 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock44).when(target).getLoggerConfiguration("jdk.internal.httpclient.debug");
		LoggerConfiguration loggerConfigurationMock45 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock45).when(target).getLoggerConfiguration("#com.intellij.codeInsight.daemon.impl.DaemonListeners");
		LoggerConfiguration loggerConfigurationMock46 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock46).when(target).getLoggerConfiguration("#com.intellij.indexing.shared.util.zipFs.UncompressedZipFileSystem");
		LoggerConfiguration loggerConfigurationMock47 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock47).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.impl.IntervalTreeImpl");
		LoggerConfiguration loggerConfigurationMock48 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock48).when(target).getLoggerConfiguration("#git4idea.index.GitStageTracker");
		LoggerConfiguration loggerConfigurationMock49 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock49).when(target).getLoggerConfiguration("#org.intellij.plugins.xpathView.XPathEvalAction");
		LoggerConfiguration loggerConfigurationMock50 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock50).when(target).getLoggerConfiguration("#com.intellij.psi.search.scope.packageSet.FilePatternPackageSet");
		LoggerConfiguration loggerConfigurationMock51 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock51).when(target).getLoggerConfiguration("#com.jetbrains.python.testing.TestRunnerDetector");
		LoggerConfiguration loggerConfigurationMock52 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock52).when(target).getLoggerConfiguration("#com.intellij.codeInsight.folding.impl.UpdateFoldRegionsOperation");
		LoggerConfiguration loggerConfigurationMock53 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock53).when(target).getLoggerConfiguration("#com.intellij.openapi.roots.impl.libraries.RenameLibraryHandler");
		LoggerConfiguration loggerConfigurationMock54 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock54).when(target).getLoggerConfiguration("#org.jetbrains.kotlin.idea.stubindex.KotlinProbablyNothingFunctionShortNameIndex$Helper");
		LoggerConfiguration loggerConfigurationMock55 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock55).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.impl.softwrap.mapping.CachingSoftWrapDataMapper");
		LoggerConfiguration loggerConfigurationMock56 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock56).when(target).getLoggerConfiguration("com.sun.xml.bind.v2.runtime.reflect.Accessor$FieldReflection");
		LoggerConfiguration loggerConfigurationMock57 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock57).when(target).getLoggerConfiguration("#com.intellij.externalProcessAuthHelper.ExternalProcessHandlerService");
		LoggerConfiguration loggerConfigurationMock58 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock58).when(target).getLoggerConfiguration("#com.intellij.execution.RunManager");
		LoggerConfiguration loggerConfigurationMock59 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock59).when(target).getLoggerConfiguration("org.apache.commons.beanutils.converters.BooleanConverter");
		LoggerConfiguration loggerConfigurationMock60 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock60).when(target).getLoggerConfiguration("#com.intellij.compiler.server.impl.BuildProcessClasspathManager");
		LoggerConfiguration loggerConfigurationMock61 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock61).when(target).getLoggerConfiguration("#com.intellij.openapi.wm.impl.ToolWindowManagerImpl");
		LoggerConfiguration loggerConfigurationMock62 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock62).when(target).getLoggerConfiguration("#com.intellij.psi.GenericsUtil");
		LoggerConfiguration loggerConfigurationMock63 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock63).when(target).getLoggerConfiguration("#com.intellij.openapi.editor.richcopy.view.AbstractSyntaxAwareReader");
		LoggerConfiguration loggerConfigurationMock64 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock64).when(target).getLoggerConfiguration("#com.jetbrains.python.sdk.PythonSdkType");
		LoggerConfiguration loggerConfigurationMock65 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock65).when(target).getLoggerConfiguration("#com.intellij.openapi.vcs.changes.VcsIgnoreManagerImpl");
		LoggerConfiguration loggerConfigurationMock66 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock66).when(target).getLoggerConfiguration("#com.intellij.psi.impl.migration.PsiMigrationManager");
		LoggerConfiguration loggerConfigurationMock67 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock67).when(target).getLoggerConfiguration("org.gradle.tooling.GradleConnector");
		LoggerConfiguration loggerConfigurationMock68 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock68).when(target).getLoggerConfiguration("#com.intellij.framework.detection.impl.DetectedFrameworksData");
		LoggerConfiguration loggerConfigurationMock69 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock69).when(target).getLoggerConfiguration("#com.intellij.openapi.wm.impl.SideStack");
		LoggerConfiguration loggerConfigurationMock70 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock70).when(target).getLoggerConfiguration("#com.jetbrains.rdserver.daemon.RdServerEditorTracker");
		LoggerConfiguration loggerConfigurationMock71 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock71).when(target).getLoggerConfiguration("#com.intellij.codeInsight.daemon.impl.DefaultHighlightVisitor");
		LoggerConfiguration loggerConfigurationMock72 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock72).when(target).getLoggerConfiguration("#com.android.tools.idea.adblib.AndroidAdbSessionHost");
		LoggerConfiguration loggerConfigurationMock73 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock73).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.tree.SharedImplUtil");
		LoggerConfiguration loggerConfigurationMock74 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock74).when(target).getLoggerConfiguration("org.eclipse.aether.internal.impl.TrackingFileManager");
		LoggerConfiguration loggerConfigurationMock75 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock75).when(target).getLoggerConfiguration("#com.jetbrains.python.black.BlackFormatterUtil$Companion");
		LoggerConfiguration loggerConfigurationMock76 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock76).when(target).getLoggerConfiguration("#com.intellij.platform.templates.SaveProjectAsTemplateAction");
		LoggerConfiguration loggerConfigurationMock77 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock77).when(target).getLoggerConfiguration("#org.jetbrains.plugins.groovy.codeInspection.confusing.GrUnusedIncDecInspection");
		LoggerConfiguration loggerConfigurationMock78 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock78).when(target).getLoggerConfiguration("#com.intellij.util.indexing.ProjectChangedFilesScanner");
		LoggerConfiguration loggerConfigurationMock79 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock79).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.resolve.ClassResolverProcessor");
		LoggerConfiguration loggerConfigurationMock80 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock80).when(target).getLoggerConfiguration("#git4idea.rebase.GitSimpleEditorHandler");
		LoggerConfiguration loggerConfigurationMock81 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock81).when(target).getLoggerConfiguration("java.awt.event.InputEvent");
		LoggerConfiguration loggerConfigurationMock82 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock82).when(target).getLoggerConfiguration("#com.android.adblib.impl.AdbDeviceServicesImpl");
		LoggerConfiguration loggerConfigurationMock83 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock83).when(target).getLoggerConfiguration("#com.intellij.util.containers.Enumerator");
		LoggerConfiguration loggerConfigurationMock84 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock84).when(target).getLoggerConfiguration("#com.intellij.lang.documentation.psi");
		LoggerConfiguration loggerConfigurationMock85 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock85).when(target).getLoggerConfiguration("#com.intellij.vcs.log.impl.VcsLogCachesInvalidator");
		LoggerConfiguration loggerConfigurationMock86 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock86).when(target).getLoggerConfiguration("#com.intellij.util.MethodInvocator");
		LoggerConfiguration loggerConfigurationMock87 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock87).when(target).getLoggerConfiguration("#org.jetbrains.kotlin.idea.script.ScriptTemplatesFromDependenciesProvider");
		LoggerConfiguration loggerConfigurationMock88 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock88).when(target).getLoggerConfiguration("#com.jetbrains.python.packaging.PyCustomPackageManagers");
		LoggerConfiguration loggerConfigurationMock89 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock89).when(target).getLoggerConfiguration("#com.intellij.ide.impl.DataValidators");
		LoggerConfiguration loggerConfigurationMock90 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock90).when(target).getLoggerConfiguration("#com.intellij.vcs.log.data.index.VcsLogUserIndex");
		LoggerConfiguration loggerConfigurationMock91 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock91).when(target).getLoggerConfiguration("org.apache.hc.client5.http2.frame.payload");
		LoggerConfiguration loggerConfigurationMock92 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock92).when(target).getLoggerConfiguration("#org.jetbrains.android.AndroidDocumentationProvider");
		LoggerConfiguration loggerConfigurationMock93 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock93).when(target).getLoggerConfiguration("#com.intellij.openapi.projectRoots.impl.UnknownSdkCollector");
		LoggerConfiguration loggerConfigurationMock94 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock94).when(target).getLoggerConfiguration("#com.intellij.openapi.vcs.changes.committed.CommittedChangesCache");
		LoggerConfiguration loggerConfigurationMock95 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock95).when(target).getLoggerConfiguration("#com.intellij.util.indexing.PerProjectIndexingQueue");
		LoggerConfiguration loggerConfigurationMock96 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock96).when(target).getLoggerConfiguration("#com.intellij.psi.impl.source.codeStyle.JavaCodeStyleManagerImpl");
		LoggerConfiguration loggerConfigurationMock97 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock97).when(target).getLoggerConfiguration("com.intellij.coverage.JavaCoverageEngine");
		LoggerConfiguration loggerConfigurationMock98 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock98).when(target).getLoggerConfiguration("#com.intellij.workspaceModel.ide.impl.WorkspaceModelCacheSerializer");
		LoggerConfiguration loggerConfigurationMock99 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock99).when(target).getLoggerConfiguration("#com.intellij.internal.statistic.eventLog.uploader.EventLogExternalUploader");
		LoggerConfiguration loggerConfigurationMock100 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock100).when(target).getLoggerConfiguration("#org.jetbrains.io.ChannelRegistrar");
		LoggerConfiguration loggerConfigurationMock101 = mock(LoggerConfiguration.class);
		doReturn(loggerConfigurationMock101).when(target).getLoggerConfiguration("org.apache.hc.client5.http.impl.nio.PoolingAsyncClientConnectionManager");
		...
		assertAll("result", () -> {
			...
			verify(target).getLoggerConfiguration("#com.intellij.openapi.progress.impl.BackgroundableProcessIndicator");
			verify(target).getLoggerConfiguration("#com.intellij.util.progress");
			...
			verify(target).getLoggerConfiguration("#com.android.tools.idea.gradle.dsl.model.ext.GradlePropertyModelImpl");
			...
			verify(target).getLoggerConfiguration("org.apache.hc.client5.http.headers");
			...
			verify(target).getLoggerConfiguration("#com.intellij.notification.impl.NotificationsAnnouncer");
			...
			verify(target).getLoggerConfiguration("#org.jetbrains.kotlin.idea.stubindex.KotlinTypeAliasByExpansionShortNameIndex$Helper");
			...
			verify(target).getLoggerConfiguration("#com.jetbrains.python.testing.TestRunnerDetector");
			...
			verify(target).getLoggerConfiguration("#org.jetbrains.kotlin.idea.stubindex.KotlinProbablyNothingFunctionShortNameIndex$Helper");
			...
			verify(target).getLoggerConfiguration("#com.jetbrains.python.sdk.PythonSdkType");
			...
			verify(target).getLoggerConfiguration("#com.android.tools.idea.adblib.AndroidAdbSessionHost");
			...
			verify(target).getLoggerConfiguration("#com.jetbrains.python.black.BlackFormatterUtil$Companion");
			...
			verify(target).getLoggerConfiguration("#com.android.adblib.impl.AdbDeviceServicesImpl");
			...
			verify(target).getLoggerConfiguration("#com.jetbrains.python.packaging.PyCustomPackageManagers");
			...
			verify(target).getLoggerConfiguration("org.apache.hc.client5.http2.frame.payload");
			...
			verify(target).getLoggerConfiguration("#com.intellij.psi.impl.source.codeStyle.JavaCodeStyleManagerImpl");
			verify(target).getLoggerConfiguration("com.intellij.coverage.JavaCoverageEngine");
			verify(target).getLoggerConfiguration("#com.intellij.workspaceModel.ide.impl.WorkspaceModelCacheSerializer");
			verify(target).getLoggerConfiguration("#com.intellij.internal.statistic.eventLog.uploader.EventLogExternalUploader");
			verify(target).getLoggerConfiguration("#org.jetbrains.io.ChannelRegistrar");
			verify(target).getLoggerConfiguration("org.apache.hc.client5.http.impl.nio.PoolingAsyncClientConnectionManager");
		});
	}
