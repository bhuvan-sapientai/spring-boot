...
class MustacheViewSapientGeneratedTest {
	...
	//Sapient generated method id: ${fc535224-7726-3ae3-a90a-c63cf170eb80}
	@Test()
	...
	//Sapient generated method id: ${86a8cc2a-9a81-37d0-846c-978b6189bbd9}
	@Test()
	...
	//Sapient generated method id: ${bf05db0f-df87-3492-9198-1233ecbf1dc8}
	@Test()
	...
	//Sapient generated method id: ${85cfec91-55e3-396b-ac2a-42d560b817f9}
	@Disabled()
	@Test()
	void renderInternalWhenDefaultBranch() throws Throwable, Exception {
		...
		try (MockedStatic<Flux> flux = mockStatic(Flux.class)) {
			...
			doReturn(outputStream).when(dataBufferMock).asOutputStream();
			...
			Map<String, Object> stringObjectMap = new HashMap<>();
			doNothing().when(templateMock).execute(eq(stringObjectMap), (OutputStreamWriter) any());
			//Act Statement(s)
			...
			assertAll("result", () -> {
				...
				verify(templateMock).execute(eq(stringObjectMap), (OutputStreamWriter) any());
			});
		}
	}

	//Sapient generated method id: ${b634464f-82e5-313f-9624-64864024a9dc}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${bc422934-d2a5-3921-9c4e-1a49e168b58a}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${bcfdba78-bae1-3cf2-a428-111fd18ebb1e}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${043563ef-2577-3f30-a839-2e3f73ccceaa}
	@Disabled()
	@Test()
