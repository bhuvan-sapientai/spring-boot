...
class BindableRuntimeHintsRegistrarSapientGeneratedTest {
	...
	//Sapient generated method id: ${bc32b462-c0e2-3b0a-8d60-1ededd13d7e9}, hash: 76ADE9F9FCBF0167F16ACC385F2015A1
	@Test()
	void forTypesTest() {
		/*
	...
	//Sapient generated method id: ${9fbf1158-262c-310f-a0b2-fd9cc0ebcdc6}, hash: C7C1DF5FBE30D2CF522A86A77DDC71F4
	@Test()
	void forBindablesTest() {
		 ...
		 */
		//Arrange Statement(s)
		BindableRuntimeHintsRegistrar bindableRuntimeHintsRegistrarMock = mock(BindableRuntimeHintsRegistrar.class, "BindableRuntimeHintsRegistrar");
		try (MockedStatic<BindableRuntimeHintsRegistrar> bindableRuntimeHintsRegistrar = mockStatic(BindableRuntimeHintsRegistrar.class, CALLS_REAL_METHODS);
