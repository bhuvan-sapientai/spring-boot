...
class SpringApplicationAdminMXBeanRegistrarSapientGeneratedTest {
	...
	//Sapient generated method id: ${8965c77a-005e-3a50-b8bb-0a78bd407600}, hash: D7F12CA6334853B1605561D2773D6038
	@Disabled()
	@Test()
	...
	void destroyTest() throws Exception, MalformedObjectNameException {
		/*
		 * TODO: Help needed! This method is not unit testable!
		 *  Following variables could not be isolated/mocked: object of type MBeanServer
		 *  Suggestions:
		 *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
		 *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
		 *  The test code, including the assertion statements, has been successfully generated.
