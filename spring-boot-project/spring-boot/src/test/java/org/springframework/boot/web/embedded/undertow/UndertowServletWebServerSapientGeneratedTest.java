...
class UndertowServletWebServerSapientGeneratedTest {
	...
	//Sapient generated method id: ${d422d2d5-bcb2-3ad6-8b06-6083e9775f6c}
	@Disabled()
	@Test()
	void createHttpHandlerWhenStringUtilsHasLengthThisContextPath() {
		...
		try (MockedStatic<Handlers> handlers = mockStatic(Handlers.class)) {
			...
			UndertowServletWebServer target = new UndertowServletWebServer(undertowBuilderMock, (Iterable) null, "A", false);
			//Act Statement(s)
	...
	void getStartLogMessageWhenPortsSizeNotEquals1AndPortsIsEmpty() {
		...
		try (MockedStatic<ReflectionUtils> reflectionUtils = mockStatic(ReflectionUtils.class, CALLS_REAL_METHODS);
			...
			UndertowServletWebServer target = new UndertowServletWebServer(undertowBuilderMock, (Iterable) null, "A", true);
			//Act Statement(s)
			String result = target.getStartLogMessage();
			//Assert statement(s)
			assertAll("result", () -> {
	...
	//Sapient generated method id: ${d37fe8f2-8215-35de-b1d4-2a6166f9ea37}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${bc7566b0-d239-375a-8bca-6321914c718d}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${553fa339-f623-3684-b26a-698c101827f4}
	@Disabled()
	@Test()
