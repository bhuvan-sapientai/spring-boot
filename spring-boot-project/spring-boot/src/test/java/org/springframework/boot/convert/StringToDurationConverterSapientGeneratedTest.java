...
class StringToDurationConverterSapientGeneratedTest {
	...
	//Sapient generated method id: ${a09cc112-2d6f-3df0-a3e4-2475492f0d41}, hash: 375B1FBFA003E47D60F78EBDBC3DF9FA
	@Test()
	void getConvertibleTypesTest() {
		...
		GenericConverter.ConvertiblePair genericConverterConvertiblePair = new GenericConverter.ConvertiblePair(String.class, Duration.class);
	...
	//Sapient generated method id: ${09d82632-f9c3-3cd5-9c0f-21b6c13aef57}, hash: 94BC32B63C436F2229C99C0B656630CF
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${d5fe6cef-93d9-323d-84c3-b6bbfb0f2d3f}, hash: 84241606EE96033DBFCD2BD924FEF322
	@Disabled()
	@Test()
	void convertWhenAnnotationIsNullAndAnnotationIsNullAndStyleIsNull() {
		...
		try (MockedStatic<DurationStyle> durationStyle = mockStatic(DurationStyle.class, CALLS_REAL_METHODS);
			...
			Object object = new Object();
			objectUtils.when(() -> ObjectUtils.isEmpty(object)).thenReturn(false);
			durationStyle.when(() -> DurationStyle.detect("")).thenReturn(DurationStyle.SIMPLE);
			StringToDurationConverter target = new StringToDurationConverter();
			TypeDescriptor typeDescriptor = new TypeDescriptor(fieldMock);
			TypeDescriptor typeDescriptor2 = new TypeDescriptor(fieldMock2);
			//Act Statement(s)
			...
			assertAll("result", () -> {
				assertThat(result, equalTo(duration));
				objectUtils.verify(() -> ObjectUtils.isEmpty(object), atLeast(1));
				durationStyle.verify(() -> DurationStyle.detect(""), atLeast(1));
			});
		}
	}
}
