...
class RandomValuePropertySourceSapientGeneratedTest {
	...
	//Sapient generated method id: ${dbfc859f-fd81-3175-baac-e4014845ddae}, hash: 4D240471A53CA00493A29B1DC10309C4
	@Test()
	...
	//Sapient generated method id: ${0f36305b-0097-3cd7-b65c-d72420b2f717}, hash: 4E9D8CCACFCE4842CF7C0AFE8F06BD73
	@Test()
	...
	//Sapient generated method id: ${f65e35f5-8987-3b69-a505-8fc9cd21e135}, hash: D91FF346DB7BE3D391EF84A363BD1A9A
	@Test()
	...
	//Sapient generated method id: ${09c5b2c4-a3dd-37b7-a254-a6c85c44ac03}, hash: 09AEE297FC45AF206370CFC41959030F
	@Disabled()
	@Test()
	void getPropertyWhenRangeIsNotNull() {
		 ...
		 *  A variable could not be isolated or mocked when calling a method - Variable name: first - Method: getAsInt
		 *  Suggestions:
	...
	//Sapient generated method id: ${c3f8f3ae-6ab4-3435-b568-f8708d2d87c9}, hash: C78F8F1BC6BF331F6B6859E9CBD9ABF8
	@Disabled()
	@Test()
	void getPropertyWhenRangeIsNullAndRangeIsNotNull() {
		 ...
		 *
		 * TODO: Help needed! This method is not unit testable!
		 *  A variable could not be isolated or mocked when calling a method - Variable name: first - Method: getAsLong
		 *  Suggestions:
		 *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
		 *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
		 *  The test code, including the assertion statements, has been successfully generated.
	...
	//Sapient generated method id: ${9f897460-478e-39e7-baae-a7f212da7774}, hash: 5C69772F8D9E609F61F6823ADD127C54
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${e2c2da42-b907-3228-a688-d482ea1cf485}, hash: E24FA3DEFD18CAA15D855C9C8E233A40
	@Test()
	...
	//Sapient generated method id: ${f501c243-87af-3b86-af39-384eda5bac28}, hash: 9AC2E5E59C97918E9284E6EDF614DAE4
	@Test()
	...
	//Sapient generated method id: ${f1611580-9925-3d58-8c21-50def6dc3b5f}, hash: 334F414CE7D1E9A49F5E83AB9C0CC6B6
	@Test()
	...
	//Sapient generated method id: ${c19f6f13-17e5-3394-9061-aec3afcbc131}, hash: 8F727D17C0E2F3CE97825444335606CB
	@Test()
	...
	//Sapient generated method id: ${7363f093-0718-3913-ad2f-da425b1f9448}, hash: 5F8D121E0AFF6758B523350245F4E486
	@Test()
