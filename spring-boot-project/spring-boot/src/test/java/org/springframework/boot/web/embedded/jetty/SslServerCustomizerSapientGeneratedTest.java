...
class SslServerCustomizerSapientGeneratedTest {
	...
	//Sapient generated method id: ${82417d83-9c68-3569-950d-e123f9dde7e2}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${430679fd-1dd0-3139-afbb-fa661bc8bf0c}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${cafab7d3-50a6-3de0-a596-e5cb61cade46}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${80d8c8d5-d732-3666-b76e-7d2e7ba39cd3}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${772d5f66-e112-3ed5-8d00-772dfd5f36b6}
	@Test()
	void configureSslWhenKeyGetPasswordIsNotNull() throws Exception {
		...
		doNothing().when(factoryMock).setKeyStore((KeyStore) null);
		doNothing().when(factoryMock).setTrustStore((KeyStore) null);
		InetSocketAddress inetSocketAddress = new InetSocketAddress(0);
		...
		assertAll("result", () -> {
			...
			verify(factoryMock).setKeyStore((KeyStore) null);
			verify(factoryMock).setTrustStore((KeyStore) null);
			verify(sslBundleMock).getKey();
	...
	//Sapient generated method id: ${748661ff-6b39-372a-bdfb-610b43c1f1a9}
	@Test()
	...
	//Sapient generated method id: ${fb4659c7-ccc2-36bd-bc25-02a1e0ba2fd1}
	@Test()
	void configureSslWhenKeyGetPasswordIsNotNullAndCaughtExceptionThrowsIllegalStateException() {
		...
		doThrow(runtimeException).when(factoryMock).setTrustStore((KeyStore) null);
		InetSocketAddress inetSocketAddress = new InetSocketAddress(0);
		SslServerCustomizer target = new SslServerCustomizer(http2Mock, inetSocketAddress, Ssl.ClientAuth.NONE, sslBundleMock);
		doReturn(sslBundleKeyMock).when(sslBundleMock).getKey();
		doReturn("return_of_getAlias1").when(sslBundleKeyMock).getAlias();
	...
	//Sapient generated method id: ${ccfd6a45-452a-32d0-8c5c-be99b5019ca9}
	@Test()
