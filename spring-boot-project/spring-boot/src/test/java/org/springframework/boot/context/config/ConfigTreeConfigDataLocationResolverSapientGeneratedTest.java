...
class ConfigTreeConfigDataLocationResolverSapientGeneratedTest {
    ...
    //Sapient generated method id: ${isResolvableWhenLocationHasPrefixPREFIX}, hash: FFA8071E699FF55FE826CC870D38EAC1
    @Test()
    ...
    //Sapient generated method id: ${isResolvableWhenLocationNotHasPrefixPREFIX}, hash: A047618F7E5592F7B6F74F3DD822FB18
    @Test()
    ...
    //Sapient generated method id: ${resolveWhenThisResourceLoaderNotIsPatternLocation}, hash: 96C8AA9485466CD5D554E0FE13745EC7
    @Test()
    void resolveWhenThisResourceLoaderNotIsPatternLocation() throws IOException {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: resourceLoader - Method: isPattern
         *  Suggestions:
    ...
    //Sapient generated method id: ${resolveWhenCaughtIOExceptionThrowsConfigDataLocationNotFoundException}, hash: B0C930CD329AD84F850DCAFF26854ACB
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${resolveWhenResourcesIsNotEmpty}, hash: F7CAB65A832EAC746BCE931AAE25CCD2
    @Test()
