...
class ConfigTreeConfigDataLocationResolverSapientGeneratedTest {
	...
	//Sapient generated method id: ${6b78cc0f-648f-3dea-82de-b38f68724c0c}
	@Test()
	...
	//Sapient generated method id: ${f3c72092-d023-31e2-895e-c58417003c86}
	@Test()
	...
	//Sapient generated method id: ${2206528a-4a91-39e3-b925-d3b48c4d52da}
	@Test()
	...
	//Sapient generated method id: ${2133bd83-535c-3663-82c2-0c722bb1179c}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${5cd1dbd5-2bcb-30bb-826a-c8ff4c48a577}
	@Disabled()
	@Test()
	void resolveWhenResourcesIsNotEmpty() throws IOException {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
			...
			//Act Statement(s)
			List<ConfigTreeConfigDataResource> result = target.resolve(configDataLocationResolverContextMock, locationMock);
			ConfigTreeConfigDataResource configTreeConfigDataResource = new ConfigTreeConfigDataResource((Path) null);
