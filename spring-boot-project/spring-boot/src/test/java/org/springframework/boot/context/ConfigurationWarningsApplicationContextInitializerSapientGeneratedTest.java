...
class ConfigurationWarningsApplicationContextInitializerSapientGeneratedTest {
    ...
    //Sapient generated method id: ${initializeTest}, hash: CCE7EA77B21DF1BBAACE8D6CBA50A0C5
    @Test()
    void initializeTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${getChecksTest}, hash: 8A45E1F0B01EB671759BEC3B49C5009E
    @Disabled()
    @Test()
    void getChecksTest() {
        //Arrange Statement(s)
