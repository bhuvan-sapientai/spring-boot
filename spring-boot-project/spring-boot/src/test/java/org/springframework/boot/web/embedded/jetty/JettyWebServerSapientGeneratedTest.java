...
class JettyWebServerSapientGeneratedTest {
	...
	//Sapient generated method id: ${9d0d85a2-ccc7-37ef-b425-3e9250cbe5d8}
	@Disabled()
	@Test()
	void startWhenHandlerInstanceOfJettyEmbeddedWebAppContextAndConnectorsIsNotEmpty() throws Exception {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
			...
			doReturn("A").when(target).getStartedLogMessage();
			//Act Statement(s)
			target.start();
			//Assert statement(s)
			assertAll("result", () -> {
	...
	//Sapient generated method id: ${ef92e134-df54-3326-8c55-66de42c3bdc4}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${061e7c9b-fdcb-38ff-b42b-b6ece1d34f73}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${755c441e-bc66-3532-836b-86c32f8a4e66}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${a051686b-3c66-3274-9c32-f33fd193500b}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${a79ad51d-0be1-3759-86ea-a609814feb0b}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${f3c9807a-4cf9-3887-a958-efebfaac257c}
	@Disabled()
	@Test()
	void getStartedLogMessageWhenConnectorInstanceOfNetworkConnectorAndContextPathIsNull() throws Exception {
		...
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class);
			...
			doNothing().when(serverMock).start();
			doNothing().when(serverMock).setStopAtShutdown(false);
			doReturn(JettyReactiveWebServerFactory.class).when(serverMock).getAttribute("org.springframework.boot.web.server.WebServerFactory");
	...
	//Sapient generated method id: ${7491aff6-37d8-31cf-8344-9b6a8ca4c639}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${9daf10c1-c77f-3aa5-a8a9-1f9be7cdcbc1}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${de8f6113-6d6e-3bcf-8ef0-b415d991ccef}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${92fbe07a-7237-30dc-b3d6-b5d53c927180}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${9c86994a-2447-3287-b52c-5cc165a62548}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${32e7fbc6-1d04-3b84-9c0d-e150e7b792e3}
	@Disabled()
	@Test()
