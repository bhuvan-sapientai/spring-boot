...
class ConfigDataPropertiesSapientGeneratedTest {
	...
	//Sapient generated method id: ${c0df80b8-42ee-3e61-b9ff-afe788883f2a}
	@Disabled()
	@Test()
	void withoutImportsWhenDefaultBranch() {
		...
		ConfigDataProperties configDataProperties = new ConfigDataProperties((List) null, activateMock);
		//Assert statement(s)
		//TODO: Please implement equals method in ConfigDataProperties for verification to succeed or you need to adjust respective assertion statements
		assertAll("result", () -> assertThat(result, equalTo(configDataProperties)));
	}
