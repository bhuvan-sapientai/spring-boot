...
class WebServerFactoryCustomizerBeanPostProcessorSapientGeneratedTest {
	...
	//Sapient generated method id: ${6a498d31-c29e-3164-874e-02924a8e16ac}, hash: D92246651BD9AC12CA098D1FD2144AB8
	@Test()
	...
	//Sapient generated method id: ${e29ea687-fb8b-3297-b227-c0457c272674}, hash: B36F18B9C170061DA02F5B30E30AF080
	@Test()
	void postProcessBeforeInitializationWhenThisCustomizersIsNull() throws BeansException {
		...
		try (MockedStatic<LambdaSafe> lambdaSafe = mockStatic(LambdaSafe.class)) {
			...
			lambdaSafe.when(() -> LambdaSafe.callbacks(eq(WebServerFactoryCustomizer.class), anyList(), eq(webServerFactoryMock), eq(objectArray))).thenReturn(lambdaSafeCallbacksMock);
			...
			//Act Statement(s)
			Object result = target.postProcessBeforeInitialization((Object) webServerFactoryMock, "<String object>");
			//Assert statement(s)
			assertAll("result", () -> {
				assertThat(result, equalTo(webServerFactoryMock));
				lambdaSafe.verify(() -> LambdaSafe.callbacks(eq(WebServerFactoryCustomizer.class), anyList(), eq(webServerFactoryMock), eq(objectArray)));
	...
	//Sapient generated method id: ${4cfb5025-dae0-38fb-9400-154ec4849360}, hash: 9F5DB12167273F3459D55AD5BE59AA15
	@Test()
