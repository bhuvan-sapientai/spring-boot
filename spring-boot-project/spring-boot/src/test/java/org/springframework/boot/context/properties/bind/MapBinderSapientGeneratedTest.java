...
class MapBinderSapientGeneratedTest {
	...
	//Sapient generated method id: ${0429d3b4-4624-32a1-a21f-c785100948e3}, hash: 4407920893FD3E37ADADFCCF80F21333
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${cfe7afa0-41c8-3000-b925-7b367a552635}, hash: D646ABF65AC49014FAD2938E68E7DECC
	@Disabled()
	@Test()
	void bindAggregateWhenNotHasDescendants() {
		...
		try (MockedStatic<CollectionFactory> collectionFactory = mockStatic(CollectionFactory.class)) {
			...
			doReturn(iterableMock, iterableMock2).when(binderContextMock).getSources();
			doReturn(null).when(iterableMock2).iterator();
			Object object = new Object();
	...
	//Sapient generated method id: ${00271470-6796-3b1a-b8b6-61156b9f56df}, hash: 37B12793E116DBEECD2C097A7D707048
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${27ad051d-497e-338e-959d-4de0373f3c6e}, hash: 7AB66EC9A3E66D7A106314D94FA9A8DD
	@Disabled()
	@Test()
