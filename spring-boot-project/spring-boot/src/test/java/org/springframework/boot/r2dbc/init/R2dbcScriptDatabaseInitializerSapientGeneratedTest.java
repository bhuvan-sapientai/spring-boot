...
class R2dbcScriptDatabaseInitializerSapientGeneratedTest {
	...
	//Sapient generated method id: ${ddbe6df9-9428-315b-a3ae-683d2029e938}, hash: C377F851AFD520450DE69DB59035ED14
	@Test()
	...
	//Sapient generated method id: ${4b1cdd9a-a906-311d-add0-50a8d73c0f7f}, hash: A5E9217F0991DEEFBEFFCBE853FE617C
	@Test()
	...
	//Sapient generated method id: ${e671421d-552d-3332-a502-0d59d8dd0620}, hash: 5702B7100976F1336D4D73BD034BDBEE
	@Disabled()
	@Test()
	void runScripts1WhenScriptsIsNotEmpty() {
		 ...
		 *  Following variables could not be isolated/mocked: object of type Mono, populator
		 *  Suggestions:
		...
		doReturn(charset, charset2).when(scriptsMock).getEncoding();
