...
class ConfigDataEnvironmentContributorsSapientGeneratedTest {
	...
	private final ConfigDataActivationContext configDataActivationContextMock = mock(ConfigDataActivationContext.class, "ConfigDataActivationContext");
	...
	private final ConfigDataImporter configDataImporterMock = mock(ConfigDataImporter.class, "ConfigDataImporter");
	...
	//Sapient generated method id: ${1842d923-3302-3abb-a58b-96aa63c0ab22}, hash: EFB00AFF7CA4072EB5537FBE2EB0DCF8
	@Test()
	void withProcessedImportsWhenContributorsGetRootIsEmptyAndContributorIsNull() {
		...
		ConfigurableBootstrapContext configurableBootstrapContextMock = mock(ConfigurableBootstrapContext.class, "ConfigurableBootstrapContext");
		try (MockedStatic<LogMessage> logMessage = mockStatic(LogMessage.class);
			...
			LogMessage logMessage3 = LogMessage.format("Processed imports for of %d contributors", 0);
			logMessage.when(() -> LogMessage.format("Processed imports for of %d contributors", 0)).thenReturn(logMessage3);
			...
			assertAll("result", () -> {
				...
				logMessage.verify(() -> LogMessage.format("Processed imports for of %d contributors", 0), atLeast(1));
			});
		}
	}

	//Sapient generated method id: ${7902a050-55f2-3bd2-87f0-3e12fcbe7266}, hash: F3C373559495E264369DB83292ABB0C2
	@Test()
	void withProcessedImportsWhenContributorNotHasUnprocessedImportsImportPhaseAndIsActiveWithUnprocessedImportsNotActivationCon() {
		...
		try (MockedStatic<LogMessage> logMessage = mockStatic(LogMessage.class, CALLS_REAL_METHODS);
			...
			LogMessage logMessage2 = LogMessage.format("Processed imports for of %d contributors", 0);
			logMessage.when(() -> LogMessage.format("Processed imports for of %d contributors", 0)).thenReturn(logMessage2);
			List<ConfigDataEnvironmentContributor> configDataEnvironmentContributorList = new ArrayList<>();
			ConfigDataEnvironmentContributors target = new ConfigDataEnvironmentContributors(logFactoryMock, configurableBootstrapContextMock, configDataEnvironmentContributorList);
			//Act Statement(s)
	...
	//Sapient generated method id: ${75f58abd-955f-3a73-8bad-89c5b631cdff}, hash: 8451E823E5982EC6DA029A9A1C490F30
	@Test()
	void withProcessedImportsWhenDataGetPropertySourcesIsEmpty() {
		 ...
		 */
		//Arrange Statement(s)
		ConfigDataImporter importerMock = mock(ConfigDataImporter.class);
		ConfigDataActivationContext configDataActivationContextMock = mock(ConfigDataActivationContext.class);
	...
	//Sapient generated method id: ${0813946b-1918-3824-85f7-5653ed308975}, hash: C0A126D380D3698DE673CA44D94B1244
	@Test()
	void withProcessedImportsWhenIGreaterThanOrEqualsTo0() {
		 ...
		 */
		//Arrange Statement(s)
		ConfigDataImporter importerMock = mock(ConfigDataImporter.class, "ConfigDataImporter");
		PropertySource<?> propertySourceMock = mock(PropertySource.class);
		ConfigDataResolutionResult configDataResolutionResultMock2 = mock(ConfigDataResolutionResult.class);
		ConfigData configDataMock2 = mock(ConfigData.class);
		ConfigDataLocation configDataLocationMock2 = mock(ConfigDataLocation.class);
		ConfigDataResource configDataResourceMock2 = mock(ConfigDataResource.class);
		PropertySource<?> propertySourceMock2 = mock(PropertySource.class);
		ConfigDataResolutionResult configDataResolutionResultMock3 = mock(ConfigDataResolutionResult.class);
		ConfigData configDataMock3 = mock(ConfigData.class);
		ConfigDataLocation configDataLocationMock3 = mock(ConfigDataLocation.class);
		ConfigDataResource configDataResourceMock3 = mock(ConfigDataResource.class);
		PropertySource<?> propertySourceMock3 = mock(PropertySource.class);
		DeferredLogFactory logFactoryMock = mock(DeferredLogFactory.class, "DeferredLogFactory");
		LogMessage logMessageMock4 = mock(LogMessage.class);
		LogMessage logMessageMock5 = mock(LogMessage.class);
		LogMessage logMessageMock6 = mock(LogMessage.class);
		LogMessage logMessageMock7 = mock(LogMessage.class);
		ConfigDataEnvironmentContributor configDataEnvironmentContributorMock2 = mock(ConfigDataEnvironmentContributor.class);
		LogMessage logMessageMock8 = mock(LogMessage.class);
		LogMessage logMessageMock9 = mock(LogMessage.class);
		ConfigDataEnvironmentContributor configDataEnvironmentContributorMock3 = mock(ConfigDataEnvironmentContributor.class);
		ConfigurableBootstrapContext configurableBootstrapContextMock = mock(ConfigurableBootstrapContext.class, "ConfigurableBootstrapContext");
		try (MockedStatic<ConfigDataEnvironmentContributor> configDataEnvironmentContributor = mockStatic(ConfigDataEnvironmentContributor.class);
			 MockedStatic<LogMessage> logMessage = mockStatic(LogMessage.class);
			 MockedStatic<ConfigDataEnvironmentContributor.ImportPhase> configDataEnvironmentContributorImportPhase = mockStatic(ConfigDataEnvironmentContributor.ImportPhase.class, CALLS_REAL_METHODS)) {
			...
			List<ConfigDataLocation> configDataLocationList = new ArrayList<>();
			doReturn(configDataResolutionResultConfigDataMap).when(importerMock).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList));
			Map<ConfigDataResolutionResult, ConfigData> configDataResolutionResultConfigDataMap2 = new HashMap<>();
			configDataResolutionResultConfigDataMap2.put(configDataResolutionResultMock, configDataMock);
			List<ConfigDataLocation> configDataLocationList2 = new ArrayList<>();
			doReturn(configDataResolutionResultConfigDataMap2).when(importerMock).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList2));
			doReturn(configDataLocationMock).when(configDataResolutionResultMock).getLocation();
			doReturn(configDataResourceMock).when(configDataResolutionResultMock).getResource();
			doReturn(false).when(configDataResolutionResultMock).isProfileSpecific();
			List<PropertySource<?>> anyList = new ArrayList<>();
			...
			doReturn(anyList).when(configDataMock).getPropertySources();
			Map<ConfigDataResolutionResult, ConfigData> configDataResolutionResultConfigDataMap3 = new HashMap<>();
			configDataResolutionResultConfigDataMap3.put(configDataResolutionResultMock2, configDataMock2);
			List<ConfigDataLocation> configDataLocationList3 = new ArrayList<>();
			doReturn(configDataResolutionResultConfigDataMap3).when(importerMock).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList3));
			doReturn(configDataLocationMock2).when(configDataResolutionResultMock2).getLocation();
			doReturn(configDataResourceMock2).when(configDataResolutionResultMock2).getResource();
			doReturn(false).when(configDataResolutionResultMock2).isProfileSpecific();
			List<PropertySource<?>> anyList2 = new ArrayList<>();
			anyList2.add(propertySourceMock2);
			doReturn(anyList2).when(configDataMock2).getPropertySources();
			Map<ConfigDataResolutionResult, ConfigData> configDataResolutionResultConfigDataMap4 = new HashMap<>();
			configDataResolutionResultConfigDataMap4.put(configDataResolutionResultMock3, configDataMock3);
			List<ConfigDataLocation> configDataLocationList4 = new ArrayList<>();
			doReturn(configDataResolutionResultConfigDataMap4).when(importerMock).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList4));
			doReturn(configDataLocationMock3).when(configDataResolutionResultMock3).getLocation();
			doReturn(configDataResourceMock3).when(configDataResolutionResultMock3).getResource();
			doReturn(false).when(configDataResolutionResultMock3).isProfileSpecific();
			List<PropertySource<?>> anyList3 = new ArrayList<>();
			anyList3.add(propertySourceMock3);
			doReturn(anyList3).when(configDataMock3).getPropertySources();
			NoOpLog noOpLog = new NoOpLog();
			doReturn(noOpLog).when(logFactoryMock).getLog(ConfigDataEnvironmentContributors.class);
			configDataEnvironmentContributor.when(() -> ConfigDataEnvironmentContributor.of(anyList())).thenReturn(rootMock);
			configDataEnvironmentContributorImportPhase.when(() -> ConfigDataEnvironmentContributor.ImportPhase.get(configDataActivationContextMock)).thenReturn(ConfigDataEnvironmentContributor.ImportPhase.BEFORE_PROFILE_ACTIVATION);
			...
			configDataEnvironmentContributor.when(() -> ConfigDataEnvironmentContributor.ofUnboundImport(configDataLocationMock2, configDataResourceMock2, false, configDataMock2, 0)).thenReturn(configDataEnvironmentContributorMock2);
			logMessage.when(() -> LogMessage.format(eq("Processing imports %s"), anyList())).thenReturn(logMessageMock2).thenReturn(logMessageMock4).thenReturn(logMessageMock6).thenReturn(logMessageMock8);
			logMessage.when(() -> LogMessage.of((Supplier) any())).thenReturn(logMessageMock3).thenReturn(logMessageMock5).thenReturn(logMessageMock7).thenReturn(logMessageMock9);
			configDataEnvironmentContributor.when(() -> ConfigDataEnvironmentContributor.ofUnboundImport(configDataLocationMock3, configDataResourceMock3, false, configDataMock3, 0)).thenReturn(configDataEnvironmentContributorMock3);
			List<ConfigDataEnvironmentContributor> configDataEnvironmentContributorList = new ArrayList<>();
			ConfigDataEnvironmentContributors target = new ConfigDataEnvironmentContributors(logFactoryMock, configurableBootstrapContextMock, configDataEnvironmentContributorList);
			//Act Statement(s)
			final NullPointerException result = assertThrows(NullPointerException.class, () -> {
				target.withProcessedImports(importerMock, configDataActivationContextMock);
			});
			//Assert statement(s)
			assertAll("result", () -> {
				assertThat(result, is(notNullValue()));
				verify(importerMock, atLeast(1)).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList));
				verify(importerMock, atLeast(1)).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList2));
				verify(configDataResolutionResultMock, atLeast(1)).getLocation();
				verify(configDataResolutionResultMock, atLeast(1)).getResource();
				verify(configDataResolutionResultMock, atLeast(1)).isProfileSpecific();
				verify(configDataMock, times(2)).getPropertySources();
				verify(importerMock, atLeast(1)).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList3));
				verify(configDataResolutionResultMock2, atLeast(1)).getLocation();
				verify(configDataResolutionResultMock2, atLeast(1)).getResource();
				verify(configDataResolutionResultMock2, atLeast(1)).isProfileSpecific();
				verify(configDataMock2, times(2)).getPropertySources();
				verify(importerMock, atLeast(1)).resolveAndLoad(eq(configDataActivationContextMock), (ConfigDataLocationResolverContext) any(), (ConfigDataLoaderContext) any(), eq(configDataLocationList4));
				verify(configDataResolutionResultMock3, atLeast(1)).getLocation();
				verify(configDataResolutionResultMock3, atLeast(1)).getResource();
				verify(configDataResolutionResultMock3, atLeast(1)).isProfileSpecific();
				verify(configDataMock3, times(2)).getPropertySources();
				verify(logFactoryMock, atLeast(1)).getLog(ConfigDataEnvironmentContributors.class);
				configDataEnvironmentContributor.verify(() -> ConfigDataEnvironmentContributor.of(anyList()), atLeast(1));
				configDataEnvironmentContributorImportPhase.verify(() -> ConfigDataEnvironmentContributor.ImportPhase.get(configDataActivationContextMock), atLeast(1));
				logMessage.verify(() -> LogMessage.format("Processing imports for phase %s. %s", ConfigDataEnvironmentContributor.ImportPhase.BEFORE_PROFILE_ACTIVATION, configDataActivationContextMock), atLeast(1));
				logMessage.verify(() -> LogMessage.format(eq("Processing imports %s"), anyList()), atLeast(4));
				logMessage.verify(() -> LogMessage.of((Supplier) any()), atLeast(4));
				...
				configDataEnvironmentContributor.verify(() -> ConfigDataEnvironmentContributor.ofUnboundImport(configDataLocationMock2, configDataResourceMock2, false, configDataMock2, 0), atLeast(1));
				configDataEnvironmentContributor.verify(() -> ConfigDataEnvironmentContributor.ofUnboundImport(configDataLocationMock3, configDataResourceMock3, false, configDataMock3, 0), atLeast(1));
			});
		}
	}

	//Sapient generated method id: ${27f159bb-8759-38a1-9961-779599d3b712}, hash: 13362568E696197EED73B6809F37E0F0
	@Test()
	void getBinderTest() {
		//Arrange Statement(s)
