...
class ConfigDataEnvironmentContributorsSapientGeneratedTest {
    ...
    //Sapient generated method id: ${withProcessedImportsWhenContributorsGetRootIsEmptyAndContributorIsNull}, hash: DDFC56F51561BCA35B47AB30F5F7B8D4
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${withProcessedImportsWhenContributorNotHasUnprocessedImportsImportPhaseAndIsActiveWithUnprocessedImportsNotActivationCon}, hash: C2F7610CACB9ADB3D22296288F3738D0
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${withProcessedImportsWhenDataGetPropertySourcesIsEmpty}, hash: 5167846305770EC2BDA27FFDD8D126E4
    @Disabled()
    @Test()
    void withProcessedImportsWhenDataGetPropertySourcesIsEmpty() {
         ...
         *  A variable could not be isolated/mocked when calling a method - Variable name: contributors - Method: getRoot
         *  Suggestions:
    ...
    //Sapient generated method id: ${withProcessedImportsWhenIGreaterThanOrEqualsTo0}, hash: 4D2DDD7CD87BA19205D9A39FD5FCC908
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${getBinderTest}, hash: BC9824B0767788693335483E442ACCE3
    @Disabled()
    @Test()
    void getBinderTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${iteratorTest}, hash: 8C1A592AA051C2C1D27ECB4D0982DFEB
    @Test()
    void iteratorTest() {
        //Arrange Statement(s)
        try (MockedStatic<ConfigDataEnvironmentContributor> configDataEnvironmentContributor = mockStatic(ConfigDataEnvironmentContributor.class)) {
            ...
            Iterator<ConfigDataEnvironmentContributor> iterator = configDataEnvironmentContributorList2.iterator();
            doReturn(iterator).when(rootMock).iterator();
            //Act Statement(s)
