...
class UnboundConfigurationPropertyFailureAnalyzerSapientGeneratedTest {
	...
	//Sapient generated method id: ${7f6bbcb3-974f-343f-9bb9-8f49d6ecf1d0}, hash: 69A0CBA777F1F8CBDF35BA963F663475
	@Test()
	void analyze2WhenPropertyIsNotNull() {
		...
		UnboundConfigurationPropertiesException exceptionMock = mock(UnboundConfigurationPropertiesException.class, "UnboundConfigurationPropertiesException");
		...
		doReturn(null).when(exceptionMock).getMessage();
		UnboundConfigurationPropertyFailureAnalyzer target = new UnboundConfigurationPropertyFailureAnalyzer();
