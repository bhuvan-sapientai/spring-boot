...
class LocationResourceLoaderSapientGeneratedTest {
	...
	//Sapient generated method id: ${c28e5654-5ba5-3b52-8f1e-d2ad6c16acd1}, hash: 4DDBC947C2128497DA56C838DEBBD66D
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${c1b693f1-34f8-3d72-bd2b-3b62fd974ef6}, hash: 0568AAE1CAF77AA2A4B4515CAE07817D
	@Disabled()
	@Test()
	void getResourcesWhenFileNotIsDirectory() throws Exception {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class);
			...
			_assert.when(() -> Assert.state(eq(false), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
			_assert.when(() -> Assert.state(eq(true), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
			stringUtils.when(() -> StringUtils.countOccurrencesOf("/path/to/location", "*")).thenReturn(1);
			LocationResourceLoader target = spy(new LocationResourceLoader(resourceLoaderMock));
			doReturn(false).when(target).isPattern("/path/to/location");
			doReturn(resourceMock).when(target).getResource("location1");
			...
			//Act Statement(s)
			Resource[] result = target.getResources("/path/to/location", LocationResourceLoader.ResourceType.FILE);
			//Assert statement(s)
			assertAll("result", () -> {
				assertThat(result.length, equalTo(0));
				_assert.verify(() -> Assert.state(eq(false), (Supplier) any()), atLeast(2));
				_assert.verify(() -> Assert.state(eq(true), (Supplier) any()), atLeast(2));
				stringUtils.verify(() -> StringUtils.countOccurrencesOf("/path/to/location", "*"), atLeast(1));
				verify(target).isPattern("/path/to/location");
				verify(target).getResource("location1");
				verify(resourceMock).exists();
	...
	//Sapient generated method id: ${a41bc3f0-2539-3a56-a37e-d782818a8147}, hash: 92A15D33B2BFA0CEAD454262614BA49D
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${076466f3-9a12-3676-b97e-4635a34498f4}, hash: 11FC399D75883F4F6B6D53F8D92B28F8
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${607a0ead-fc76-38f5-b6fc-16d5d642ea93}, hash: 30210AF6AD64522C19E2C5D23898BFDE
	@Disabled()
	@Test()
