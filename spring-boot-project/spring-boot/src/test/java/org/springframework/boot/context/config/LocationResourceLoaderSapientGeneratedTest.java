...
class LocationResourceLoaderSapientGeneratedTest {
    ...
    //Sapient generated method id: ${isPatternWhenLocationContains_}, hash: 179E372E5FC2A93CDF3BB8A9D64BB639
    @Test()
    ...
    //Sapient generated method id: ${isPatternWhenLocationNotContains_}, hash: 885F2F3721AC8825C49707BD3389E300
    @Test()
    ...
    //Sapient generated method id: ${getResourceWhenResourceUtilsNotIsUrlLocation}, hash: B169D9DA37FC09F29B563FD62E322ED2
    @Test()
    ...
    //Sapient generated method id: ${getResourceWhenIsPatternLocationAndResourceUtilsIsUrlLocation}, hash: 2F3BD165BC0A3DD78111E429650CFB83
    @Test()
    ...
    //Sapient generated method id: ${getResourcesWhenResourceNotExists}, hash: 4DDBC947C2128497DA56C838DEBBD66D
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${getResourcesWhenFileNotIsDirectory}, hash: 11A17530303AD108A185A210FEDC835A
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${getResourcesWhenCaughtExceptionThrowsIllegalStateException}, hash: 63F08BD7A65F9F7C7011882EFE7A2232
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${getResourcesWhenSubDirectoriesIsNotNullAndTypeEqualsResourceTypeDIRECTORY}, hash: 92A15D33B2BFA0CEAD454262614BA49D
    @Disabled()
    @Test()
    void getResourcesWhenSubDirectoriesIsNotNullAndTypeEqualsResourceTypeDIRECTORY() throws Exception {
        /* Branches:
         * (!location.startsWith(ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX)) : true  #  inside validatePattern method
        ...
        try (MockedStatic<Assert> _assert = mockStatic(Assert.class);
            ...
            _assert.when(() -> Assert.state(eq(false), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
            _assert.when(() -> Assert.state(eq(true), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
            stringUtils.when(() -> StringUtils.countOccurrencesOf("location1", "*")).thenReturn(0);
            LocationResourceLoader target = spy(new LocationResourceLoader(resourceLoaderMock));
            doReturn(false).when(target).isPattern("location1");
            doReturn(resourceMock).when(target).getResource("location1");
            doReturn(false).when(resourceMock).exists();
            ...
            assertAll("result", () -> {
                ...
                _assert.verify(() -> Assert.state(eq(true), (Supplier) any()));
                stringUtils.verify(() -> StringUtils.countOccurrencesOf("location1", "*"), atLeast(1));
                verify(target).isPattern("location1");
                verify(target).getResource("location1");
                verify(resourceMock).exists();
                verify(resourceMock).getFile();
    ...
    //Sapient generated method id: ${getResourcesWhenTypeNotEqualsResourceTypeDIRECTORYAndSubDirectoriesIsEmpty}, hash: 11FC399D75883F4F6B6D53F8D92B28F8
    @Disabled()
    @Test()
    void getResourcesWhenTypeNotEqualsResourceTypeDIRECTORYAndSubDirectoriesIsEmpty() throws Exception {
        /* Branches:
    ...
    //Sapient generated method id: ${getResourcesWhenFilesIsNotNull}, hash: 30210AF6AD64522C19E2C5D23898BFDE
    @Disabled()
    @Test()
