...
class WebFilterHandlerSapientGeneratedTest {
	...
	//Sapient generated method id: ${241a8e22-f94a-3193-81dc-e6ec914bdcd6}, hash: F9171CD1A2C8F7224F4C5ABDBED0E867
	@Test()
	...
	//Sapient generated method id: ${6d7d47bc-f5bd-3e35-b530-31069f274b1f}, hash: F74B3E81C47E239173A4C902E692FBE0
	@Test()
	...
	//Sapient generated method id: ${17009f6a-25ca-3d0d-be2f-9bb303c07355}, hash: C3669F49B666BDD18B67E42C44DD7F65
	@Test()
	void doHandleWhenDispatcherTypesLengthNotEquals1AndStringUtilsNotHasTextAttributesGetFilterName() throws BeanDefinitionStoreException {
		...
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class);
			...
			WebFilterHandler target = spy(new WebFilterHandler());
			DispatcherType[] dispatcherTypeArray = new DispatcherType[] { DispatcherType.FORWARD, DispatcherType.FORWARD };
			Map<String, Object> stringObjectMap = new HashMap<>();
