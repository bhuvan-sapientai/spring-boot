...
class LazyInitializationBeanFactoryPostProcessorSapientGeneratedTest {
    ...
    //Sapient generated method id: ${postProcessBeanFactoryWhenLazyInitIsNotNull}, hash: 6959CD47F5CA4E366D758636E525C6AE
    @Test()
    ...
    //Sapient generated method id: ${postProcessBeanFactoryWhenBeanTypeIsNullAndIsExcludedNotFiltersBeanNameBeanDefinitionBeanType}, hash: E79F4C88C2942226D950FD8C1D243F5A
    @Test()
    ...
    //Sapient generated method id: ${postProcessBeanFactoryWhenIsExcludedFiltersBeanNameBeanDefinitionBeanType}, hash: FD4449796E605A9CDD2B0DF4C048D171
    @Test()
    void postProcessBeanFactoryWhenIsExcludedFiltersBeanNameBeanDefinitionBeanType() throws BeansException, NoSuchBeanDefinitionException {
        ...
        try (MockedStatic<LazyInitializationExcludeFilter> lazyInitializationExcludeFilter = mockStatic(LazyInitializationExcludeFilter.class)) {
            ...
            Class<SmartInitializingSingleton>[] classArray = new Class[] { SmartInitializingSingleton.class };
    ...
    //Sapient generated method id: ${postProcessBeanFactoryWhenFilterNotIsExcludedBeanNameBeanDefinitionBeanTypeAndIsExcludedNotFiltersBeanNameBeanDefinitio}, hash: 0A402E72FF0DE4C8B4B516D3C1F90272
    @Test()
