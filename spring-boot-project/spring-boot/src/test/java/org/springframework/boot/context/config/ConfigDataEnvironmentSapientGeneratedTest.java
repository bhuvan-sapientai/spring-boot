...
class ConfigDataEnvironmentSapientGeneratedTest {
	...
	private final NoOpLog loggerMock = mock(NoOpLog.class, "Log");
	...
	//Sapient generated method id: ${1627c4eb-7a5a-372b-bb70-2c07cb2b6d35}, hash: 1E743E119C5AA30A2FE43A8DCBBF73F5
	@Disabled()
	@Test()
	void createConfigDataLocationResolversTest() {
		...
		try (MockedStatic<SpringFactoriesLoader> springFactoriesLoader = mockStatic(SpringFactoriesLoader.class);
			...
			doReturn(loggerMock).when(logFactoryMock).getLog(ConfigDataEnvironment.class);
			...
			doNothing().when(loggerMock).trace("Building config data environment contributors");
			...
			doNothing().when(loggerMock).trace(logMessageMock);
			doNothing().when(loggerMock).trace(logMessageMock2);
			doNothing().when(loggerMock).trace(logMessageMock3);
			doNothing().when(loggerMock).trace(logMessageMock4);
			//Act Statement(s)
			...
			assertAll("result", () -> {
				...
				verify(loggerMock).trace("Building config data environment contributors");
				...
				verify(loggerMock).trace(logMessageMock);
				verify(loggerMock).trace(logMessageMock2);
				verify(loggerMock).trace(logMessageMock3);
				verify(loggerMock).trace(logMessageMock4);
			});
		}
	}

	//Sapient generated method id: ${820d0286-666f-3e3b-92fa-bf3f3f80f7fc}, hash: BD75C72A987791F8DF7689A43F4DD95D
	@Disabled()
	@Test()
	...
	void processAndApplyWhenExGetCauseInstanceOfInactiveConfigDataAccessExceptionThrowsInactiveConfigDataAccessException() {
		 ...
		 *  Following variables could not be isolated/mocked: contributors
		 *  Suggestions:
	...
	//Sapient generated method id: ${a9681f80-592e-3df6-b206-577ffa348f90}, hash: 2156B472040FA51CFAE720C3BF3F61AF
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${87c76203-0888-3b2f-8e34-ac53d19d22e9}, hash: 372F65482778C2AFDF58F820A68DAA01
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${abacdc5c-08db-310f-ae50-32be1716fe75}, hash: 9E597749E68582DB2EEFC05DF2DBA7C4
	@Disabled()
	@Test()
	void processAndApplyWhenContributorNotIsActiveActivationContext() {
		 ...
		 *
		 * TODO: Help needed! This method is not unit testable!
		 *  Following variables could not be isolated/mocked: importer, contributors
		 *  Suggestions:
		 *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
		 *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
		 *  The test code, including the assertion statements, has been successfully generated.
	...
	//Sapient generated method id: ${afb95b61-a7c6-39e1-807f-36b28ddfab0c}, hash: F6BBD19E82CB64D1C96E5EEF52BE70E0
	@Disabled()
	@Test()
