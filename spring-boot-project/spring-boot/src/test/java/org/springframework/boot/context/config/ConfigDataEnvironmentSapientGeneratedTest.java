...
class ConfigDataEnvironmentSapientGeneratedTest {
	...
	private final Bindable<ConfigDataLocation[]> bindableMock = mock(Bindable.class);
	...
	private final ConfigDataLocation configDataLocation2Mock = mock(ConfigDataLocation.class);

	private final ConfigDataLocation configDataLocation2Mock2 = mock(ConfigDataLocation.class);
	...
	private final ConfigDataLocation configDataLocationMock4 = mock(ConfigDataLocation.class);

	private final ConfigDataLocation configDataLocationMock5 = mock(ConfigDataLocation.class);
	...
	//Sapient generated method id: ${1627c4eb-7a5a-372b-bb70-2c07cb2b6d35}, hash: 5D6754A8D1C6CEF6BA0FA1BF08A47169
	@Disabled()
	@Test()
	void createConfigDataLocationResolversTest() {
		...
		try (MockedStatic<SpringFactoriesLoader> springFactoriesLoader = mockStatic(SpringFactoriesLoader.class);
			...
			doReturn(bindResultMock2).when(binderMock).bind("spring.config.import", bindableMock);
			...
			doReturn(bindResultMock3).when(binderMock).bind("spring.config.additional-location", bindableMock);
			...
			doReturn(bindResultMock4).when(binderMock).bind("spring.config.location", bindableMock);
			...
			ConfigDataLocation[] configDataLocationArray5 = new ConfigDataLocation[] { configDataLocation2Mock, configDataLocation2Mock2 };
			...
			SpringFactoriesLoader springFactoriesLoader2 = SpringFactoriesLoader.forDefaultResourceLocation();
			...
			assertAll("result", () -> {
				...
				verify(binderMock, atLeast(1)).bind("spring.config.import", bindableMock);
				verify(bindResultMock2).orElse(configDataLocationArray2);
				verify(binderMock, atLeast(1)).bind("spring.config.additional-location", bindableMock);
				verify(bindResultMock3).orElse(configDataLocationArray2);
				verify(binderMock, atLeast(1)).bind("spring.config.location", bindableMock);
	...
	//Sapient generated method id: ${820d0286-666f-3e3b-92fa-bf3f3f80f7fc}, hash: E946A0E454B2F7C6701DE507534A8661
	@Disabled()
	@Test()
	void createContributors1Test() {
		...
		try (MockedStatic<ConfigDataEnvironmentContributor> configDataEnvironmentContributor = mockStatic(ConfigDataEnvironmentContributor.class);
			...
			assertAll("result", () -> {
				...
				verify(bindResultMock).orElse(ConfigDataNotFoundAction.FAIL);
				verify(binderMock).bind("spring.config.import", bindableMock);
				verify(bindResultMock2).orElse(configDataLocationArray2);
				verify(binderMock).bind("spring.config.additional-location", bindableMock);
				verify(bindResultMock3).orElse(configDataLocationArray2);
				verify(binderMock).bind("spring.config.location", bindableMock);
				verify(bindResultMock4).orElse(configDataLocationArray5);
	...
	//Sapient generated method id: ${24ffa5f9-670a-39b3-b8fc-e7297e50797f}, hash: CD12644FF82C8B83BA4310A43D01F2D0
	@Disabled()
	@Test()
	void processAndApplyWhenExGetCauseInstanceOfInactiveConfigDataAccessExceptionThrowsInactiveConfigDataAccessException() {
		...
		try (MockedStatic<BootstrapRegistry.InstanceSupplier> bootstrapRegistryInstanceSupplier = mockStatic(BootstrapRegistry.InstanceSupplier.class);
			...
			ConfigDataLocation[] configDataLocationArray5 = new ConfigDataLocation[] { configDataLocationMock4, configDataLocationMock5 };
			doReturn(configDataLocationArray4).when(bindResultMock4).orElse(configDataLocationArray5);
	...
	//Sapient generated method id: ${a9681f80-592e-3df6-b206-577ffa348f90}, hash: A047682D7D8231E0B21CB455A611ECA2
	@Test()
	...
	//Sapient generated method id: ${11f3c4b5-9aa8-3339-bdde-3e8219e8bfbd}, hash: AD763DD4B7C32FFE53FD5C069637D088
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${87c76203-0888-3b2f-8e34-ac53d19d22e9}, hash: 997C34A25BA58EB1A54EFB72F3D9AE2B
	@Test()
	...
	//Sapient generated method id: ${abacdc5c-08db-310f-ae50-32be1716fe75}, hash: 3E9232011C063EC866AA7B6F307BCA8E
	@Disabled()
	@Test()
	void processAndApplyWhenContributorNotIsActiveActivationContext() {
		...
		ConfigDataEnvironmentContributor configDataEnvironmentContributorMock = mock(ConfigDataEnvironmentContributor.class, "ConfigDataEnvironmentContributor");
		ConfigDataEnvironmentContributor configDataEnvironmentContributorMock4 = mock(ConfigDataEnvironmentContributor.class, "ConfigDataEnvironmentContributor");
		LogMessage logMessageMock7 = mock(LogMessage.class, "LogMessage");
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class);
			...
			logMessage.when(() -> LogMessage.format("Skipping inactive property source '%s'", "name1")).thenReturn(logMessageMock5);
			MutablePropertySources mutablePropertySources = new MutablePropertySources();
			defaultPropertiesPropertySource.when(() -> DefaultPropertiesPropertySource.moveToEnd(mutablePropertySources)).thenAnswer((Answer<Void>) invocation -> null);
			logMessage.when(() -> LogMessage.format(eq("Setting default profiles: %s"), anyList())).thenReturn(logMessageMock6);
			String[] stringArray = new String[] {};
			logMessage.when(() -> LogMessage.format(eq("Setting active profiles: %s"), anyList())).thenReturn(logMessageMock7);
			String[] stringArray2 = new String[] {};
			stringUtils.when(() -> StringUtils.toStringArray(anyList())).thenReturn(stringArray).thenReturn(stringArray2);
			Collection<String> collection = new ArrayList<>();
			collection.add("Collection<String>");
			ConfigDataEnvironment target = new ConfigDataEnvironment(logFactoryMock, bootstrapContextMock, environmentMock, resourceLoaderMock, collection, environmentUpdateListenerMock);
			doReturn(0).when(mutablePropertySourcesMock).size();
			doReturn(null).when(mutablePropertySourcesMock).iterator();
			doNothing().when(bootstrapContextMock).register(Binder.class, bootstrapRegistryInstanceSupplierMock2);
			doNothing().when(bootstrapContextMock).register(Binder.class, bootstrapRegistryInstanceSupplierMock4);
			doNothing().when(bootstrapContextMock).register(Binder.class, bootstrapRegistryInstanceSupplierMock6);
			doNothing().when(bootstrapContextMock).register(Binder.class, bootstrapRegistryInstanceSupplierMock8);
			doReturn(mutablePropertySourcesMock, mutablePropertySources).when(environmentMock).getPropertySources();
			...
			assertAll("result", () -> {
				...
				defaultPropertiesPropertySource.verify(() -> DefaultPropertiesPropertySource.moveToEnd(mutablePropertySources), atLeast(1));
	...
	//Sapient generated method id: ${afb95b61-a7c6-39e1-807f-36b28ddfab0c}, hash: 0185434B81BB9355D65ACD436872E9F4
	@Disabled()
	@Test()
	void processAndApplyWhenContributorIsActiveActivationContext() {
		...
		ConfigDataLocation configDataLocationMock6 = mock(ConfigDataLocation.class);
		...
		try (MockedStatic<StringUtils> stringUtils = mockStatic(StringUtils.class);
			...
			ConfigDataLocation[] configDataLocationArray5 = new ConfigDataLocation[] { configDataLocationMock, configDataLocationMock2 };
			doReturn(configDataLocationArray4).when(bindResultMock4).orElse(configDataLocationArray5);
			springFactoriesLoader.when(() -> SpringFactoriesLoader.forDefaultResourceLocation((ClassLoader) any())).thenReturn(springFactoriesLoaderMock).thenReturn(springFactoriesLoaderMock2);
			defaultPropertiesPropertySource.when(() -> DefaultPropertiesPropertySource.hasMatchingName(propertySourceMock)).thenReturn(false);
			logMessage.when(() -> LogMessage.format("Adding initial config data import from location '%s'", configDataLocationMock3)).thenReturn(logMessageMock);
			configDataEnvironmentContributor.when(() -> ConfigDataEnvironmentContributor.ofInitialImport(configDataLocationMock3)).thenReturn(configDataEnvironmentContributorMock);
			logMessage.when(() -> LogMessage.format("Adding initial config data import from location '%s'", configDataLocationMock4)).thenReturn(logMessageMock2);
			configDataEnvironmentContributor.when(() -> ConfigDataEnvironmentContributor.ofInitialImport(configDataLocationMock4)).thenReturn(configDataEnvironmentContributorMock2);
			logMessage.when(() -> LogMessage.format("Adding initial config data import from location '%s'", configDataLocationMock5)).thenReturn(logMessageMock3);
			configDataEnvironmentContributor.when(() -> ConfigDataEnvironmentContributor.ofInitialImport(configDataLocationMock5)).thenReturn(configDataEnvironmentContributorMock3);
			configDataEnvironmentContributor.when(() -> ConfigDataEnvironmentContributor.ofExisting(propertySourceMock)).thenReturn(configDataEnvironmentContributorMock4);
			doReturn(bootstrapRegistryInstanceSupplierMock2).when(bootstrapRegistryInstanceSupplierMock).withScope(BootstrapRegistry.Scope.PROTOTYPE);
			doReturn(bootstrapRegistryInstanceSupplierMock4).when(bootstrapRegistryInstanceSupplierMock3).withScope(BootstrapRegistry.Scope.PROTOTYPE);
			doReturn(bootstrapRegistryInstanceSupplierMock6).when(bootstrapRegistryInstanceSupplierMock5).withScope(BootstrapRegistry.Scope.PROTOTYPE);
			...
			doNothing().when(environmentUpdateListenerMock).onPropertySourceAdded((PropertySource) any(), eq(configDataLocationMock6), eq(configDataResourceMock));
			doNothing().when(environmentMock).setDefaultProfiles(stringArray);
			doNothing().when(environmentMock).setActiveProfiles(stringArray2);
			doNothing().when(environmentUpdateListenerMock).onSetProfiles(profilesMock);
			List<String> stringList = new ArrayList<>();
			...
			assertAll("result", () -> {
				...
				logMessage.verify(() -> LogMessage.format("Adding initial config data import from location '%s'", configDataLocationMock3), atLeast(1));
				configDataEnvironmentContributor.verify(() -> ConfigDataEnvironmentContributor.ofInitialImport(configDataLocationMock3), atLeast(1));
				logMessage.verify(() -> LogMessage.format("Adding initial config data import from location '%s'", configDataLocationMock4), atLeast(1));
				configDataEnvironmentContributor.verify(() -> ConfigDataEnvironmentContributor.ofInitialImport(configDataLocationMock4), atLeast(1));
				logMessage.verify(() -> LogMessage.format("Adding initial config data import from location '%s'", configDataLocationMock5), atLeast(1));
				configDataEnvironmentContributor.verify(() -> ConfigDataEnvironmentContributor.ofInitialImport(configDataLocationMock5), atLeast(1));
				configDataEnvironmentContributor.verify(() -> ConfigDataEnvironmentContributor.ofExisting(propertySourceMock), atLeast(1));
				bootstrapRegistryInstanceSupplier.verify(() -> BootstrapRegistry.InstanceSupplier.from((Supplier) any()), atLeast(4));
				verify(bootstrapRegistryInstanceSupplierMock).withScope(BootstrapRegistry.Scope.PROTOTYPE);
				verify(bootstrapRegistryInstanceSupplierMock3).withScope(BootstrapRegistry.Scope.PROTOTYPE);
				...
				verify(bootstrapContextMock).register(Binder.class, bootstrapRegistryInstanceSupplierMock6);
				verify(bootstrapContextMock).register(Binder.class, bootstrapRegistryInstanceSupplierMock8);
				verify(environmentUpdateListenerMock).onPropertySourceAdded((PropertySource) any(), eq(configDataLocationMock6), eq(configDataResourceMock));
				verify(environmentMock).setDefaultProfiles(stringArray);
				verify(environmentMock).setActiveProfiles(stringArray2);
				verify(environmentUpdateListenerMock).onSetProfiles(profilesMock);
				verify(profilesMock, times(2)).getDefault();
