...
class SpringIterableConfigurationPropertySourceSapientGeneratedTest {
	...
	//Sapient generated method id: ${9fc1eebb-964a-3d08-9dbf-f24b53dfd687}, hash: 4834148D18CD1966F3C17F2B0379EFFC
	@Test()
	void getConfigurationPropertyWhenValueIsNullAndConfigurationPropertyIsNullAndGetMappingsGetMappedNameIsEmpty() {
		...
		doReturn("name1").when(mapSourceMock).getName();
		doReturn(null).when(mapSourceMock).getProperty("<List<String>>");
		PropertyMapper[] propertyMapperArray = new PropertyMapper[] { propertyMapperMock };
		SpringIterableConfigurationPropertySource target = new SpringIterableConfigurationPropertySource(mapSourceMock, propertyMapperArray);
		...
		assertAll("result", () -> {
			...
			verify(mapSourceMock).getProperty("<List<String>>");
		});
	}

	//Sapient generated method id: ${57054a1e-10ca-3fbe-8b8c-9d6a45d7edfc}, hash: 1BCAFE00E89187539758F7F8599777ED
	@Test()
	...
	//Sapient generated method id: ${15837300-d633-3fc1-8480-7507eacca3a1}, hash: 75AE92C9B6CF6A00376CBDB6B2D03FFE
	@Test()
	void streamWhenConfigurationPropertyNamesIsNull() {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class, CALLS_REAL_METHODS)) {
			...
			SpringIterableConfigurationPropertySource target = spy(new SpringIterableConfigurationPropertySource(mapSourceMock, propertyMapperArray));
			doReturn("systemEnvironment").when(enumerablePropertySourceMock).getName();
			Map<String, String> stringStringMap2 = new HashMap<>(Map.ofEntries(entry("PATH", "/usr/bin:/bin:/usr/sbin:/sbin"), entry("__CFBundleIdentifier", "com.jetbrains.intellij.ce"), entry("SSH_AUTH_SOCK", "/private/tmp/com.apple.launchd.4oEtTEgErm/Listeners"), entry("XPC_FLAGS", "0x0"), entry("SHELL", "/bin/zsh"), entry("__CF_USER_TEXT_ENCODING", "0x1F5:0x0:0x0"), entry("LOGNAME", "bhuvan"), entry("XPC_SERVICE_NAME", "application.com.jetbrains.intellij.ce.7960374.7961073"), entry("USER", "bhuvan"), entry("HOME", "/Users/bhuvan"), entry("TMPDIR", "/var/folders/23/6wlpx0js4c9b9z51m_1txb780000gn/T/"), entry("COMMAND_MODE", "unix2003")));
	...
	//Sapient generated method id: ${29532aaf-aa83-3bbc-bab1-a7aa401044f9}, hash: 0A6F9046F6F8D9DFE80B9909DF7D53C2
	@Test()
	...
	//Sapient generated method id: ${9fb0ca08-ed2e-31c2-a1d9-0392e69db412}, hash: 8AD3CFF1B08A833EEC2837CCFAA5C7C1
	@Test()
	...
	//Sapient generated method id: ${4739748f-ab7f-3670-b7b9-3d8a3e4f2a31}, hash: 6FBB987CAAEB7B18F7508250CC5FA79F
	@Test()
