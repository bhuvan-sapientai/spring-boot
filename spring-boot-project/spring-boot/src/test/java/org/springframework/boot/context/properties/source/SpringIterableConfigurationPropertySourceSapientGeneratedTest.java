...
class SpringIterableConfigurationPropertySourceSapientGeneratedTest {
	...
	//Sapient generated method id: ${57054a1e-10ca-3fbe-8b8c-9d6a45d7edfc}, hash: 252BCD265F49E665D11D36AC5F20BA4E
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${e893205b-f056-31da-9a8b-883b9fa7b02b}, hash: D018C0CB36E03354AE2237BF7C4C9692
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${e105d3be-5472-393b-b059-b658a063d376}, hash: B6C9AF26A6F0528043ACD8CE3629A79A
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${9050c48e-938a-32db-b9a6-0eb22f72c7dc}, hash: C26FDD3DB82A0CDA7D4DE48F0FAC478B
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${15837300-d633-3fc1-8480-7507eacca3a1}, hash: A50DC3D2591EDF6FAA17FA45743FF01E
	@Disabled()
	@Test()
	void streamWhenConfigurationPropertyNamesIsNull() {
		...
		try (MockedStatic<Assert> _assert = mockStatic(Assert.class, CALLS_REAL_METHODS)) {
			...
			SpringIterableConfigurationPropertySource target = spy(new SpringIterableConfigurationPropertySource(mapSourceMock, propertyMapperArray));
			doReturn("systemEnvironment").when(enumerablePropertySourceMock).getName();
			Map<String, String> stringStringMap2 = new HashMap<>(Map.ofEntries(entry("PATH", "/usr/bin:/bin:/usr/sbin:/sbin"), entry("__CFBundleIdentifier", "com.jetbrains.intellij.ce"), entry("SSH_AUTH_SOCK", "/private/tmp/com.apple.launchd.JoZW0qULYk/Listeners"), entry("XPC_FLAGS", "0x0"), entry("SHELL", "/bin/zsh"), entry("__CF_USER_TEXT_ENCODING", "0x1F5:0x0:0x0"), entry("LOGNAME", "bhuvan"), entry("XPC_SERVICE_NAME", "application.com.jetbrains.intellij.ce.7960374.7961073"), entry("USER", "bhuvan"), entry("HOME", "/Users/bhuvan"), entry("TMPDIR", "/var/folders/23/6wlpx0js4c9b9z51m_1txb780000gn/T/"), entry("COMMAND_MODE", "unix2003")));
	...
	//Sapient generated method id: ${29532aaf-aa83-3bbc-bab1-a7aa401044f9}, hash: 1E17EB3A042158A0C86B5DF3069C205F
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${9fb0ca08-ed2e-31c2-a1d9-0392e69db412}, hash: 8D89124F65CB5FDDC69FDEA25DDDFDD8
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${4739748f-ab7f-3670-b7b9-3d8a3e4f2a31}, hash: 849727842F5F9DC08706117B116CD906
	@Disabled()
	@Test()
