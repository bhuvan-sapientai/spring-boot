...
class EnableConfigurationPropertiesRegistrarSapientGeneratedTest {
	...
	//Sapient generated method id: ${65ccd99f-3bf8-36f1-bca0-bbb723609f6b}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${96dec1e4-e0cf-3af5-8062-1ec41e83a239}
	@Test()
	...
	//Sapient generated method id: ${a8406ee8-52ed-335b-bd8c-e91c55a8b744}
	@Test()
	void registerMethodValidationExcludeFilterWhenRegistryNotContainsBeanDefinitionMETHOD_VALIDATION_EXCLUDE_FILTER_BEAN_NAME() throws BeanDefinitionStoreException {
		...
		doNothing().when(registryMock).registerBeanDefinition(eq("org.springframework.boot.context.properties.EnableConfigurationPropertiesRegistrar.methodValidationExcludeFilter"), (AbstractBeanDefinition) any());
		//Act Statement(s)
		...
		assertAll("result", () -> {
			...
			verify(registryMock).registerBeanDefinition(eq("org.springframework.boot.context.properties.EnableConfigurationPropertiesRegistrar.methodValidationExcludeFilter"), (AbstractBeanDefinition) any());
		});
	}
}
