...
class ConfigurationPropertySapientGeneratedTest {
	...
	void toStringTest() {
		 ...
		 *  Following variables could not be isolated/mocked: org.springframework.core.style.ToStringCreator
		 *  Suggestions:
	...
	//Sapient generated method id: ${9ebb26ae-85fd-38c3-a6f9-2dd2158a80f3}
	@Test()
