...
class MimeMappingsSapientGeneratedTest {
	...
	//Sapient generated method id: ${ce7dfc7c-d15c-36e4-a6fe-06e5d0f607a5}
	@Test()
	...
	//Sapient generated method id: ${8a084572-19c1-3657-b661-bddf31c4aa27}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${72f7efec-21b6-30b5-b5d4-333f2d737f26}
	@Test()
	...
	//Sapient generated method id: ${a88321e2-c443-39ad-bf1b-22930f2ed148}
	@Test()
	void getAllTest() {
		//Arrange Statement(s)
        /*try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
    ...
    Collection<MimeMappings.Mapping> collection = new Collection<>();
    Iterator<MimeMappings.Mapping> iteratorResult = collection.iterator();
    //Assert statement(s)
    assertAll("result", () -> {
	...
	//Sapient generated method id: ${7e30d504-f47c-3103-aed7-a97aa01fddb7}
	@Test()
	...
	//Sapient generated method id: ${d1d51270-6f25-31cb-8e2b-b5b9179f1980}
	@Test()
	void lazyCopyTest() {
		//Arrange Statement(s)
        /*try (MockedStatic<Assert> _assert = mockStatic(Assert.class)) {
