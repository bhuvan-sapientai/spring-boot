...
class TomcatWebServerSapientGeneratedTest {
	...
	//Sapient generated method id: ${6ce71ce8-ed1d-3565-bbbe-1c9fc63aaa44}
	...
	//Sapient generated method id: ${2a926680-5a33-384b-93e6-05e8609c11bb}
	@Disabled()
	@Test()
	void startWhenThisTomcatGetServiceFindConnectorsIsNotEmptyAndCaughtExceptionThrowsWebServerException() throws WebServerException, LifecycleException {
		...
		try (MockedStatic<PortInUseException> portInUseException = mockStatic(PortInUseException.class)) {
			...
			TomcatWebServer target = spy(new TomcatWebServer(tomcat, true, Shutdown.GRACEFUL));
			doReturn("B").when(target).getStartedLogMessage();
			//Act Statement(s)
	...
	//Sapient generated method id: ${dd22e4a6-0543-3aab-bf9f-1b7fa471bea5}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	void startWhenThreadCurrentThreadGetContextClassLoaderNotInstanceOfTomcatEmbeddedWebappCl2ThrowsConnectorStartFailedException() throws WebServerException, LifecycleException, NamingException {
		...
		try (MockedStatic<ContextBindings> contextBindings = mockStatic(ContextBindings.class);
			...
			doNothing().when(tomcatEmbeddedContextMock2).deferredLoadOnStartup();
			doReturn(connectorMock3, connectorMock4).when(tomcatMock).getConnector();
			doReturn(LifecycleState.STARTING).when(connectorMock4).getState();
	...
	//Sapient generated method id: ${4e85c2b1-1a4a-392d-93e8-a08449966bb6}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	void startWhenChildInstanceOfContext() throws Exception {
		...
		try (MockedStatic<ContextBindings> contextBindings = mockStatic(ContextBindings.class);
			...
			Connector[] connectorArray4 = new Connector[] { connectorMock5 };
			doReturn(connectorArray4).when(serviceMock5).findConnectors();
			doReturn(LifecycleState.STARTING).when(connectorMock5).getState();
			doReturn("").when(target).getStartedLogMessage();
	...
	//Sapient generated method id: ${77dab7d8-9bbd-31ad-a6f1-d92d56b9a09c}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	...
	//Sapient generated method id: ${f07eb671-88a1-30da-b6e2-4266f9fef9a1}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	void getStartedLogMessageWhenLocalPortAndContextPathIsNull() throws LifecycleException, NamingException {
		...
		try (MockedStatic<ContextBindings> contextBindings = mockStatic(ContextBindings.class);
			...
			doReturn(8).when(connectorMock3).getLocalPort();
			doReturn("").when(connectorMock3).getScheme();
			doReturn(2).when(connectorMock4).getLocalPort();
			doReturn("").when(connectorMock4).getScheme();
			//Act Statement(s)
			String result = target.getStartedLogMessage();
			//Assert statement(s)
			assertAll("result", () -> {
				assertThat(result, equalTo("Tomcat started on ports 8 (), 2 ()"));
				_assert.verify(() -> Assert.notNull(tomcatMock, "Tomcat Server must not be null"), atLeast(1));
				contextBindings.verify(() -> ContextBindings.bindClassLoader(eq(contextMock), eq(object), (ClassLoader) any()));
				verify(contextMock).addLifecycleListener((LifecycleListener) any());
				verify(contextMock).getNamingToken();
	...
	//Sapient generated method id: ${3ec8067a-c803-3247-8b95-21ac0cdf9296}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	...
	//Sapient generated method id: ${7c6465c7-f95f-3515-8e00-5a07af39b1cf}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${534dce3f-7c80-3c70-91d9-adde758ba215}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${1c7909e8-e5f8-32af-ae70-86d5e3a5f3b0}
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${f6d1c4f8-d979-3198-acbc-9f01370a4805}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	...
	//Sapient generated method id: ${8fd7472d-38f6-3a76-8eab-cacec2274e36}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
	...
	//Sapient generated method id: ${d0333bfe-140b-3a95-96a4-614f95f451ca}
	@Disabled(value = "Potential harmful system call (Thread.start) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
	@Test()
