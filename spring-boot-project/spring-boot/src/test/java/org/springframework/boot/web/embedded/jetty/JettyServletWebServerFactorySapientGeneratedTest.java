...
class JettyServletWebServerFactorySapientGeneratedTest {
	...
	//Sapient generated method id: ${0e320937-c483-315b-81e7-87b93ffc2737}, hash: A84F557C1887AE10FFB60A2E1DB11207
	@Disabled()
	@Test()
	void getWebServerWhenGetShutdownEqualsShutdownGRACEFUL() throws Exception {
		...
		try (MockedStatic<WebServerSslBundle> webServerSslBundle = mockStatic(WebServerSslBundle.class);
			...
			target = spy(new JettyServletWebServerFactory("/A", 8));
	...
	//Sapient generated method id: ${39b1274f-506b-33ca-be63-af583ed013ba}, hash: FAE888A7EA7E355A65497DE121D2024F
	@Disabled()
	@Test()
	...
	//Sapient generated method id: ${e2641ce8-56ba-3a51-8f66-b5746824dc92}, hash: 1FC8D7166A3D3B5FBD247A0AA75CE5FD
	@Disabled()
	@Test()
	void getWebAppContextConfigurationsTest() {
		 ...
		 */
		//Arrange Statement(s)
		target = spy(new JettyServletWebServerFactory("<value>", 0));
		autoCloseableMocks = MockitoAnnotations.openMocks(this);
		Configuration configurationMock = mock(Configuration.class);
		WebAppContext webAppContext = new WebAppContext();
		ServletContextInitializer servletContextInitializerMock = mock(ServletContextInitializer.class);
